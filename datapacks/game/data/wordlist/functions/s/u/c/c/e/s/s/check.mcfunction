scoreboard players set @s word_id 6574 
...
execute if block ~7 ~ ~ minecraft:red_concrete_powder run function wordlist:s/u/c/c/e/s/s/o/check 
...
execute if block ~7 ~ ~ minecraft:lime_concrete_powder run function wordlist:s/u/c/c/e/s/s/f/check 
...
execute if block ~7 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:s/u/c/c/e/s/s/i/check 
