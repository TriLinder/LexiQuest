...
execute if block ~8 ~ ~ minecraft:red_concrete_powder run function wordlist:s/u/c/c/e/s/s/i/o/check 
...
execute if block ~8 ~ ~ minecraft:lime_wool run function wordlist:s/u/c/c/e/s/s/i/v/check 
