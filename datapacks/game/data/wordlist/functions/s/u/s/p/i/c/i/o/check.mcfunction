...
execute if block ~8 ~ ~ minecraft:green_concrete_powder run function wordlist:s/u/s/p/i/c/i/o/n/check 
...
execute if block ~8 ~ ~ minecraft:yellow_wool run function wordlist:s/u/s/p/i/c/i/o/u/check 
