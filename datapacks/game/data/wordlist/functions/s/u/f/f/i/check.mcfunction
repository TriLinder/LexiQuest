...
execute if block ~5 ~ ~ minecraft:gray_wool run function wordlist:s/u/f/f/i/x/check 
...
execute if block ~5 ~ ~ minecraft:magenta_concrete_powder run function wordlist:s/u/f/f/i/c/check 
