...
execute if block ~7 ~ ~ minecraft:orange_concrete_powder run function wordlist:s/u/b/s/c/r/i/b/c
...
execute if block ~7 ~ ~ minecraft:black_concrete_powder run function wordlist:s/u/b/s/c/r/i/p/c
