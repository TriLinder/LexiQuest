...
execute if block ~8 ~ ~ minecraft:green_concrete_powder run function wordlist:s/u/b/j/e/c/t/i/n/c
...
execute if block ~8 ~ ~ minecraft:lime_wool run function wordlist:s/u/b/j/e/c/t/i/v/c
