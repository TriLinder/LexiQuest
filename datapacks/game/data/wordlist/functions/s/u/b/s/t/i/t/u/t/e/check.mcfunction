scoreboard players set @s word_id 11250 
...
execute if block ~10 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:s/u/b/s/t/i/t/u/t/e/d/check 
...
execute if block ~10 ~ ~ minecraft:magenta_wool run function wordlist:s/u/b/s/t/i/t/u/t/e/s/check 
