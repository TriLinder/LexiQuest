...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:s/u/b/s/i/d/i/s/check 
...
execute if block ~7 ~ ~ minecraft:cyan_wool run function wordlist:s/u/b/s/i/d/i/z/check 
...
execute if block ~7 ~ ~ minecraft:white_concrete_powder run function wordlist:s/u/b/s/i/d/i/a/check 
