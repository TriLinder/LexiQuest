...
execute if block ~10 ~ ~ minecraft:green_concrete_powder run function wordlist:s/u/b/s/t/i/t/u/t/i/n/c
...
execute if block ~10 ~ ~ minecraft:red_concrete_powder run function wordlist:s/u/b/s/t/i/t/u/t/i/o/c
