...
execute if block ~8 ~ ~ minecraft:green_concrete_powder run function wordlist:s/u/g/g/e/s/t/i/n/check 
...
execute if block ~8 ~ ~ minecraft:red_concrete_powder run function wordlist:s/u/g/g/e/s/t/i/o/check 
