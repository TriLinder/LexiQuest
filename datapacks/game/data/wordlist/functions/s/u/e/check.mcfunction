scoreboard players set @s word_id 275 
...
execute if block ~3 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:s/u/e/d/check 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:s/u/e/s/check 
