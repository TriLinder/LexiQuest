...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 11633
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 11633
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 11633
...
execute if block ~11 ~ ~ minecraft:magenta_wool run function wordlist:s/u/p/e/r/v/i/s/i/o/n/s/c
