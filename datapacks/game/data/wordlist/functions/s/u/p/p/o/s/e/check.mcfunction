scoreboard players set @s word_id 6584 
...
execute if block ~7 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:s/u/p/p/o/s/e/d/check 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:s/u/p/p/o/s/e/s/check 
