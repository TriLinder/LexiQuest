...
execute if block ~7 ~ ~ minecraft:yellow_concrete_powder run function wordlist:s/u/m/m/a/r/i/e/check 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:s/u/m/m/a/r/i/s/check 
...
execute if block ~7 ~ ~ minecraft:cyan_wool run function wordlist:s/u/m/m/a/r/i/z/check 
