scoreboard players set @s word_id 276 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:s/u/m/s/check 
...
execute if block ~3 ~ ~ minecraft:brown_concrete_powder run function wordlist:s/u/m/m/check 
