scoreboard players set @s word_id 8488 
...
execute if block ~8 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:s/t/r/u/g/g/l/e/d/check 
...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:s/t/r/u/g/g/l/e/s/check 
