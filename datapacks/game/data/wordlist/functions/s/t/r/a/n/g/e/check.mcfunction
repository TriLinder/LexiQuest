scoreboard players set @s word_id 6555 
...
execute if block ~7 ~ ~ minecraft:orange_wool run function wordlist:s/t/r/a/n/g/e/r/check 
...
execute if block ~7 ~ ~ minecraft:blue_concrete_powder run function wordlist:s/t/r/a/n/g/e/l/check 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:s/t/r/a/n/g/e/s/check 
