...
execute if block ~8 ~ ~ minecraft:magenta_concrete_powder run function wordlist:s/t/r/a/t/e/g/i/c/check 
...
execute if block ~8 ~ ~ minecraft:yellow_concrete_powder run function wordlist:s/t/r/a/t/e/g/i/e/check 
