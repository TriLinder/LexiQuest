...
execute if block ~5 ~ ~ minecraft:green_concrete_powder run function wordlist:s/t/r/a/i/n/c
...
execute if block ~5 ~ ~ minecraft:pink_concrete_powder run function wordlist:s/t/r/a/i/g/c
