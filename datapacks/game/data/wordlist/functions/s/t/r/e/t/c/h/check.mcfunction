scoreboard players set @s word_id 6558 
...
execute if block ~7 ~ ~ minecraft:yellow_concrete_powder run function wordlist:s/t/r/e/t/c/h/e/check 
...
execute if block ~7 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:s/t/r/e/t/c/h/i/check 
