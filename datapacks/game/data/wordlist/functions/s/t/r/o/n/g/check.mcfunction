scoreboard players set @s word_id 4439 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:s/t/r/o/n/g/e/check 
...
execute if block ~6 ~ ~ minecraft:blue_concrete_powder run function wordlist:s/t/r/o/n/g/l/check 
