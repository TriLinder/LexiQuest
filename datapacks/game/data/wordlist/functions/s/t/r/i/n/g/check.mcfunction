scoreboard players set @s word_id 4435 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:s/t/r/i/n/g/s/check 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:s/t/r/i/n/g/e/check 
