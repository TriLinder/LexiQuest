scoreboard players set @s word_id 2478 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:s/t/r/i/p/s/check 
...
execute if block ~5 ~ ~ minecraft:black_concrete_powder run function wordlist:s/t/r/i/p/p/check 
