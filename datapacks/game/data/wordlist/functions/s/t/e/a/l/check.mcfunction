scoreboard players set @s word_id 2457 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:s/t/e/a/l/s/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:s/t/e/a/l/i/check 
