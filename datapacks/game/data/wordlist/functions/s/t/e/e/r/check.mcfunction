scoreboard players set @s word_id 2461 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:s/t/e/e/r/s/check 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:s/t/e/e/r/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:s/t/e/e/r/i/check 
