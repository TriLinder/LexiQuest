scoreboard players set @s word_id 2454 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:s/t/a/r/t/s/check 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:s/t/a/r/t/e/check 
...
execute if block ~5 ~ ~ minecraft:blue_concrete_powder run function wordlist:s/t/a/r/t/l/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:s/t/a/r/t/i/check 
