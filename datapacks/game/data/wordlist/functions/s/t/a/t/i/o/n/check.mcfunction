scoreboard players set @s word_id 6535 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:s/t/a/t/i/o/n/s/check 
...
execute if block ~7 ~ ~ minecraft:white_concrete_powder run function wordlist:s/t/a/t/i/o/n/a/check 
