scoreboard players set @s word_id 2450 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:s/t/a/n/d/s/check 
...
execute if block ~5 ~ ~ minecraft:white_concrete_powder run function wordlist:s/t/a/n/d/a/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:s/t/a/n/d/i/check 
...
execute if block ~5 ~ ~ minecraft:black_concrete_powder run function wordlist:s/t/a/n/d/p/check 
