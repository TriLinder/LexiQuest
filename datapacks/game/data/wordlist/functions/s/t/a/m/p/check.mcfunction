scoreboard players set @s word_id 2449 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:s/t/a/m/p/s/check 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:s/t/a/m/p/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:s/t/a/m/p/i/check 
