scoreboard players set @s word_id 6530 
...
execute if block ~7 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:s/t/a/r/t/l/e/d/check 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:s/t/a/r/t/l/e/s/check 
