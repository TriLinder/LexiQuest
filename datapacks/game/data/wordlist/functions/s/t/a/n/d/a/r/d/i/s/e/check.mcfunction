scoreboard players set @s word_id 11976 
...
execute if block ~11 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:s/t/a/n/d/a/r/d/i/s/e/d/check 
...
execute if block ~11 ~ ~ minecraft:magenta_wool run function wordlist:s/t/a/n/d/a/r/d/i/s/e/s/check 
