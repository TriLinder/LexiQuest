scoreboard players set @s word_id 2455 
...
execute if block ~5 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:s/t/a/t/e/d/check 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:s/t/a/t/e/s/check 
...
execute if block ~5 ~ ~ minecraft:brown_concrete_powder run function wordlist:s/t/a/t/e/m/check 
