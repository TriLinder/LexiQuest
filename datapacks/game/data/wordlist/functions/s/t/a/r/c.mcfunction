...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 748
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 748
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 748
...
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run function wordlist:s/t/a/r/e/c
execute if block ~ ~ ~4 minecraft:yellow_concrete_powder run scoreboard players set @s word_direction 1
execute if block ~ ~ ~4 minecraft:yellow_concrete_powder run function wordlist:s/t/a/r/e/c
execute if block ~4 ~ ~ minecraft:magenta_wool run scoreboard players set @s word_direction 0
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:s/t/a/r/s/c
execute if block ~ ~ ~4 minecraft:magenta_wool run scoreboard players set @s word_direction 1
execute if block ~ ~ ~4 minecraft:magenta_wool run function wordlist:s/t/a/r/s/c
execute if block ~4 ~ ~ minecraft:light_blue_wool run scoreboard players set @s word_direction 0
execute if block ~4 ~ ~ minecraft:light_blue_wool run function wordlist:s/t/a/r/t/c
...
execute if block ~4 ~ ~ minecraft:purple_concrete_powder run function wordlist:s/t/a/r/k/c
...
execute if block ~4 ~ ~ minecraft:lime_wool run function wordlist:s/t/a/r/v/c
...
execute if block ~4 ~ ~ minecraft:orange_wool run function wordlist:s/t/a/r/r/c
...
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:s/t/a/r/i/c
