scoreboard players set @s word_id 4406 
...
execute if block ~6 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:s/t/a/r/v/e/d/check 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:s/t/a/r/v/e/s/check 
