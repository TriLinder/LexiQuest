...
execute if block ~10 ~ ~ minecraft:yellow_concrete_powder run function wordlist:s/t/a/n/d/a/r/d/i/z/e/check 
...
execute if block ~10 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:s/t/a/n/d/a/r/d/i/z/i/check 
