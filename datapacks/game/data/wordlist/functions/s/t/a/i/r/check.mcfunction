scoreboard players set @s word_id 2445 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:s/t/a/i/r/s/check 
...
execute if block ~5 ~ ~ minecraft:magenta_concrete_powder run function wordlist:s/t/a/i/r/c/check 
