scoreboard players set @s word_id 2431 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:s/p/l/i/t/s/check 
...
execute if block ~5 ~ ~ minecraft:light_blue_wool run function wordlist:s/p/l/i/t/t/check 
