scoreboard players set @s word_id 4382 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:s/p/i/r/i/t/s/check 
...
execute if block ~6 ~ ~ minecraft:yellow_wool run function wordlist:s/p/i/r/i/t/u/check 
