scoreboard players set @s word_id 2421 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:s/p/e/e/d/s/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:s/p/e/e/d/i/check 
