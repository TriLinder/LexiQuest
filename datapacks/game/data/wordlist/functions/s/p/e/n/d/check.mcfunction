scoreboard players set @s word_id 2424 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:s/p/e/n/d/s/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:s/p/e/n/d/i/check 
