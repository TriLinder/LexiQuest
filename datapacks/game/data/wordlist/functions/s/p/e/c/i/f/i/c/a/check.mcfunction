...
execute if block ~9 ~ ~ minecraft:blue_concrete_powder run function wordlist:s/p/e/c/i/f/i/c/a/l/check 
...
execute if block ~9 ~ ~ minecraft:light_blue_wool run function wordlist:s/p/e/c/i/f/i/c/a/t/check 
