scoreboard players set @s word_id 6500 
...
execute if block ~7 ~ ~ minecraft:blue_concrete_powder run function wordlist:s/p/e/c/i/a/l/l/check 
...
execute if block ~7 ~ ~ minecraft:light_blue_wool run function wordlist:s/p/e/c/i/a/l/t/check 
...
execute if block ~7 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:s/p/e/c/i/a/l/i/check 
