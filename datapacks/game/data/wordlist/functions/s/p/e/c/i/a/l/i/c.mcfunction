...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:s/p/e/c/i/a/l/i/s/c
...
execute if block ~8 ~ ~ minecraft:cyan_wool run function wordlist:s/p/e/c/i/a/l/i/z/c
...
execute if block ~8 ~ ~ minecraft:light_blue_wool run function wordlist:s/p/e/c/i/a/l/i/t/c
