scoreboard players set @s word_id 2422 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:s/p/e/l/l/s/check 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:s/p/e/l/l/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:s/p/e/l/l/i/check 
