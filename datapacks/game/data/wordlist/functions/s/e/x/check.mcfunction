scoreboard players set @s word_id 263 
...
execute if block ~3 ~ ~ minecraft:light_gray_wool run function wordlist:s/e/x/y/check 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:s/e/x/e/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:s/e/x/i/check 
...
execute if block ~3 ~ ~ minecraft:yellow_wool run function wordlist:s/e/x/u/check 
