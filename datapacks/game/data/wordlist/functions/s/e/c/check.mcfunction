scoreboard players set @s word_id 260 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:s/e/c/t/check 
...
execute if block ~3 ~ ~ minecraft:red_concrete_powder run function wordlist:s/e/c/o/check 
...
execute if block ~3 ~ ~ minecraft:orange_wool run function wordlist:s/e/c/r/check 
...
execute if block ~3 ~ ~ minecraft:yellow_wool run function wordlist:s/e/c/u/check 
