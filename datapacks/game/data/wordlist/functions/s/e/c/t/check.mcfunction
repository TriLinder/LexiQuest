scoreboard players set @s word_id 1022 
...
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:s/e/c/t/s/check 
execute if block ~ ~ ~4 minecraft:magenta_wool run scoreboard players set @s word_direction 1 
execute if block ~ ~ ~4 minecraft:magenta_wool run function wordlist:s/e/c/t/s/check 
execute if block ~4 ~ ~ minecraft:red_concrete_powder run scoreboard players set @s word_direction 0 
execute if block ~4 ~ ~ minecraft:red_concrete_powder run function wordlist:s/e/c/t/o/check 
...
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:s/e/c/t/i/check 
