scoreboard players set @s word_id 8357 
...
execute if block ~8 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:s/e/n/t/e/n/c/e/d/check 
...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:s/e/n/t/e/n/c/e/s/check 
