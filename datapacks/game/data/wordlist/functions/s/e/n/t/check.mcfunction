scoreboard players set @s word_id 1031 
...
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run function wordlist:s/e/n/t/e/check 
...
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:s/e/n/t/i/check 
