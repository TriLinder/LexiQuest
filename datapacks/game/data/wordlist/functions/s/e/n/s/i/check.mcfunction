...
execute if block ~5 ~ ~ minecraft:orange_concrete_powder run function wordlist:s/e/n/s/i/b/check 
...
execute if block ~5 ~ ~ minecraft:light_blue_wool run function wordlist:s/e/n/s/i/t/check 
