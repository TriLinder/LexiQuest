scoreboard players set @s word_id 4281 
...
execute if block ~6 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:s/e/t/t/l/e/d/check 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:s/e/t/t/l/e/s/check 
