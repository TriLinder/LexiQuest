scoreboard players set @s word_id 259 
...
execute if block ~3 ~ ~ minecraft:blue_concrete_powder run function wordlist:s/e/a/l/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:s/e/a/t/check 
...
execute if block ~3 ~ ~ minecraft:orange_wool run function wordlist:s/e/a/r/check 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:s/e/a/s/check 
