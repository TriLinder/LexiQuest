scoreboard players set @s word_id 2327 
...
execute if block ~5 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:s/e/r/v/e/d/check 
...
execute if block ~5 ~ ~ minecraft:orange_wool run function wordlist:s/e/r/v/e/r/check 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:s/e/r/v/e/s/check 
