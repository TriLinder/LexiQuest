...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 921
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 921
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 921
...
execute if block ~4 ~ ~ minecraft:black_concrete_powder run function wordlist:s/w/a/m/p/c
