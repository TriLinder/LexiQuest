scoreboard players set @s word_id 4466 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:s/w/i/t/c/h/e/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:s/w/i/t/c/h/i/check 
