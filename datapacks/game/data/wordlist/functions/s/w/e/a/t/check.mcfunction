scoreboard players set @s word_id 2495 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:s/w/e/a/t/s/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:s/w/e/a/t/i/check 
