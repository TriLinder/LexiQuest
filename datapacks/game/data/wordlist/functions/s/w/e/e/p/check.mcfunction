scoreboard players set @s word_id 2496 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:s/w/e/e/p/s/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:s/w/e/e/p/i/check 
