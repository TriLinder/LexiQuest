...
execute if block ~3 ~ ~ minecraft:pink_wool run function wordlist:s/n/o/w/c
...
execute if block ~3 ~ ~ minecraft:orange_concrete_powder run function wordlist:s/n/o/b/c
