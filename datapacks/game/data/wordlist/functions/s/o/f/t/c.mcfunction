...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 936
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 936
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 936
...
execute if block ~4 ~ ~ minecraft:pink_wool run function wordlist:s/o/f/t/w/c
