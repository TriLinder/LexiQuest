scoreboard players set @s word_id 4355 
...
execute if block ~6 ~ ~ minecraft:blue_concrete_powder run function wordlist:s/o/c/i/a/l/l/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:s/o/c/i/a/l/i/check 
