scoreboard players set @s word_id 273 
...
execute if block ~3 ~ ~ minecraft:pink_concrete_powder run function wordlist:s/o/n/g/check 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:s/o/n/s/check 
