scoreboard players set @s word_id 2398 
...
execute if block ~5 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:s/m/i/l/e/d/check 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:s/m/i/l/e/s/check 
