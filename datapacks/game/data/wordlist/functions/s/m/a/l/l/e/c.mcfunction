...
execute if block ~6 ~ ~ minecraft:orange_wool run function wordlist:s/m/a/l/l/e/r/c
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:s/m/a/l/l/e/s/c
