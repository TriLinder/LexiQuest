scoreboard players set @s word_id 2394 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:s/m/a/l/l/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:s/m/a/l/l/i/check 
