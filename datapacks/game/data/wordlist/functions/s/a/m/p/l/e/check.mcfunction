scoreboard players set @s word_id 4232 
...
execute if block ~6 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:s/a/m/p/l/e/d/check 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:s/a/m/p/l/e/s/check 
