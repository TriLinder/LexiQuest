scoreboard players set @s word_id 258 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:s/a/y/s/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:s/a/y/i/check 
