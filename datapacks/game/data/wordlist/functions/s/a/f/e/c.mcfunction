...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 452
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 452
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 452
...
execute if block ~4 ~ ~ minecraft:orange_wool run function wordlist:s/a/f/e/r/c
execute if block ~ ~ ~4 minecraft:orange_wool run scoreboard players set @s word_direction 1
execute if block ~ ~ ~4 minecraft:orange_wool run function wordlist:s/a/f/e/r/c
execute if block ~4 ~ ~ minecraft:magenta_wool run scoreboard players set @s word_direction 0
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:s/a/f/e/s/c
execute if block ~ ~ ~4 minecraft:magenta_wool run scoreboard players set @s word_direction 1
execute if block ~ ~ ~4 minecraft:magenta_wool run function wordlist:s/a/f/e/s/c
execute if block ~4 ~ ~ minecraft:light_blue_wool run scoreboard players set @s word_direction 0
execute if block ~4 ~ ~ minecraft:light_blue_wool run function wordlist:s/a/f/e/t/c
...
execute if block ~4 ~ ~ minecraft:blue_concrete_powder run function wordlist:s/a/f/e/l/c
...
execute if block ~4 ~ ~ minecraft:pink_concrete_powder run function wordlist:s/a/f/e/g/c
