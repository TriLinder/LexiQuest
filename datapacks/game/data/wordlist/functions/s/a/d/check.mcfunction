scoreboard players set @s word_id 255 
...
execute if block ~3 ~ ~ minecraft:blue_concrete_powder run function wordlist:s/a/d/l/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:s/a/d/d/check 
