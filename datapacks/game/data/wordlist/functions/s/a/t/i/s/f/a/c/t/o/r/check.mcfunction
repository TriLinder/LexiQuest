...
execute if block ~11 ~ ~ minecraft:light_gray_wool run function wordlist:s/a/t/i/s/f/a/c/t/o/r/y/check 
...
execute if block ~11 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:s/a/t/i/s/f/a/c/t/o/r/i/check 
