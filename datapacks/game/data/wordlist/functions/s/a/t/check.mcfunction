scoreboard players set @s word_id 256 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:s/a/t/i/check 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:s/a/t/e/check 
