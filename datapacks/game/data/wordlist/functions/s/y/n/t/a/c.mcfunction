...
execute if block ~5 ~ ~ minecraft:gray_wool run function wordlist:s/y/n/t/a/x/c
...
execute if block ~5 ~ ~ minecraft:magenta_concrete_powder run function wordlist:s/y/n/t/a/c/c
