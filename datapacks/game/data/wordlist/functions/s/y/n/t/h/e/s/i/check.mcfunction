...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:s/y/n/t/h/e/s/i/s/check 
...
execute if block ~8 ~ ~ minecraft:cyan_wool run function wordlist:s/y/n/t/h/e/s/i/z/check 
