scoreboard players set @s word_id 2379 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:s/k/i/l/l/s/check 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:s/k/i/l/l/e/check 
