scoreboard players set @s word_id 4311 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:s/i/c/k/e/n/s/check 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:s/i/c/k/e/n/e/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:s/i/c/k/e/n/i/check 
