...
execute if block ~5 ~ ~ minecraft:green_concrete_powder run function wordlist:s/i/g/n/i/n/c
...
execute if block ~5 ~ ~ minecraft:lime_concrete_powder run function wordlist:s/i/g/n/i/f/c
