...
execute if block ~2 ~ ~ minecraft:magenta_concrete_powder run function wordlist:s/i/c/check 
...
execute if block ~2 ~ ~ minecraft:green_concrete_powder run function wordlist:s/i/n/check 
...
execute if block ~2 ~ ~ minecraft:orange_wool run function wordlist:s/i/r/check 
...
execute if block ~2 ~ ~ minecraft:light_blue_wool run function wordlist:s/i/t/check 
...
execute if block ~2 ~ ~ minecraft:gray_wool run function wordlist:s/i/x/check 
...
execute if block ~2 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:s/i/d/check 
...
execute if block ~2 ~ ~ minecraft:pink_concrete_powder run function wordlist:s/i/g/check 
...
execute if block ~2 ~ ~ minecraft:cyan_wool run function wordlist:s/i/z/check 
...
execute if block ~2 ~ ~ minecraft:blue_concrete_powder run function wordlist:s/i/l/check 
...
execute if block ~2 ~ ~ minecraft:brown_concrete_powder run function wordlist:s/i/m/check 
...
execute if block ~2 ~ ~ minecraft:magenta_wool run function wordlist:s/i/s/check 
