...
execute if block ~5 ~ ~ minecraft:light_blue_wool run function wordlist:s/i/l/e/n/t/check 
...
execute if block ~5 ~ ~ minecraft:magenta_concrete_powder run function wordlist:s/i/l/e/n/c/check 
