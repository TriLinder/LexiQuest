scoreboard players set @s word_id 6460 
...
execute if block ~7 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:s/i/t/u/a/t/e/d/check 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:s/i/t/u/a/t/e/s/check 
