scoreboard players set @s word_id 267 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:s/i/n/e/check 
...
execute if block ~3 ~ ~ minecraft:pink_concrete_powder run function wordlist:s/i/n/g/check 
...
execute if block ~3 ~ ~ minecraft:purple_concrete_powder run function wordlist:s/i/n/k/check 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:s/i/n/s/check 
...
execute if block ~3 ~ ~ minecraft:magenta_concrete_powder run function wordlist:s/i/n/c/check 
...
execute if block ~3 ~ ~ minecraft:lime_concrete_powder run function wordlist:s/i/n/f/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:s/i/n/i/check 
