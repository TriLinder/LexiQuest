...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 41
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 41
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 41
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:s/i/n/s/c
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:s/i/n/e/c
...
execute if block ~3 ~ ~ minecraft:purple_concrete_powder run function wordlist:s/i/n/k/c
...
execute if block ~3 ~ ~ minecraft:pink_concrete_powder run function wordlist:s/i/n/g/c
...
execute if block ~3 ~ ~ minecraft:magenta_concrete_powder run function wordlist:s/i/n/c/c
...
execute if block ~3 ~ ~ minecraft:lime_concrete_powder run function wordlist:s/i/n/f/c
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:s/i/n/i/c
