scoreboard players set @s word_id 1046 
...
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:s/i/n/g/s/check 
execute if block ~ ~ ~4 minecraft:magenta_wool run scoreboard players set @s word_direction 1 
execute if block ~ ~ ~4 minecraft:magenta_wool run function wordlist:s/i/n/g/s/check 
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run scoreboard players set @s word_direction 0 
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run function wordlist:s/i/n/g/e/check 
...
execute if block ~4 ~ ~ minecraft:blue_concrete_powder run function wordlist:s/i/n/g/l/check 
...
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:s/i/n/g/i/check 
...
execute if block ~4 ~ ~ minecraft:yellow_wool run function wordlist:s/i/n/g/u/check 
