scoreboard players set @s word_id 264 
...
execute if block ~3 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:s/h/e/d/check 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:s/h/e/e/check 
...
execute if block ~3 ~ ~ minecraft:blue_concrete_powder run function wordlist:s/h/e/l/check 
