scoreboard players set @s word_id 2347 
...
execute if block ~5 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:s/h/i/n/e/d/check 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:s/h/i/n/e/s/check 
