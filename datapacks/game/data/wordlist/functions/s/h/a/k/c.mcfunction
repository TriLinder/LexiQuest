...
execute if block ~4 ~ ~ minecraft:light_gray_wool run function wordlist:s/h/a/k/y/c
...
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run function wordlist:s/h/a/k/e/c
...
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:s/h/a/k/i/c
