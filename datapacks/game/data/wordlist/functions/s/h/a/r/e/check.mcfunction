scoreboard players set @s word_id 2338 
...
execute if block ~5 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:s/h/a/r/e/d/check 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:s/h/a/r/e/s/check 
...
execute if block ~5 ~ ~ minecraft:gray_concrete_powder run function wordlist:s/h/a/r/e/h/check 
