scoreboard players set @s word_id 2333 
...
execute if block ~5 ~ ~ minecraft:green_concrete_powder run function wordlist:s/h/a/k/e/n/check 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:s/h/a/k/e/s/check 
