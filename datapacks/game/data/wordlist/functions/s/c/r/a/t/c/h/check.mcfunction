scoreboard players set @s word_id 6384 
...
execute if block ~7 ~ ~ minecraft:yellow_concrete_powder run function wordlist:s/c/r/a/t/c/h/e/check 
...
execute if block ~7 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:s/c/r/a/t/c/h/i/check 
