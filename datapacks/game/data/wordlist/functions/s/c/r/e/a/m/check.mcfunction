scoreboard players set @s word_id 4251 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:s/c/r/e/a/m/s/check 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:s/c/r/e/a/m/e/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:s/c/r/e/a/m/i/check 
