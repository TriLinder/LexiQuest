scoreboard players set @s word_id 2316 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:s/c/r/a/p/s/check 
...
execute if block ~5 ~ ~ minecraft:black_concrete_powder run function wordlist:s/c/r/a/p/p/check 
