...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 11047
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 11047
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 11047
...
execute if block ~10 ~ ~ minecraft:white_concrete_powder run function wordlist:s/c/i/e/n/t/i/f/i/c/a/c
