scoreboard players set @s word_id 1018 
...
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:s/c/a/n/s/check 
execute if block ~ ~ ~4 minecraft:magenta_wool run scoreboard players set @s word_direction 1 
execute if block ~ ~ ~4 minecraft:magenta_wool run function wordlist:s/c/a/n/s/check 
execute if block ~4 ~ ~ minecraft:light_blue_concrete_powder run scoreboard players set @s word_direction 0 
execute if block ~4 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:s/c/a/n/d/check 
...
execute if block ~4 ~ ~ minecraft:green_concrete_powder run function wordlist:s/c/a/n/n/check 
