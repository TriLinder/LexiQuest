scoreboard players set @s word_id 2309 
...
execute if block ~5 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:s/c/a/l/e/d/check 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:s/c/a/l/e/s/check 
