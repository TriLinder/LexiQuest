scoreboard players set @s word_id 2107 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:o/c/c/u/r/s/check 
...
execute if block ~5 ~ ~ minecraft:orange_wool run function wordlist:o/c/c/u/r/r/check 
