scoreboard players set @s word_id 28 
...
execute if block ~2 ~ ~ minecraft:yellow_concrete_powder run function wordlist:o/n/e/check 
...
execute if block ~2 ~ ~ minecraft:magenta_concrete_powder run function wordlist:o/n/c/check 
...
execute if block ~2 ~ ~ minecraft:blue_concrete_powder run function wordlist:o/n/l/check 
...
execute if block ~2 ~ ~ minecraft:light_blue_wool run function wordlist:o/n/t/check 
...
execute if block ~2 ~ ~ minecraft:yellow_wool run function wordlist:o/n/u/check 
...
execute if block ~2 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:o/n/i/check 
...
execute if block ~2 ~ ~ minecraft:pink_concrete_powder run function wordlist:o/n/g/check 
...
execute if block ~2 ~ ~ minecraft:pink_wool run function wordlist:o/n/w/check 
