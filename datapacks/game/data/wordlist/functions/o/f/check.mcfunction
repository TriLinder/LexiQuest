scoreboard players set @s word_id 26 
...
execute if block ~2 ~ ~ minecraft:lime_concrete_powder run function wordlist:o/f/f/check 
...
execute if block ~2 ~ ~ minecraft:light_blue_wool run function wordlist:o/f/t/check 
