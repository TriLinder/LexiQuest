scoreboard players set @s word_id 3916 
...
execute if block ~6 ~ ~ minecraft:orange_wool run function wordlist:o/f/f/i/c/e/r/check 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:o/f/f/i/c/e/s/check 
