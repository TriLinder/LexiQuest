scoreboard players set @s word_id 6001 
...
execute if block ~7 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:o/p/e/r/a/t/e/d/check 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:o/p/e/r/a/t/e/s/check 
