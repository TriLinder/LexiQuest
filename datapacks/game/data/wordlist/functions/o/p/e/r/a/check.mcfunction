scoreboard players set @s word_id 2117 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:o/p/e/r/a/s/check 
...
execute if block ~5 ~ ~ minecraft:light_blue_wool run function wordlist:o/p/e/r/a/t/check 
