scoreboard players set @s word_id 218 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:o/p/t/s/check 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:o/p/t/e/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:o/p/t/i/check 
