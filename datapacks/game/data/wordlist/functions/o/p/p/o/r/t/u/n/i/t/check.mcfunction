...
execute if block ~10 ~ ~ minecraft:light_gray_wool run function wordlist:o/p/p/o/r/t/u/n/i/t/y/check 
...
execute if block ~10 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:o/p/p/o/r/t/u/n/i/t/i/check 
