scoreboard players set @s word_id 213 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:o/d/d/s/check 
...
execute if block ~3 ~ ~ minecraft:blue_concrete_powder run function wordlist:o/d/d/l/check 
