...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 152
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 152
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 152
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:o/w/n/s/c
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:o/w/n/e/c
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:o/w/n/i/c
