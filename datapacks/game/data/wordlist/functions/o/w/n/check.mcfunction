scoreboard players set @s word_id 222 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:o/w/n/s/check 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:o/w/n/e/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:o/w/n/i/check 
