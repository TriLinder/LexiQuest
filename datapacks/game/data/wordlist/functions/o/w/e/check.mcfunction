scoreboard players set @s word_id 221 
...
execute if block ~3 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:o/w/e/d/check 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:o/w/e/s/check 
