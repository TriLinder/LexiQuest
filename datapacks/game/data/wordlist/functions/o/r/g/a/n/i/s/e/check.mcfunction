scoreboard players set @s word_id 7980 
...
execute if block ~8 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:o/r/g/a/n/i/s/e/d/check 
...
execute if block ~8 ~ ~ minecraft:orange_wool run function wordlist:o/r/g/a/n/i/s/e/r/check 
...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:o/r/g/a/n/i/s/e/s/check 
