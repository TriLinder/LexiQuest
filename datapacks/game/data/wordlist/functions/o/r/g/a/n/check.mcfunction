scoreboard players set @s word_id 2122 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:o/r/g/a/n/s/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:o/r/g/a/n/i/check 
