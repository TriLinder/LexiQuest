scoreboard players set @s word_id 9653 
...
execute if block ~9 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:o/r/i/e/n/t/a/t/e/d/check 
...
execute if block ~9 ~ ~ minecraft:magenta_wool run function wordlist:o/r/i/e/n/t/a/t/e/s/check 
