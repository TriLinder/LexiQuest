scoreboard players set @s word_id 2121 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:o/r/d/e/r/s/check 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:o/r/d/e/r/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:o/r/d/e/r/i/check 
