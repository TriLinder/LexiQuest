...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 1738
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 1738
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 1738
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:o/t/h/e/r/s/c
...
execute if block ~5 ~ ~ minecraft:pink_wool run function wordlist:o/t/h/e/r/w/c
