scoreboard players set @s word_id 3909 
...
execute if block ~6 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:o/b/l/i/g/e/d/check 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:o/b/l/i/g/e/s/check 
