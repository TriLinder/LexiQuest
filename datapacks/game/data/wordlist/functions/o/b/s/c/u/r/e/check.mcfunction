scoreboard players set @s word_id 5982 
...
execute if block ~7 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:o/b/s/c/u/r/e/d/check 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:o/b/s/c/u/r/e/s/check 
