scoreboard players set @s word_id 167 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:j/a/m/s/check 
...
execute if block ~3 ~ ~ minecraft:brown_concrete_powder run function wordlist:j/a/m/m/check 
