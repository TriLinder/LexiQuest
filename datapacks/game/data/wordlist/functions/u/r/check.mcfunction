...
execute if block ~2 ~ ~ minecraft:pink_concrete_powder run function wordlist:u/r/g/check 
...
execute if block ~2 ~ ~ minecraft:orange_concrete_powder run function wordlist:u/r/b/check 
