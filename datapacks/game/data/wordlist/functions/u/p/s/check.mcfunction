scoreboard players set @s word_id 297 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:u/p/s/e/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:u/p/s/i/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:u/p/s/t/check 
