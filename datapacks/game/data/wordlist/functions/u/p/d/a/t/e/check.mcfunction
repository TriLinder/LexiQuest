scoreboard players set @s word_id 4612 
...
execute if block ~6 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:u/p/d/a/t/e/d/check 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:u/p/d/a/t/e/s/check 
