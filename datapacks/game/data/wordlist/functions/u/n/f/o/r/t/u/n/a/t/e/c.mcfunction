...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 11843
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 11843
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 11843
...
execute if block ~11 ~ ~ minecraft:blue_concrete_powder run function wordlist:u/n/f/o/r/t/u/n/a/t/e/l/c
