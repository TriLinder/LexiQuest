scoreboard players set @s word_id 2619 
...
execute if block ~5 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:u/n/i/t/e/d/check 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:u/n/i/t/e/s/check 
