...
execute if block ~10 ~ ~ minecraft:light_gray_wool run function wordlist:u/n/n/e/c/e/s/s/a/r/y/c
...
execute if block ~10 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:u/n/n/e/c/e/s/s/a/r/i/c
