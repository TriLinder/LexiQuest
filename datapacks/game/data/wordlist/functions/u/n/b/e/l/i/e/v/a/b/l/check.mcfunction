...
execute if block ~11 ~ ~ minecraft:yellow_concrete_powder run function wordlist:u/n/b/e/l/i/e/v/a/b/l/e/check 
...
execute if block ~11 ~ ~ minecraft:light_gray_wool run function wordlist:u/n/b/e/l/i/e/v/a/b/l/y/check 
