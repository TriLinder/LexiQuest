...
execute if block ~3 ~ ~ minecraft:white_concrete_powder run function wordlist:u/n/e/a/c
...
execute if block ~3 ~ ~ minecraft:gray_wool run function wordlist:u/n/e/x/c
...
execute if block ~3 ~ ~ minecraft:brown_concrete_powder run function wordlist:u/n/e/m/c
