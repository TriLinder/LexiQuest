...
execute if block ~2 ~ ~ minecraft:light_blue_wool run function wordlist:l/e/t/c
...
execute if block ~2 ~ ~ minecraft:pink_concrete_powder run function wordlist:l/e/g/c
...
execute if block ~2 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:l/e/d/c
...
execute if block ~2 ~ ~ minecraft:green_concrete_powder run function wordlist:l/e/n/c
...
execute if block ~2 ~ ~ minecraft:white_concrete_powder run function wordlist:l/e/a/c
...
execute if block ~2 ~ ~ minecraft:magenta_wool run function wordlist:l/e/s/c
...
execute if block ~2 ~ ~ minecraft:lime_concrete_powder run function wordlist:l/e/f/c
...
execute if block ~2 ~ ~ minecraft:lime_wool run function wordlist:l/e/v/c
...
execute if block ~2 ~ ~ minecraft:brown_concrete_powder run function wordlist:l/e/m/c
...
execute if block ~2 ~ ~ minecraft:magenta_concrete_powder run function wordlist:l/e/c/c
...
execute if block ~2 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:l/e/i/c
