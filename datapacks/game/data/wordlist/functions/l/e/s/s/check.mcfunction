scoreboard players set @s word_id 768 
...
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run function wordlist:l/e/s/s/e/check 
...
execute if block ~4 ~ ~ minecraft:red_concrete_powder run function wordlist:l/e/s/s/o/check 
