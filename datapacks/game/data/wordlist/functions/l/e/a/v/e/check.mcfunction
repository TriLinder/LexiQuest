scoreboard players set @s word_id 1958 
...
execute if block ~5 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:l/e/a/v/e/d/check 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:l/e/a/v/e/s/check 
