scoreboard players set @s word_id 182 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:l/e/t/s/check 
...
execute if block ~3 ~ ~ minecraft:gray_concrete_powder run function wordlist:l/e/t/h/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:l/e/t/t/check 
