scoreboard players set @s word_id 3731 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:l/i/s/t/e/n/s/check 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:l/i/s/t/e/n/e/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:l/i/s/t/e/n/i/check 
