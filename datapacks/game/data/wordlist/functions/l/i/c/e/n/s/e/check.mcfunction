scoreboard players set @s word_id 5809 
...
execute if block ~7 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:l/i/c/e/n/s/e/d/check 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:l/i/c/e/n/s/e/s/check 
