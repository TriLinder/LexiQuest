...
execute if block ~7 ~ ~ minecraft:yellow_concrete_powder run function wordlist:l/i/t/e/r/a/t/e/c
...
execute if block ~7 ~ ~ minecraft:yellow_wool run function wordlist:l/i/t/e/r/a/t/u/c
