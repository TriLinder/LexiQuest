scoreboard players set @s word_id 186 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:l/i/t/e/check 
...
execute if block ~3 ~ ~ minecraft:orange_wool run function wordlist:l/i/t/r/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:l/i/t/t/check 
