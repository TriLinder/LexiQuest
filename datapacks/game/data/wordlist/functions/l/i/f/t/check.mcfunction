scoreboard players set @s word_id 774 
...
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:l/i/f/t/s/check 
execute if block ~ ~ ~4 minecraft:magenta_wool run scoreboard players set @s word_direction 1 
execute if block ~ ~ ~4 minecraft:magenta_wool run function wordlist:l/i/f/t/s/check 
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run scoreboard players set @s word_direction 0 
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run function wordlist:l/i/f/t/e/check 
...
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:l/i/f/t/i/check 
