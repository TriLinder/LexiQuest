scoreboard players set @s word_id 1986 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:l/o/c/a/l/s/check 
...
execute if block ~5 ~ ~ minecraft:blue_concrete_powder run function wordlist:l/o/c/a/l/l/check 
