scoreboard players set @s word_id 3742 
...
execute if block ~6 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:l/o/c/a/t/e/d/check 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:l/o/c/a/t/e/s/check 
