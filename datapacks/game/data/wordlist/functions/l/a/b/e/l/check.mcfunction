scoreboard players set @s word_id 1941 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:l/a/b/e/l/s/check 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:l/a/b/e/l/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:l/a/b/e/l/i/check 
...
execute if block ~5 ~ ~ minecraft:blue_concrete_powder run function wordlist:l/a/b/e/l/l/check 
