scoreboard players set @s word_id 175 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:l/a/b/s/check 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:l/a/b/e/check 
...
execute if block ~3 ~ ~ minecraft:red_concrete_powder run function wordlist:l/a/b/o/check 
