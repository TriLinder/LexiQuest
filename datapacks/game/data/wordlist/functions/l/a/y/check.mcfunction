scoreboard players set @s word_id 179 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:l/a/y/s/check 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:l/a/y/e/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:l/a/y/i/check 
...
execute if block ~3 ~ ~ minecraft:red_concrete_powder run function wordlist:l/a/y/o/check 
