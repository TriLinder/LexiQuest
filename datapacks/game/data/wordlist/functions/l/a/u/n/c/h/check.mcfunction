scoreboard players set @s word_id 3687 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:l/a/u/n/c/h/e/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:l/a/u/n/c/h/i/check 
