scoreboard players set @s word_id 2160 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:p/h/o/t/o/s/check 
...
execute if block ~5 ~ ~ minecraft:magenta_concrete_powder run function wordlist:p/h/o/t/o/c/check 
...
execute if block ~5 ~ ~ minecraft:pink_concrete_powder run function wordlist:p/h/o/t/o/g/check 
