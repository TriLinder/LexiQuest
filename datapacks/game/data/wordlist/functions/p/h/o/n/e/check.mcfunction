scoreboard players set @s word_id 2159 
...
execute if block ~5 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:p/h/o/n/e/d/check 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:p/h/o/n/e/s/check 
