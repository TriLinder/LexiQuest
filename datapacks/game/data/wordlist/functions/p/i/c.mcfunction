...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 24
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 24
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 24
...
execute if block ~2 ~ ~ minecraft:pink_concrete_powder run function wordlist:p/i/g/c
...
execute if block ~2 ~ ~ minecraft:yellow_concrete_powder run function wordlist:p/i/e/c
...
execute if block ~2 ~ ~ minecraft:light_blue_wool run function wordlist:p/i/t/c
...
execute if block ~2 ~ ~ minecraft:green_concrete_powder run function wordlist:p/i/n/c
...
execute if block ~2 ~ ~ minecraft:blue_concrete_powder run function wordlist:p/i/l/c
...
execute if block ~2 ~ ~ minecraft:magenta_concrete_powder run function wordlist:p/i/c/c
...
execute if block ~2 ~ ~ minecraft:black_concrete_powder run function wordlist:p/i/p/c
...
execute if block ~2 ~ ~ minecraft:white_concrete_powder run function wordlist:p/i/a/c
...
execute if block ~2 ~ ~ minecraft:cyan_wool run function wordlist:p/i/z/c
...
execute if block ~2 ~ ~ minecraft:magenta_wool run function wordlist:p/i/s/c
