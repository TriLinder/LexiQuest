scoreboard players set @s word_id 232 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:p/i/g/s/check 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:p/i/g/e/check 
