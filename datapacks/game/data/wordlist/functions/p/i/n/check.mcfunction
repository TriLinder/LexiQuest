scoreboard players set @s word_id 233 
...
execute if block ~3 ~ ~ minecraft:purple_concrete_powder run function wordlist:p/i/n/k/check 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:p/i/n/s/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:p/i/n/t/check 
...
execute if block ~3 ~ ~ minecraft:magenta_concrete_powder run function wordlist:p/i/n/c/check 
