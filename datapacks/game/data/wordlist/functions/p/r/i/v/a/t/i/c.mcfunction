...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:p/r/i/v/a/t/i/s/c
...
execute if block ~7 ~ ~ minecraft:cyan_wool run function wordlist:p/r/i/v/a/t/i/z/c
