scoreboard players set @s word_id 2201 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:p/r/i/n/t/s/check 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:p/r/i/n/t/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:p/r/i/n/t/i/check 
...
execute if block ~5 ~ ~ minecraft:red_concrete_powder run function wordlist:p/r/i/n/t/o/check 
