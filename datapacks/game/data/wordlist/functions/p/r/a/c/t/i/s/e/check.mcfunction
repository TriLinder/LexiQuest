scoreboard players set @s word_id 8099 
...
execute if block ~8 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:p/r/a/c/t/i/s/e/d/check 
...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:p/r/a/c/t/i/s/e/s/check 
