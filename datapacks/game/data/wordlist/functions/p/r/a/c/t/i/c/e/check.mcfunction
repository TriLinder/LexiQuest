scoreboard players set @s word_id 8098 
...
execute if block ~8 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:p/r/a/c/t/i/c/e/d/check 
...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:p/r/a/c/t/i/c/e/s/check 
