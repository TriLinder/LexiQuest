scoreboard players set @s word_id 6177 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:p/r/o/t/e/c/t/s/check 
...
execute if block ~7 ~ ~ minecraft:yellow_concrete_powder run function wordlist:p/r/o/t/e/c/t/e/check 
...
execute if block ~7 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:p/r/o/t/e/c/t/i/check 
