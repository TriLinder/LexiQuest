scoreboard players set @s word_id 6167 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:p/r/o/g/r/a/m/s/check 
...
execute if block ~7 ~ ~ minecraft:brown_concrete_powder run function wordlist:p/r/o/g/r/a/m/m/check 
