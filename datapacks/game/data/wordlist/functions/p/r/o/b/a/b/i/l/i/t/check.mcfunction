...
execute if block ~10 ~ ~ minecraft:light_gray_wool run function wordlist:p/r/o/b/a/b/i/l/i/t/y/check 
...
execute if block ~10 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:p/r/o/b/a/b/i/l/i/t/i/check 
