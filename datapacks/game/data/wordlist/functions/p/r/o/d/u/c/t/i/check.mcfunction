...
execute if block ~8 ~ ~ minecraft:red_concrete_powder run function wordlist:p/r/o/d/u/c/t/i/o/check 
...
execute if block ~8 ~ ~ minecraft:lime_wool run function wordlist:p/r/o/d/u/c/t/i/v/check 
