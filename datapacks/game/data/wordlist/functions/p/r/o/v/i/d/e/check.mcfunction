scoreboard players set @s word_id 6180 
...
execute if block ~7 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:p/r/o/v/i/d/e/d/check 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:p/r/o/v/i/d/e/s/check 
