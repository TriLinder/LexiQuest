...
execute if block ~5 ~ ~ minecraft:purple_concrete_powder run function wordlist:p/r/o/v/o/k/check 
...
execute if block ~5 ~ ~ minecraft:magenta_concrete_powder run function wordlist:p/r/o/v/o/c/check 
