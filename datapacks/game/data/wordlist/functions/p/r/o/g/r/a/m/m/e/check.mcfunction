scoreboard players set @s word_id 9791 
...
execute if block ~9 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:p/r/o/g/r/a/m/m/e/d/check 
...
execute if block ~9 ~ ~ minecraft:orange_wool run function wordlist:p/r/o/g/r/a/m/m/e/r/check 
...
execute if block ~9 ~ ~ minecraft:magenta_wool run function wordlist:p/r/o/g/r/a/m/m/e/s/check 
