scoreboard players set @s word_id 4050 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:p/r/e/f/i/x/e/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:p/r/e/f/i/x/i/check 
