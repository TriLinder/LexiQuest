scoreboard players set @s word_id 6145 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:p/r/e/t/e/n/d/s/check 
...
execute if block ~7 ~ ~ minecraft:yellow_concrete_powder run function wordlist:p/r/e/t/e/n/d/e/check 
...
execute if block ~7 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:p/r/e/t/e/n/d/i/check 
