scoreboard players set @s word_id 4048 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:p/r/e/a/c/h/e/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:p/r/e/a/c/h/i/check 
