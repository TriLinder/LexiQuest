scoreboard players set @s word_id 2176 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:p/l/a/n/e/s/check 
...
execute if block ~5 ~ ~ minecraft:light_blue_wool run function wordlist:p/l/a/n/e/t/check 
