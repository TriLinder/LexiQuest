scoreboard players set @s word_id 4006 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:p/l/a/n/e/t/s/check 
...
execute if block ~6 ~ ~ minecraft:white_concrete_powder run function wordlist:p/l/a/n/e/t/a/check 
