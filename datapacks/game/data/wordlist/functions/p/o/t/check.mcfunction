scoreboard players set @s word_id 236 
...
execute if block ~3 ~ ~ minecraft:white_concrete_powder run function wordlist:p/o/t/a/check 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:p/o/t/e/check 
