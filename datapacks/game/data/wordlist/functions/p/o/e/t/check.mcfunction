scoreboard players set @s word_id 928 
...
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:p/o/e/t/s/check 
execute if block ~ ~ ~4 minecraft:magenta_wool run scoreboard players set @s word_direction 1 
execute if block ~ ~ ~4 minecraft:magenta_wool run function wordlist:p/o/e/t/s/check 
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run scoreboard players set @s word_direction 0 
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:p/o/e/t/i/check 
...
execute if block ~4 ~ ~ minecraft:orange_wool run function wordlist:p/o/e/t/r/check 
