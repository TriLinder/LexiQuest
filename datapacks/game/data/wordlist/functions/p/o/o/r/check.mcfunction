scoreboard players set @s word_id 933 
...
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run function wordlist:p/o/o/r/e/check 
...
execute if block ~4 ~ ~ minecraft:blue_concrete_powder run function wordlist:p/o/o/r/l/check 
