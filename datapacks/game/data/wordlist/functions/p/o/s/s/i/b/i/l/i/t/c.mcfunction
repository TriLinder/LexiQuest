...
execute if block ~10 ~ ~ minecraft:light_gray_wool run function wordlist:p/o/s/s/i/b/i/l/i/t/y/c
...
execute if block ~10 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:p/o/s/s/i/b/i/l/i/t/i/c
