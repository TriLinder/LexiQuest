...
execute if block ~5 ~ ~ minecraft:blue_concrete_powder run function wordlist:p/o/s/t/a/l/c
...
execute if block ~5 ~ ~ minecraft:pink_concrete_powder run function wordlist:p/o/s/t/a/g/c
