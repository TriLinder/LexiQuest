...
execute if block ~6 ~ ~ minecraft:lime_wool run function wordlist:p/o/s/i/t/i/v/c
...
execute if block ~6 ~ ~ minecraft:red_concrete_powder run function wordlist:p/o/s/i/t/i/o/c
