scoreboard players set @s word_id 235 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:p/o/p/e/check 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:p/o/p/s/check 
...
execute if block ~3 ~ ~ minecraft:black_concrete_powder run function wordlist:p/o/p/p/check 
...
execute if block ~3 ~ ~ minecraft:yellow_wool run function wordlist:p/o/p/u/check 
