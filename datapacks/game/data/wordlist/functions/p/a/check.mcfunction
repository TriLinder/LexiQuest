...
execute if block ~2 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:p/a/d/check 
...
execute if block ~2 ~ ~ minecraft:green_concrete_powder run function wordlist:p/a/n/check 
...
execute if block ~2 ~ ~ minecraft:orange_wool run function wordlist:p/a/r/check 
...
execute if block ~2 ~ ~ minecraft:light_blue_wool run function wordlist:p/a/t/check 
...
execute if block ~2 ~ ~ minecraft:light_gray_wool run function wordlist:p/a/y/check 
...
execute if block ~2 ~ ~ minecraft:magenta_concrete_powder run function wordlist:p/a/c/check 
...
execute if block ~2 ~ ~ minecraft:pink_concrete_powder run function wordlist:p/a/g/check 
...
execute if block ~2 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:p/a/i/check 
...
execute if block ~2 ~ ~ minecraft:blue_concrete_powder run function wordlist:p/a/l/check 
...
execute if block ~2 ~ ~ minecraft:magenta_wool run function wordlist:p/a/s/check 
...
execute if block ~2 ~ ~ minecraft:black_concrete_powder run function wordlist:p/a/p/check 
...
execute if block ~2 ~ ~ minecraft:yellow_wool run function wordlist:p/a/u/check 
...
execute if block ~2 ~ ~ minecraft:lime_wool run function wordlist:p/a/v/check 
