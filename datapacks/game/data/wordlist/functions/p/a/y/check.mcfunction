scoreboard players set @s word_id 227 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:p/a/y/s/check 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:p/a/y/e/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:p/a/y/i/check 
...
execute if block ~3 ~ ~ minecraft:brown_concrete_powder run function wordlist:p/a/y/m/check 
