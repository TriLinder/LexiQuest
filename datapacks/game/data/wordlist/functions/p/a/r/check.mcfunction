scoreboard players set @s word_id 225 
...
execute if block ~3 ~ ~ minecraft:purple_concrete_powder run function wordlist:p/a/r/k/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:p/a/r/t/check 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:p/a/r/s/check 
...
execute if block ~3 ~ ~ minecraft:white_concrete_powder run function wordlist:p/a/r/a/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:p/a/r/d/check 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:p/a/r/e/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:p/a/r/i/check 
...
execute if block ~3 ~ ~ minecraft:red_concrete_powder run function wordlist:p/a/r/o/check 
...
execute if block ~3 ~ ~ minecraft:orange_wool run function wordlist:p/a/r/r/check 
...
execute if block ~3 ~ ~ minecraft:blue_concrete_powder run function wordlist:p/a/r/l/check 
