...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 965
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 965
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 965
...
execute if block ~4 ~ ~ minecraft:light_gray_wool run function wordlist:p/a/r/t/y/c
execute if block ~ ~ ~4 minecraft:light_gray_wool run scoreboard players set @s word_direction 1
execute if block ~ ~ ~4 minecraft:light_gray_wool run function wordlist:p/a/r/t/y/c
execute if block ~4 ~ ~ minecraft:magenta_wool run scoreboard players set @s word_direction 0
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:p/a/r/t/s/c
execute if block ~ ~ ~4 minecraft:magenta_wool run scoreboard players set @s word_direction 1
execute if block ~ ~ ~4 minecraft:magenta_wool run function wordlist:p/a/r/t/s/c
execute if block ~4 ~ ~ minecraft:blue_concrete_powder run scoreboard players set @s word_direction 0
execute if block ~4 ~ ~ minecraft:blue_concrete_powder run function wordlist:p/a/r/t/l/c
...
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:p/a/r/t/i/c
...
execute if block ~4 ~ ~ minecraft:green_concrete_powder run function wordlist:p/a/r/t/n/c
