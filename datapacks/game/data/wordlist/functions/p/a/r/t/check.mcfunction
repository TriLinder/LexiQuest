scoreboard players set @s word_id 902 
...
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:p/a/r/t/s/check 
execute if block ~ ~ ~4 minecraft:magenta_wool run scoreboard players set @s word_direction 1 
execute if block ~ ~ ~4 minecraft:magenta_wool run function wordlist:p/a/r/t/s/check 
execute if block ~4 ~ ~ minecraft:light_gray_wool run scoreboard players set @s word_direction 0 
execute if block ~4 ~ ~ minecraft:light_gray_wool run function wordlist:p/a/r/t/y/check 
...
execute if block ~4 ~ ~ minecraft:blue_concrete_powder run function wordlist:p/a/r/t/l/check 
...
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:p/a/r/t/i/check 
...
execute if block ~4 ~ ~ minecraft:green_concrete_powder run function wordlist:p/a/r/t/n/check 
