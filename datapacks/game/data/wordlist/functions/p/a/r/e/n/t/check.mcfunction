scoreboard players set @s word_id 3956 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:p/a/r/e/n/t/s/check 
...
execute if block ~6 ~ ~ minecraft:gray_concrete_powder run function wordlist:p/a/r/e/n/t/h/check 
