scoreboard players set @s word_id 2141 
...
execute if block ~5 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:p/a/r/s/e/d/check 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:p/a/r/s/e/s/check 
