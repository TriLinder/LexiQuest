scoreboard players set @s word_id 226 
...
execute if block ~3 ~ ~ minecraft:gray_concrete_powder run function wordlist:p/a/t/h/check 
...
execute if block ~3 ~ ~ minecraft:magenta_concrete_powder run function wordlist:p/a/t/c/check 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:p/a/t/e/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:p/a/t/i/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:p/a/t/t/check 
...
execute if block ~3 ~ ~ minecraft:orange_wool run function wordlist:p/a/t/r/check 
