scoreboard players set @s word_id 2145 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:p/a/t/c/h/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:p/a/t/c/h/i/check 
