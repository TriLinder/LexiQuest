...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:p/a/t/r/o/n/i/s/c
...
execute if block ~7 ~ ~ minecraft:cyan_wool run function wordlist:p/a/t/r/o/n/i/z/c
