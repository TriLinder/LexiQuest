scoreboard players set @s word_id 223 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:p/a/d/s/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:p/a/d/d/check 
