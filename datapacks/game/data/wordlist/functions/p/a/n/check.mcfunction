scoreboard players set @s word_id 224 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:p/a/n/t/check 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:p/a/n/e/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:p/a/n/i/check 
