scoreboard players set @s word_id 240 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:p/u/t/s/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:p/u/t/t/check 
