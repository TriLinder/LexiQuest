scoreboard players set @s word_id 8170 
...
execute if block ~8 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:p/u/r/c/h/a/s/e/d/check 
...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:p/u/r/c/h/a/s/e/s/check 
