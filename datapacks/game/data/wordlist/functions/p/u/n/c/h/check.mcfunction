scoreboard players set @s word_id 2214 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:p/u/n/c/h/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:p/u/n/c/h/i/check 
