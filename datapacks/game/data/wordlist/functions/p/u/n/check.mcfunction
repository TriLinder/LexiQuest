scoreboard players set @s word_id 239 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:p/u/n/s/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:p/u/n/t/check 
...
execute if block ~3 ~ ~ minecraft:magenta_concrete_powder run function wordlist:p/u/n/c/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:p/u/n/i/check 
