...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:p/u/b/l/i/c/i/s/check 
...
execute if block ~7 ~ ~ minecraft:light_blue_wool run function wordlist:p/u/b/l/i/c/i/t/check 
...
execute if block ~7 ~ ~ minecraft:cyan_wool run function wordlist:p/u/b/l/i/c/i/z/check 
