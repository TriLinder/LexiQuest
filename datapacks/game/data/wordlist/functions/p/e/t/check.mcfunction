scoreboard players set @s word_id 230 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:p/e/t/t/check 
...
execute if block ~3 ~ ~ minecraft:orange_wool run function wordlist:p/e/t/r/check 
