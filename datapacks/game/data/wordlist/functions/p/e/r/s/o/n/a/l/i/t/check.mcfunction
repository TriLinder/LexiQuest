...
execute if block ~10 ~ ~ minecraft:light_gray_wool run function wordlist:p/e/r/s/o/n/a/l/i/t/y/check 
...
execute if block ~10 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:p/e/r/s/o/n/a/l/i/t/i/check 
