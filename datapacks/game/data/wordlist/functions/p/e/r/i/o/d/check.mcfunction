scoreboard players set @s word_id 3981 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:p/e/r/i/o/d/s/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:p/e/r/i/o/d/i/check 
