scoreboard players set @s word_id 3982 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:p/e/r/m/i/t/s/check 
...
execute if block ~6 ~ ~ minecraft:light_blue_wool run function wordlist:p/e/r/m/i/t/t/check 
