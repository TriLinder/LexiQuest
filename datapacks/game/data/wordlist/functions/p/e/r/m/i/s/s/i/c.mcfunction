...
execute if block ~8 ~ ~ minecraft:red_concrete_powder run function wordlist:p/e/r/m/i/s/s/i/o/c
...
execute if block ~8 ~ ~ minecraft:orange_concrete_powder run function wordlist:p/e/r/m/i/s/s/i/b/c
