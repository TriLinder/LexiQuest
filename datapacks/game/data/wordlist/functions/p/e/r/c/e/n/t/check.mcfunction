scoreboard players set @s word_id 6064 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:p/e/r/c/e/n/t/s/check 
...
execute if block ~7 ~ ~ minecraft:white_concrete_powder run function wordlist:p/e/r/c/e/n/t/a/check 
