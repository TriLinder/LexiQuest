scoreboard players set @s word_id 4118 
...
execute if block ~6 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:r/a/t/t/l/e/d/check 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:r/a/t/t/l/e/s/check 
