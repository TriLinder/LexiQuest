scoreboard players set @s word_id 2248 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:r/a/t/i/o/s/check 
...
execute if block ~5 ~ ~ minecraft:green_concrete_powder run function wordlist:r/a/t/i/o/n/check 
