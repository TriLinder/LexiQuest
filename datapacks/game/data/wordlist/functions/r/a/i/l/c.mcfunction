...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 861
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 861
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 861
...
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:r/a/i/l/s/c
execute if block ~ ~ ~4 minecraft:magenta_wool run scoreboard players set @s word_direction 1
execute if block ~ ~ ~4 minecraft:magenta_wool run function wordlist:r/a/i/l/s/c
execute if block ~4 ~ ~ minecraft:pink_wool run scoreboard players set @s word_direction 0
execute if block ~4 ~ ~ minecraft:pink_wool run function wordlist:r/a/i/l/w/c
...
execute if block ~4 ~ ~ minecraft:orange_wool run function wordlist:r/a/i/l/r/c
