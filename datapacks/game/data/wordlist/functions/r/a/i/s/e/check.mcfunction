scoreboard players set @s word_id 2239 
...
execute if block ~5 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:r/a/i/s/e/d/check 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:r/a/i/s/e/s/check 
