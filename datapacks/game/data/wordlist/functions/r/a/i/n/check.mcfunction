scoreboard players set @s word_id 958 
...
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:r/a/i/n/s/check 
execute if block ~ ~ ~4 minecraft:magenta_wool run scoreboard players set @s word_direction 1 
execute if block ~ ~ ~4 minecraft:magenta_wool run function wordlist:r/a/i/n/s/check 
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run scoreboard players set @s word_direction 0 
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run function wordlist:r/a/i/n/e/check 
...
execute if block ~4 ~ ~ minecraft:orange_concrete_powder run function wordlist:r/a/i/n/b/check 
...
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:r/a/i/n/i/check 
