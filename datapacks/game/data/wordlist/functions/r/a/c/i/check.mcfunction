...
execute if block ~4 ~ ~ minecraft:white_concrete_powder run function wordlist:r/a/c/i/a/check 
...
execute if block ~4 ~ ~ minecraft:green_concrete_powder run function wordlist:r/a/c/i/n/check 
execute if block ~ ~ ~4 minecraft:green_concrete_powder run scoreboard players set @s word_direction 1 
execute if block ~ ~ ~4 minecraft:green_concrete_powder run function wordlist:r/a/c/i/n/check 
execute if block ~4 ~ ~ minecraft:magenta_wool run scoreboard players set @s word_direction 0 
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:r/a/c/i/s/check 
