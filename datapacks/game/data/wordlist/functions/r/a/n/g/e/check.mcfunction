scoreboard players set @s word_id 2240 
...
execute if block ~5 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:r/a/n/g/e/d/check 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:r/a/n/g/e/s/check 
