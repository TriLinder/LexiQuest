scoreboard players set @s word_id 959 
...
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run function wordlist:r/a/n/g/e/check 
...
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:r/a/n/g/i/check 
