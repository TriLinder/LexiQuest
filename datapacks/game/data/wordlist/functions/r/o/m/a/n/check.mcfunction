scoreboard players set @s word_id 2283 
...
execute if block ~5 ~ ~ minecraft:magenta_concrete_powder run function wordlist:r/o/m/a/n/c/check 
...
execute if block ~5 ~ ~ minecraft:light_blue_wool run function wordlist:r/o/m/a/n/t/check 
