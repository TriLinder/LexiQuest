...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:r/o/u/t/i/n/e/check 
...
execute if block ~6 ~ ~ minecraft:pink_concrete_powder run function wordlist:r/o/u/t/i/n/g/check 
