scoreboard players set @s word_id 4209 
...
execute if block ~6 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:r/o/t/a/t/e/d/check 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:r/o/t/a/t/e/s/check 
