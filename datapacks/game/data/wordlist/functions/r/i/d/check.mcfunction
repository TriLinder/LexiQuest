scoreboard players set @s word_id 248 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:r/i/d/e/check 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:r/i/d/s/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:r/i/d/d/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:r/i/d/i/check 
