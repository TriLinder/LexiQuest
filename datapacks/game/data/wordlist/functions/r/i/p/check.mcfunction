scoreboard players set @s word_id 249 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:r/i/p/s/check 
...
execute if block ~3 ~ ~ minecraft:black_concrete_powder run function wordlist:r/i/p/p/check 
