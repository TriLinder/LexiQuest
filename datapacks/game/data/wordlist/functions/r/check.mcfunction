...
execute if block ~1 ~ ~ minecraft:yellow_concrete_powder run function wordlist:r/e/check 
...
execute if block ~1 ~ ~ minecraft:white_concrete_powder run function wordlist:r/a/check 
...
execute if block ~1 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:r/i/check 
...
execute if block ~1 ~ ~ minecraft:red_concrete_powder run function wordlist:r/o/check 
...
execute if block ~1 ~ ~ minecraft:yellow_wool run function wordlist:r/u/check 
...
execute if block ~1 ~ ~ minecraft:gray_concrete_powder run function wordlist:r/h/check 
