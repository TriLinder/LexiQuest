scoreboard players set @s word_id 4176 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:r/e/t/u/r/n/s/check 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:r/e/t/u/r/n/e/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:r/e/t/u/r/n/i/check 
