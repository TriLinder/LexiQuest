scoreboard players set @s word_id 4175 
...
execute if block ~6 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:r/e/t/i/r/e/d/check 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:r/e/t/i/r/e/s/check 
...
execute if block ~6 ~ ~ minecraft:brown_concrete_powder run function wordlist:r/e/t/i/r/e/m/check 
