scoreboard players set @s word_id 2262 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:r/e/n/e/w/s/check 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:r/e/n/e/w/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:r/e/n/e/w/i/check 
