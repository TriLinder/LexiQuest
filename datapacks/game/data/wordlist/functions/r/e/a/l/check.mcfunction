scoreboard players set @s word_id 969 
...
execute if block ~4 ~ ~ minecraft:brown_concrete_powder run function wordlist:r/e/a/l/m/check 
...
execute if block ~4 ~ ~ minecraft:blue_concrete_powder run function wordlist:r/e/a/l/l/check 
...
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:r/e/a/l/i/check 
