scoreboard players set @s word_id 6240 
...
execute if block ~7 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:r/e/a/l/i/s/e/d/check 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:r/e/a/l/i/s/e/s/check 
