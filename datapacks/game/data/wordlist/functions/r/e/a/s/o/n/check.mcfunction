scoreboard players set @s word_id 4125 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:r/e/a/s/o/n/s/check 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:r/e/a/s/o/n/e/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:r/e/a/s/o/n/i/check 
...
execute if block ~6 ~ ~ minecraft:white_concrete_powder run function wordlist:r/e/a/s/o/n/a/check 
