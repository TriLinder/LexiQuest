scoreboard players set @s word_id 9840 
...
execute if block ~9 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:r/e/a/r/r/a/n/g/e/d/check 
...
execute if block ~9 ~ ~ minecraft:magenta_wool run function wordlist:r/e/a/r/r/a/n/g/e/s/check 
