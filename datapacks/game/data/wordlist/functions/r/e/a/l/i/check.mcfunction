...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:r/e/a/l/i/s/check 
...
execute if block ~5 ~ ~ minecraft:light_blue_wool run function wordlist:r/e/a/l/i/t/check 
...
execute if block ~5 ~ ~ minecraft:cyan_wool run function wordlist:r/e/a/l/i/z/check 
