...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 19
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 19
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 19
...
execute if block ~2 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:r/e/d/c
...
execute if block ~2 ~ ~ minecraft:white_concrete_powder run function wordlist:r/e/a/c
...
execute if block ~2 ~ ~ minecraft:green_concrete_powder run function wordlist:r/e/n/c
...
execute if block ~2 ~ ~ minecraft:magenta_wool run function wordlist:r/e/s/c
...
execute if block ~2 ~ ~ minecraft:blue_concrete_powder run function wordlist:r/e/l/c
...
execute if block ~2 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:r/e/i/c
...
execute if block ~2 ~ ~ minecraft:black_concrete_powder run function wordlist:r/e/p/c
...
execute if block ~2 ~ ~ minecraft:lime_concrete_powder run function wordlist:r/e/f/c
...
execute if block ~2 ~ ~ minecraft:yellow_wool run function wordlist:r/e/u/c
...
execute if block ~2 ~ ~ minecraft:brown_concrete_powder run function wordlist:r/e/m/c
...
execute if block ~2 ~ ~ minecraft:orange_wool run function wordlist:r/e/r/c
...
execute if block ~2 ~ ~ minecraft:lime_wool run function wordlist:r/e/v/c
...
execute if block ~2 ~ ~ minecraft:magenta_concrete_powder run function wordlist:r/e/c/c
...
execute if block ~2 ~ ~ minecraft:light_blue_wool run function wordlist:r/e/t/c
...
execute if block ~2 ~ ~ minecraft:pink_concrete_powder run function wordlist:r/e/g/c
...
execute if block ~2 ~ ~ minecraft:cyan_concrete_powder run function wordlist:r/e/j/c
...
execute if block ~2 ~ ~ minecraft:pink_wool run function wordlist:r/e/w/c
...
execute if block ~2 ~ ~ minecraft:white_wool run function wordlist:r/e/q/c
...
execute if block ~2 ~ ~ minecraft:orange_concrete_powder run function wordlist:r/e/b/c
