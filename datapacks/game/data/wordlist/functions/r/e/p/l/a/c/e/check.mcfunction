scoreboard players set @s word_id 6294 
...
execute if block ~7 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:r/e/p/l/a/c/e/d/check 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:r/e/p/l/a/c/e/s/check 
...
execute if block ~7 ~ ~ minecraft:brown_concrete_powder run function wordlist:r/e/p/l/a/c/e/m/check 
