scoreboard players set @s word_id 2259 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:r/e/l/a/x/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:r/e/l/a/x/i/check 
