...
execute if block ~7 ~ ~ minecraft:green_concrete_powder run function wordlist:r/e/l/i/g/i/o/n/c
...
execute if block ~7 ~ ~ minecraft:yellow_wool run function wordlist:r/e/l/i/g/i/o/u/c
