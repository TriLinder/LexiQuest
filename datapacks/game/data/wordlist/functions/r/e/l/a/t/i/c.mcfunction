...
execute if block ~6 ~ ~ minecraft:lime_wool run function wordlist:r/e/l/a/t/i/v/c
...
execute if block ~6 ~ ~ minecraft:green_concrete_powder run function wordlist:r/e/l/a/t/i/n/c
...
execute if block ~6 ~ ~ minecraft:red_concrete_powder run function wordlist:r/e/l/a/t/i/o/c
