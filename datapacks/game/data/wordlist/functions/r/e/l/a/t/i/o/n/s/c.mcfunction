...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 10288
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 10288
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 10288
...
execute if block ~9 ~ ~ minecraft:gray_concrete_powder run function wordlist:r/e/l/a/t/i/o/n/s/h/c
