scoreboard players set @s word_id 247 
...
execute if block ~3 ~ ~ minecraft:yellow_wool run function wordlist:r/e/d/u/check 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:r/e/d/e/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:r/e/d/i/check 
