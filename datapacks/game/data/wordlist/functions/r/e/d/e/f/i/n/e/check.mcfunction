scoreboard players set @s word_id 8216 
...
execute if block ~8 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:r/e/d/e/f/i/n/e/d/check 
...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:r/e/d/e/f/i/n/e/s/check 
