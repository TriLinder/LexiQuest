scoreboard players set @s word_id 9866 
...
execute if block ~9 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:r/e/f/e/r/e/n/c/e/d/check 
...
execute if block ~9 ~ ~ minecraft:magenta_wool run function wordlist:r/e/f/e/r/e/n/c/e/s/check 
