...
execute if block ~5 ~ ~ minecraft:gray_wool run function wordlist:r/e/f/l/e/x/check 
...
execute if block ~5 ~ ~ minecraft:magenta_concrete_powder run function wordlist:r/e/f/l/e/c/check 
