scoreboard players set @s word_id 2257 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:r/e/f/e/r/s/check 
...
execute if block ~5 ~ ~ minecraft:orange_wool run function wordlist:r/e/f/e/r/r/check 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:r/e/f/e/r/e/check 
