scoreboard players set @s word_id 4162 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:r/e/r/e/a/d/s/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:r/e/r/e/a/d/i/check 
