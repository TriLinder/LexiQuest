scoreboard players set @s word_id 4142 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:r/e/g/i/o/n/s/check 
...
execute if block ~6 ~ ~ minecraft:white_concrete_powder run function wordlist:r/e/g/i/o/n/a/check 
