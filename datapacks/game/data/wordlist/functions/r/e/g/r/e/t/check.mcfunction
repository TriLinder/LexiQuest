scoreboard players set @s word_id 4143 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:r/e/g/r/e/t/s/check 
...
execute if block ~6 ~ ~ minecraft:light_blue_wool run function wordlist:r/e/g/r/e/t/t/check 
