...
execute if block ~5 ~ ~ minecraft:pink_concrete_powder run function wordlist:r/e/v/e/n/g/check 
...
execute if block ~5 ~ ~ minecraft:yellow_wool run function wordlist:r/e/v/e/n/u/check 
