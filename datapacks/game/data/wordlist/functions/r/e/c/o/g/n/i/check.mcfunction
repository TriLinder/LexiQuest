...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:r/e/c/o/g/n/i/s/check 
...
execute if block ~7 ~ ~ minecraft:cyan_wool run function wordlist:r/e/c/o/g/n/i/z/check 
...
execute if block ~7 ~ ~ minecraft:light_blue_wool run function wordlist:r/e/c/o/g/n/i/t/check 
