...
execute if block ~7 ~ ~ minecraft:lime_wool run function wordlist:r/e/c/u/r/s/i/v/c
...
execute if block ~7 ~ ~ minecraft:red_concrete_powder run function wordlist:r/e/c/u/r/s/i/o/c
