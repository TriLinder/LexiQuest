scoreboard players set @s word_id 6257 
...
execute if block ~7 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:r/e/c/y/c/l/e/d/check 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:r/e/c/y/c/l/e/s/check 
