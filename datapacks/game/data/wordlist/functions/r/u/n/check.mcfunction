scoreboard players set @s word_id 254 
...
execute if block ~3 ~ ~ minecraft:pink_concrete_powder run function wordlist:r/u/n/g/check 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:r/u/n/s/check 
...
execute if block ~3 ~ ~ minecraft:green_concrete_powder run function wordlist:r/u/n/n/check 
