scoreboard players set @s word_id 155 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:h/i/t/s/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:h/i/t/t/check 
...
execute if block ~3 ~ ~ minecraft:gray_concrete_powder run function wordlist:h/i/t/h/check 
