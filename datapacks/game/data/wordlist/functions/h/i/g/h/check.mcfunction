scoreboard players set @s word_id 688 
...
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run function wordlist:h/i/g/h/e/check 
...
execute if block ~4 ~ ~ minecraft:blue_concrete_powder run function wordlist:h/i/g/h/l/check 
...
execute if block ~4 ~ ~ minecraft:pink_wool run function wordlist:h/i/g/h/w/check 
