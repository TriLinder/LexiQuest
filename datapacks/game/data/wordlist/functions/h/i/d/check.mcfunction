scoreboard players set @s word_id 151 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:h/i/d/e/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:h/i/d/d/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:h/i/d/i/check 
