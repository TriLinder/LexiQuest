scoreboard players set @s word_id 686 
...
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run function wordlist:h/e/r/o/e/check 
...
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:h/e/r/o/i/check 
