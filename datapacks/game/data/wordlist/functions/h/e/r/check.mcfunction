scoreboard players set @s word_id 148 
...
execute if block ~3 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:h/e/r/d/check 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:h/e/r/e/check 
...
execute if block ~3 ~ ~ minecraft:red_concrete_powder run function wordlist:h/e/r/o/check 
...
execute if block ~3 ~ ~ minecraft:orange_wool run function wordlist:h/e/r/r/check 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:h/e/r/s/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:h/e/r/i/check 
