scoreboard players set @s word_id 1861 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:h/e/a/r/t/s/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:h/e/a/r/t/i/check 
