scoreboard players set @s word_id 145 
...
execute if block ~3 ~ ~ minecraft:gray_concrete_powder run function wordlist:h/a/s/h/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:h/a/s/t/check 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:h/a/s/s/check 
