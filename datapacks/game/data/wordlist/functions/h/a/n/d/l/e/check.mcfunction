scoreboard players set @s word_id 3520 
...
execute if block ~6 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:h/a/n/d/l/e/d/check 
...
execute if block ~6 ~ ~ minecraft:orange_wool run function wordlist:h/a/n/d/l/e/r/check 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:h/a/n/d/l/e/s/check 
