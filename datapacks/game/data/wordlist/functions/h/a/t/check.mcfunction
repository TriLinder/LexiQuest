scoreboard players set @s word_id 146 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:h/a/t/e/check 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:h/a/t/s/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:h/a/t/i/check 
...
execute if block ~3 ~ ~ minecraft:orange_wool run function wordlist:h/a/t/r/check 
