scoreboard players set @s word_id 3524 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:h/a/r/d/e/n/s/check 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:h/a/r/d/e/n/e/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:h/a/r/d/e/n/i/check 
