...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 696
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 696
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 696
...
execute if block ~4 ~ ~ minecraft:light_gray_wool run function wordlist:h/a/r/d/y/c
...
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run function wordlist:h/a/r/d/e/c
...
execute if block ~4 ~ ~ minecraft:blue_concrete_powder run function wordlist:h/a/r/d/l/c
...
execute if block ~4 ~ ~ minecraft:orange_concrete_powder run function wordlist:h/a/r/d/b/c
execute if block ~ ~ ~4 minecraft:orange_concrete_powder run scoreboard players set @s word_direction 1
execute if block ~ ~ ~4 minecraft:orange_concrete_powder run function wordlist:h/a/r/d/b/c
execute if block ~4 ~ ~ minecraft:magenta_wool run scoreboard players set @s word_direction 0
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:h/a/r/d/s/c
execute if block ~ ~ ~4 minecraft:magenta_wool run scoreboard players set @s word_direction 1
execute if block ~ ~ ~4 minecraft:magenta_wool run function wordlist:h/a/r/d/s/c
execute if block ~4 ~ ~ minecraft:pink_wool run scoreboard players set @s word_direction 0
execute if block ~4 ~ ~ minecraft:pink_wool run function wordlist:h/a/r/d/w/c
