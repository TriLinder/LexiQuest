scoreboard players set @s word_id 669 
...
execute if block ~4 ~ ~ minecraft:lime_concrete_powder run function wordlist:h/a/r/m/f/check 
...
execute if block ~4 ~ ~ minecraft:red_concrete_powder run function wordlist:h/a/r/m/o/check 
...
execute if block ~4 ~ ~ minecraft:blue_concrete_powder run function wordlist:h/a/r/m/l/check 
