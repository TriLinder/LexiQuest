scoreboard players set @s word_id 1187 
...
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:v/e/r/b/s/check 
execute if block ~ ~ ~4 minecraft:magenta_wool run scoreboard players set @s word_direction 1 
execute if block ~ ~ ~4 minecraft:magenta_wool run function wordlist:v/e/r/b/s/check 
execute if block ~4 ~ ~ minecraft:white_concrete_powder run scoreboard players set @s word_direction 0 
execute if block ~4 ~ ~ minecraft:white_concrete_powder run function wordlist:v/e/r/b/a/check 
...
execute if block ~4 ~ ~ minecraft:red_concrete_powder run function wordlist:v/e/r/b/o/check 
