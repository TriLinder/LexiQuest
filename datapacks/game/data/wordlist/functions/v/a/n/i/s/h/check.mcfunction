scoreboard players set @s word_id 4626 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:v/a/n/i/s/h/e/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:v/a/n/i/s/h/i/check 
