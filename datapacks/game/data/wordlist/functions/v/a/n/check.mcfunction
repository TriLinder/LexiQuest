scoreboard players set @s word_id 299 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:v/a/n/s/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:v/a/n/i/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:v/a/n/d/check 
