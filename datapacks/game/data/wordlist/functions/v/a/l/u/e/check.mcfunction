scoreboard players set @s word_id 2637 
...
execute if block ~5 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:v/a/l/u/e/d/check 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:v/a/l/u/e/s/check 
