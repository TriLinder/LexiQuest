scoreboard players set @s word_id 2092 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:n/i/g/h/t/s/check 
...
execute if block ~5 ~ ~ minecraft:brown_concrete_powder run function wordlist:n/i/g/h/t/m/check 
