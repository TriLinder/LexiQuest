scoreboard players set @s word_id 861 
...
execute if block ~4 ~ ~ minecraft:orange_wool run function wordlist:n/i/c/e/r/check 
...
execute if block ~4 ~ ~ minecraft:blue_concrete_powder run function wordlist:n/i/c/e/l/check 
execute if block ~ ~ ~4 minecraft:blue_concrete_powder run scoreboard players set @s word_direction 1 
execute if block ~ ~ ~4 minecraft:blue_concrete_powder run function wordlist:n/i/c/e/l/check 
execute if block ~4 ~ ~ minecraft:magenta_wool run scoreboard players set @s word_direction 0 
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:n/i/c/e/s/check 
