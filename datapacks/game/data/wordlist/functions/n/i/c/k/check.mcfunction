scoreboard players set @s word_id 862 
...
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:n/i/c/k/s/check 
execute if block ~ ~ ~4 minecraft:magenta_wool run scoreboard players set @s word_direction 1 
execute if block ~ ~ ~4 minecraft:magenta_wool run function wordlist:n/i/c/k/s/check 
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run scoreboard players set @s word_direction 0 
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run function wordlist:n/i/c/k/e/check 
...
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:n/i/c/k/i/check 
...
execute if block ~4 ~ ~ minecraft:green_concrete_powder run function wordlist:n/i/c/k/n/check 
