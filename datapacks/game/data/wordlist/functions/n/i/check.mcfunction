...
execute if block ~2 ~ ~ minecraft:blue_concrete_powder run function wordlist:n/i/l/check 
...
execute if block ~2 ~ ~ minecraft:magenta_concrete_powder run function wordlist:n/i/c/check 
...
execute if block ~2 ~ ~ minecraft:green_concrete_powder run function wordlist:n/i/n/check 
...
execute if block ~2 ~ ~ minecraft:pink_concrete_powder run function wordlist:n/i/g/check 
