scoreboard players set @s word_id 853 
...
execute if block ~4 ~ ~ minecraft:orange_concrete_powder run function wordlist:n/e/a/r/b/check 
...
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run function wordlist:n/e/a/r/e/check 
...
execute if block ~4 ~ ~ minecraft:blue_concrete_powder run function wordlist:n/e/a/r/l/check 
