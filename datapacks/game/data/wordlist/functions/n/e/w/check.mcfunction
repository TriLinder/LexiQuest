scoreboard players set @s word_id 205 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:n/e/w/s/check 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:n/e/w/e/check 
...
execute if block ~3 ~ ~ minecraft:blue_concrete_powder run function wordlist:n/e/w/l/check 
...
execute if block ~3 ~ ~ minecraft:magenta_concrete_powder run function wordlist:n/e/w/c/check 
