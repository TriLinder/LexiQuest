scoreboard players set @s word_id 859 
...
execute if block ~4 ~ ~ minecraft:black_concrete_powder run function wordlist:n/e/w/s/p/check 
...
execute if block ~4 ~ ~ minecraft:blue_concrete_powder run function wordlist:n/e/w/s/l/check 
