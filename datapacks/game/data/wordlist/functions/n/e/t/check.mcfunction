scoreboard players set @s word_id 204 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:n/e/t/s/check 
...
execute if block ~3 ~ ~ minecraft:pink_wool run function wordlist:n/e/t/w/check 
