scoreboard players set @s word_id 7919 
...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:n/e/i/g/h/b/o/r/s/check 
...
execute if block ~8 ~ ~ minecraft:gray_concrete_powder run function wordlist:n/e/i/g/h/b/o/r/h/check 
