...
execute if block ~7 ~ ~ minecraft:orange_wool run function wordlist:n/e/i/g/h/b/o/r/check 
...
execute if block ~7 ~ ~ minecraft:yellow_wool run function wordlist:n/e/i/g/h/b/o/u/check 
