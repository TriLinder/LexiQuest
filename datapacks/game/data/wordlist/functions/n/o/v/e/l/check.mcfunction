scoreboard players set @s word_id 2102 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:n/o/v/e/l/s/check 
...
execute if block ~5 ~ ~ minecraft:light_blue_wool run function wordlist:n/o/v/e/l/t/check 
