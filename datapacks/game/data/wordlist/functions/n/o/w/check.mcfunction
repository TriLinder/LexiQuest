scoreboard players set @s word_id 209 
...
execute if block ~3 ~ ~ minecraft:gray_concrete_powder run function wordlist:n/o/w/h/check 
...
execute if block ~3 ~ ~ minecraft:white_concrete_powder run function wordlist:n/o/w/a/check 
