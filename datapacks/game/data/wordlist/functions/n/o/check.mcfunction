scoreboard players set @s word_id 25 
...
execute if block ~2 ~ ~ minecraft:orange_wool run function wordlist:n/o/r/check 
...
execute if block ~2 ~ ~ minecraft:light_blue_wool run function wordlist:n/o/t/check 
...
execute if block ~2 ~ ~ minecraft:pink_wool run function wordlist:n/o/w/check 
...
execute if block ~2 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:n/o/d/check 
...
execute if block ~2 ~ ~ minecraft:green_concrete_powder run function wordlist:n/o/n/check 
...
execute if block ~2 ~ ~ minecraft:red_concrete_powder run function wordlist:n/o/o/check 
...
execute if block ~2 ~ ~ minecraft:magenta_wool run function wordlist:n/o/s/check 
...
execute if block ~2 ~ ~ minecraft:yellow_wool run function wordlist:n/o/u/check 
...
execute if block ~2 ~ ~ minecraft:orange_concrete_powder run function wordlist:n/o/b/check 
...
execute if block ~2 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:n/o/i/check 
...
execute if block ~2 ~ ~ minecraft:lime_wool run function wordlist:n/o/v/check 
...
execute if block ~2 ~ ~ minecraft:brown_concrete_powder run function wordlist:n/o/m/check 
