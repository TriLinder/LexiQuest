scoreboard players set @s word_id 207 
...
execute if block ~3 ~ ~ minecraft:brown_concrete_powder run function wordlist:n/o/r/m/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:n/o/r/t/check 
