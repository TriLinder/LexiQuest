...
execute if block ~1 ~ ~ minecraft:red_concrete_powder run function wordlist:n/o/c
...
execute if block ~1 ~ ~ minecraft:white_concrete_powder run function wordlist:n/a/c
...
execute if block ~1 ~ ~ minecraft:yellow_concrete_powder run function wordlist:n/e/c
...
execute if block ~1 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:n/i/c
...
execute if block ~1 ~ ~ minecraft:yellow_wool run function wordlist:n/u/c
