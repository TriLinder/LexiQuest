scoreboard players set @s word_id 3873 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:n/a/t/i/o/n/s/check 
...
execute if block ~6 ~ ~ minecraft:white_concrete_powder run function wordlist:n/a/t/i/o/n/a/check 
