scoreboard players set @s word_id 1801 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:g/l/e/a/n/s/check 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:g/l/e/a/n/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:g/l/e/a/n/i/check 
