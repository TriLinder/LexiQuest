scoreboard players set @s word_id 1833 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:g/u/e/s/s/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:g/u/e/s/s/i/check 
