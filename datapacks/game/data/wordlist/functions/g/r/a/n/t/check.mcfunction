scoreboard players set @s word_id 1816 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:g/r/a/n/t/s/check 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:g/r/a/n/t/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:g/r/a/n/t/i/check 
