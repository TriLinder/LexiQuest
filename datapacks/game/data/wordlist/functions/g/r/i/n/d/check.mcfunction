scoreboard players set @s word_id 1825 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:g/r/i/n/d/s/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:g/r/i/n/d/i/check 
