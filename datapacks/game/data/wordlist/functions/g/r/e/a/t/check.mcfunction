scoreboard players set @s word_id 1821 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:g/r/e/a/t/e/check 
...
execute if block ~5 ~ ~ minecraft:blue_concrete_powder run function wordlist:g/r/e/a/t/l/check 
