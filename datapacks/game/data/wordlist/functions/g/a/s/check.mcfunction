scoreboard players set @s word_id 132 
...
execute if block ~3 ~ ~ minecraft:black_concrete_powder run function wordlist:g/a/s/p/check 
...
execute if block ~3 ~ ~ minecraft:red_concrete_powder run function wordlist:g/a/s/o/check 
