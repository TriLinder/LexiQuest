...
execute if block ~2 ~ ~ minecraft:black_concrete_powder run function wordlist:g/a/p/check 
...
execute if block ~2 ~ ~ minecraft:magenta_wool run function wordlist:g/a/s/check 
...
execute if block ~2 ~ ~ minecraft:light_gray_wool run function wordlist:g/a/y/check 
...
execute if block ~2 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:g/a/i/check 
...
execute if block ~2 ~ ~ minecraft:brown_concrete_powder run function wordlist:g/a/m/check 
...
execute if block ~2 ~ ~ minecraft:green_concrete_powder run function wordlist:g/a/n/check 
...
execute if block ~2 ~ ~ minecraft:light_blue_wool run function wordlist:g/a/t/check 
...
execute if block ~2 ~ ~ minecraft:lime_wool run function wordlist:g/a/v/check 
...
execute if block ~2 ~ ~ minecraft:blue_concrete_powder run function wordlist:g/a/l/check 
...
execute if block ~2 ~ ~ minecraft:orange_wool run function wordlist:g/a/r/check 
