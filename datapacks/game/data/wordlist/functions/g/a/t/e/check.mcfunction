scoreboard players set @s word_id 627 
...
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:g/a/t/e/s/check 
execute if block ~ ~ ~4 minecraft:magenta_wool run scoreboard players set @s word_direction 1 
execute if block ~ ~ ~4 minecraft:magenta_wool run function wordlist:g/a/t/e/s/check 
execute if block ~4 ~ ~ minecraft:pink_wool run scoreboard players set @s word_direction 0 
execute if block ~4 ~ ~ minecraft:pink_wool run function wordlist:g/a/t/e/w/check 
