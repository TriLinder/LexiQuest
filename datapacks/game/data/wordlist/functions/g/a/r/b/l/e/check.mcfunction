scoreboard players set @s word_id 3461 
...
execute if block ~6 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:g/a/r/b/l/e/d/check 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:g/a/r/b/l/e/s/check 
