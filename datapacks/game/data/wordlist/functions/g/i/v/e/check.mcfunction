scoreboard players set @s word_id 634 
...
execute if block ~4 ~ ~ minecraft:green_concrete_powder run function wordlist:g/i/v/e/n/check 
execute if block ~ ~ ~4 minecraft:green_concrete_powder run scoreboard players set @s word_direction 1 
execute if block ~ ~ ~4 minecraft:green_concrete_powder run function wordlist:g/i/v/e/n/check 
execute if block ~4 ~ ~ minecraft:magenta_wool run scoreboard players set @s word_direction 0 
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:g/i/v/e/s/check 
