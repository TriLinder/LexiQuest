scoreboard players set @s word_id 630 
...
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:g/e/n/e/s/check 
execute if block ~ ~ ~4 minecraft:magenta_wool run scoreboard players set @s word_direction 1 
execute if block ~ ~ ~4 minecraft:magenta_wool run function wordlist:g/e/n/e/s/check 
execute if block ~4 ~ ~ minecraft:orange_wool run scoreboard players set @s word_direction 0 
execute if block ~4 ~ ~ minecraft:orange_wool run function wordlist:g/e/n/e/r/check 
...
execute if block ~4 ~ ~ minecraft:light_blue_wool run function wordlist:g/e/n/e/t/check 
