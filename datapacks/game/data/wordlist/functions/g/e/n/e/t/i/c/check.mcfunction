scoreboard players set @s word_id 5567 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:g/e/n/e/t/i/c/s/check 
...
execute if block ~7 ~ ~ minecraft:white_concrete_powder run function wordlist:g/e/n/e/t/i/c/a/check 
