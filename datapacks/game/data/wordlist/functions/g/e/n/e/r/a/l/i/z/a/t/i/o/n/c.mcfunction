...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 12800
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 12800
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 12800
...
execute if block ~14 ~ ~ minecraft:magenta_wool run function wordlist:g/e/n/e/r/a/l/i/z/a/t/i/o/n/s/c
