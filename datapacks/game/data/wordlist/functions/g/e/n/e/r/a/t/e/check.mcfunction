scoreboard players set @s word_id 7594 
...
execute if block ~8 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:g/e/n/e/r/a/t/e/d/check 
...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:g/e/n/e/r/a/t/e/s/check 
