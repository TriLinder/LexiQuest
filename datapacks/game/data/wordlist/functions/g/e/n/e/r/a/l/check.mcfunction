scoreboard players set @s word_id 5565 
...
execute if block ~7 ~ ~ minecraft:blue_concrete_powder run function wordlist:g/e/n/e/r/a/l/l/check 
...
execute if block ~7 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:g/e/n/e/r/a/l/i/check 
