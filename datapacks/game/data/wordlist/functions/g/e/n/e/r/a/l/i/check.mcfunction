...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:g/e/n/e/r/a/l/i/s/check 
...
execute if block ~8 ~ ~ minecraft:cyan_wool run function wordlist:g/e/n/e/r/a/l/i/z/check 
