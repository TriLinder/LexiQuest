scoreboard players set @s word_id 134 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:g/e/t/s/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:g/e/t/t/check 
