scoreboard players set @s word_id 24 
...
execute if block ~2 ~ ~ minecraft:light_blue_wool run function wordlist:m/y/t/check 
...
execute if block ~2 ~ ~ minecraft:magenta_wool run function wordlist:m/y/s/check 
