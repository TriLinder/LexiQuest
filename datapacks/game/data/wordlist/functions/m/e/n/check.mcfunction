scoreboard players set @s word_id 194 
...
execute if block ~3 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:m/e/n/d/check 
...
execute if block ~3 ~ ~ minecraft:yellow_wool run function wordlist:m/e/n/u/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:m/e/n/t/check 
