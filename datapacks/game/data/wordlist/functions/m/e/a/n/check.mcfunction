scoreboard players set @s word_id 818 
...
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:m/e/a/n/s/check 
execute if block ~ ~ ~4 minecraft:magenta_wool run scoreboard players set @s word_direction 1 
execute if block ~ ~ ~4 minecraft:magenta_wool run function wordlist:m/e/a/n/s/check 
execute if block ~4 ~ ~ minecraft:light_blue_wool run scoreboard players set @s word_direction 0 
execute if block ~4 ~ ~ minecraft:light_blue_wool run function wordlist:m/e/a/n/t/check 
...
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:m/e/a/n/i/check 
...
execute if block ~4 ~ ~ minecraft:pink_wool run function wordlist:m/e/a/n/w/check 
