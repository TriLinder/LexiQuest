scoreboard players set @s word_id 5874 
...
execute if block ~7 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:m/e/a/s/u/r/e/d/check 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:m/e/a/s/u/r/e/s/check 
...
execute if block ~7 ~ ~ minecraft:brown_concrete_powder run function wordlist:m/e/a/s/u/r/e/m/check 
