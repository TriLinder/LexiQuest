scoreboard players set @s word_id 2036 
...
execute if block ~5 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:m/e/r/g/e/d/check 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:m/e/r/g/e/s/check 
