scoreboard players set @s word_id 7836 
...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:m/e/c/h/a/n/i/c/s/check 
...
execute if block ~8 ~ ~ minecraft:white_concrete_powder run function wordlist:m/e/c/h/a/n/i/c/a/check 
