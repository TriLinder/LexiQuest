...
execute if block ~5 ~ ~ minecraft:gray_wool run function wordlist:m/a/t/r/i/x/c
...
execute if block ~5 ~ ~ minecraft:magenta_concrete_powder run function wordlist:m/a/t/r/i/c/c
