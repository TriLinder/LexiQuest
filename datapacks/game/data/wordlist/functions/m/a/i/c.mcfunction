...
execute if block ~3 ~ ~ minecraft:blue_concrete_powder run function wordlist:m/a/i/l/c
...
execute if block ~3 ~ ~ minecraft:green_concrete_powder run function wordlist:m/a/i/n/c
...
execute if block ~3 ~ ~ minecraft:cyan_wool run function wordlist:m/a/i/z/c
