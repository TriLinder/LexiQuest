...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 262
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 262
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 262
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:m/a/d/e/c
...
execute if block ~3 ~ ~ minecraft:green_concrete_powder run function wordlist:m/a/d/n/c
