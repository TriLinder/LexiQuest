scoreboard players set @s word_id 190 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:m/a/d/e/check 
...
execute if block ~3 ~ ~ minecraft:green_concrete_powder run function wordlist:m/a/d/n/check 
