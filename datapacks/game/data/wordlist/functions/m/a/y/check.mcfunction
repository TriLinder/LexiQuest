scoreboard players set @s word_id 193 
...
execute if block ~3 ~ ~ minecraft:orange_concrete_powder run function wordlist:m/a/y/b/check 
...
execute if block ~3 ~ ~ minecraft:red_concrete_powder run function wordlist:m/a/y/o/check 
