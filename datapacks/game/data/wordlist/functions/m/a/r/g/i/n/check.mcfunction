scoreboard players set @s word_id 3781 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:m/a/r/g/i/n/s/check 
...
execute if block ~6 ~ ~ minecraft:white_concrete_powder run function wordlist:m/a/r/g/i/n/a/check 
