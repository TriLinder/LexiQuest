scoreboard players set @s word_id 3785 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:m/a/r/k/e/t/s/check 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:m/a/r/k/e/t/e/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:m/a/r/k/e/t/i/check 
