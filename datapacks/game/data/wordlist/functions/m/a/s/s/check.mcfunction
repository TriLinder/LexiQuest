scoreboard players set @s word_id 814 
...
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run function wordlist:m/a/s/s/e/check 
...
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:m/a/s/s/i/check 
