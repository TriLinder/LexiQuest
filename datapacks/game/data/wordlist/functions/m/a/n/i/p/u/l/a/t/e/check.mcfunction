scoreboard players set @s word_id 10854 
...
execute if block ~10 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:m/a/n/i/p/u/l/a/t/e/d/check 
...
execute if block ~10 ~ ~ minecraft:magenta_wool run function wordlist:m/a/n/i/p/u/l/a/t/e/s/check 
