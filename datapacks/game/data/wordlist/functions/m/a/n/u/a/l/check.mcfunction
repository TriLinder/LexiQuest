scoreboard players set @s word_id 3779 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:m/a/n/u/a/l/s/check 
...
execute if block ~6 ~ ~ minecraft:blue_concrete_powder run function wordlist:m/a/n/u/a/l/l/check 
