scoreboard players set @s word_id 3776 
...
execute if block ~6 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:m/a/n/g/l/e/d/check 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:m/a/n/g/l/e/s/check 
