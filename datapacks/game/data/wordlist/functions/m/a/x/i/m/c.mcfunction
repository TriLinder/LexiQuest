...
execute if block ~5 ~ ~ minecraft:yellow_wool run function wordlist:m/a/x/i/m/u/c
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:m/a/x/i/m/i/c
