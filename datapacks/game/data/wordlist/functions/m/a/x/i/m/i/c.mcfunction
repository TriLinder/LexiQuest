...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:m/a/x/i/m/i/s/c
...
execute if block ~6 ~ ~ minecraft:cyan_wool run function wordlist:m/a/x/i/m/i/z/c
