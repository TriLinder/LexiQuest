execute if block ~1 ~ ~ minecraft:light_gray_wool run scoreboard players set @s word_direction 0
execute if block ~1 ~ ~ minecraft:light_gray_wool run function wordlist:m/y/c
execute if block ~ ~ ~1 minecraft:light_gray_wool run scoreboard players set @s word_direction 1
execute if block ~ ~ ~1 minecraft:light_gray_wool run function wordlist:m/y/c
execute if block ~1 ~ ~ minecraft:yellow_concrete_powder run scoreboard players set @s word_direction 0
execute if block ~1 ~ ~ minecraft:yellow_concrete_powder run function wordlist:m/e/c
...
execute if block ~1 ~ ~ minecraft:orange_wool run function wordlist:m/r/c
...
execute if block ~1 ~ ~ minecraft:white_concrete_powder run function wordlist:m/a/c
...
execute if block ~1 ~ ~ minecraft:yellow_wool run function wordlist:m/u/c
...
execute if block ~1 ~ ~ minecraft:red_concrete_powder run function wordlist:m/o/c
...
execute if block ~1 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:m/i/c
...
execute if block ~1 ~ ~ minecraft:green_concrete_powder run function wordlist:m/n/c
