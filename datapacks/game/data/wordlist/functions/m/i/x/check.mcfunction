scoreboard players set @s word_id 196 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:m/i/x/e/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:m/i/x/i/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:m/i/x/t/check 
