...
execute if block ~5 ~ ~ minecraft:pink_wool run function wordlist:m/i/c/r/o/w/c
...
execute if block ~5 ~ ~ minecraft:magenta_concrete_powder run function wordlist:m/i/c/r/o/c/c
...
execute if block ~5 ~ ~ minecraft:black_concrete_powder run function wordlist:m/i/c/r/o/p/c
