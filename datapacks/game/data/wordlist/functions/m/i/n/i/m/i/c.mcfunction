...
execute if block ~6 ~ ~ minecraft:cyan_wool run function wordlist:m/i/n/i/m/i/z/c
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:m/i/n/i/m/i/s/c
