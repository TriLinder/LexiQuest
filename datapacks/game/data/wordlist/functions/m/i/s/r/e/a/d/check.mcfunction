scoreboard players set @s word_id 5900 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:m/i/s/r/e/a/d/s/check 
...
execute if block ~7 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:m/i/s/r/e/a/d/i/check 
