scoreboard players set @s word_id 5904 
...
execute if block ~7 ~ ~ minecraft:green_concrete_powder run function wordlist:m/i/s/t/a/k/e/n/check 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:m/i/s/t/a/k/e/s/check 
