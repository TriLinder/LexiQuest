scoreboard players set @s word_id 3846 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:m/o/r/t/a/l/s/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:m/o/r/t/a/l/i/check 
