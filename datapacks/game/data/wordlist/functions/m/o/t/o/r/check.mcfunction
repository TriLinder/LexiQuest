scoreboard players set @s word_id 2063 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:m/o/t/o/r/s/check 
...
execute if block ~5 ~ ~ minecraft:pink_wool run function wordlist:m/o/t/o/r/w/check 
