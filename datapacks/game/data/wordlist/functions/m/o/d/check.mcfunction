scoreboard players set @s word_id 198 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:m/o/d/e/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:m/o/d/i/check 
...
execute if block ~3 ~ ~ minecraft:yellow_wool run function wordlist:m/o/d/u/check 
