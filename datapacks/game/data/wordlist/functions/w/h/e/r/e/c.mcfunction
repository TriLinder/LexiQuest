...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 1606
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 1606
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 1606
...
execute if block ~5 ~ ~ minecraft:orange_concrete_powder run function wordlist:w/h/e/r/e/b/c
...
execute if block ~5 ~ ~ minecraft:white_concrete_powder run function wordlist:w/h/e/r/e/a/c
...
execute if block ~5 ~ ~ minecraft:lime_wool run function wordlist:w/h/e/r/e/v/c
...
execute if block ~5 ~ ~ minecraft:yellow_wool run function wordlist:w/h/e/r/e/u/c
