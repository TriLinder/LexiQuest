scoreboard players set @s word_id 1220 
...
execute if block ~4 ~ ~ minecraft:magenta_concrete_powder run function wordlist:w/h/e/n/c/check 
...
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run function wordlist:w/h/e/n/e/check 
