...
execute if block ~1 ~ ~ minecraft:yellow_concrete_powder run function wordlist:w/e/c
...
execute if block ~1 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:w/i/c
...
execute if block ~1 ~ ~ minecraft:red_concrete_powder run function wordlist:w/o/c
...
execute if block ~1 ~ ~ minecraft:white_concrete_powder run function wordlist:w/a/c
...
execute if block ~1 ~ ~ minecraft:gray_concrete_powder run function wordlist:w/h/c
...
execute if block ~1 ~ ~ minecraft:orange_wool run function wordlist:w/r/c
