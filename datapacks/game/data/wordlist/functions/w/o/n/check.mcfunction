scoreboard players set @s word_id 313 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:w/o/n/t/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:w/o/n/d/check 
