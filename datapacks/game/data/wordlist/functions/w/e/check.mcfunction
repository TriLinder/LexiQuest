scoreboard players set @s word_id 36 
...
execute if block ~2 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:w/e/d/check 
...
execute if block ~2 ~ ~ minecraft:yellow_concrete_powder run function wordlist:w/e/e/check 
...
execute if block ~2 ~ ~ minecraft:light_blue_wool run function wordlist:w/e/t/check 
...
execute if block ~2 ~ ~ minecraft:white_concrete_powder run function wordlist:w/e/a/check 
...
execute if block ~2 ~ ~ minecraft:blue_concrete_powder run function wordlist:w/e/l/check 
...
execute if block ~2 ~ ~ minecraft:green_concrete_powder run function wordlist:w/e/n/check 
...
execute if block ~2 ~ ~ minecraft:orange_wool run function wordlist:w/e/r/check 
...
execute if block ~2 ~ ~ minecraft:magenta_wool run function wordlist:w/e/s/check 
...
execute if block ~2 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:w/e/i/check 
