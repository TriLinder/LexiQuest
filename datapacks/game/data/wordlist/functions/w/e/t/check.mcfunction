scoreboard players set @s word_id 308 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:w/e/t/s/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:w/e/t/t/check 
