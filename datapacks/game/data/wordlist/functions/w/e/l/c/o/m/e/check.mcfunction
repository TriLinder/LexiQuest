scoreboard players set @s word_id 6791 
...
execute if block ~7 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:w/e/l/c/o/m/e/d/check 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:w/e/l/c/o/m/e/s/check 
