...
execute if block ~2 ~ ~ minecraft:orange_wool run function wordlist:w/a/r/check 
...
execute if block ~2 ~ ~ minecraft:magenta_wool run function wordlist:w/a/s/check 
...
execute if block ~2 ~ ~ minecraft:light_gray_wool run function wordlist:w/a/y/check 
...
execute if block ~2 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:w/a/d/check 
...
execute if block ~2 ~ ~ minecraft:pink_concrete_powder run function wordlist:w/a/g/check 
...
execute if block ~2 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:w/a/i/check 
...
execute if block ~2 ~ ~ minecraft:purple_concrete_powder run function wordlist:w/a/k/check 
...
execute if block ~2 ~ ~ minecraft:blue_concrete_powder run function wordlist:w/a/l/check 
...
execute if block ~2 ~ ~ minecraft:green_concrete_powder run function wordlist:w/a/n/check 
...
execute if block ~2 ~ ~ minecraft:lime_wool run function wordlist:w/a/v/check 
...
execute if block ~2 ~ ~ minecraft:light_blue_wool run function wordlist:w/a/t/check 
...
execute if block ~2 ~ ~ minecraft:lime_concrete_powder run function wordlist:w/a/f/check 
