scoreboard players set @s word_id 4667 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:w/a/n/d/e/r/s/check 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:w/a/n/d/e/r/e/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:w/a/n/d/e/r/i/check 
