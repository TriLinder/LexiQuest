scoreboard players set @s word_id 303 
...
execute if block ~3 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:w/a/r/d/check 
...
execute if block ~3 ~ ~ minecraft:brown_concrete_powder run function wordlist:w/a/r/m/check 
...
execute if block ~3 ~ ~ minecraft:green_concrete_powder run function wordlist:w/a/r/n/check 
...
execute if block ~3 ~ ~ minecraft:black_concrete_powder run function wordlist:w/a/r/p/check 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:w/a/r/s/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_wool run function wordlist:w/a/r/y/check 
...
execute if block ~3 ~ ~ minecraft:orange_wool run function wordlist:w/a/r/r/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:w/a/r/t/check 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:w/a/r/e/check 
