scoreboard players set @s word_id 1207 
...
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run function wordlist:w/a/s/h/e/check 
...
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:w/a/s/h/i/check 
