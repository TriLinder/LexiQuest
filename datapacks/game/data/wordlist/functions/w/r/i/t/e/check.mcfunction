scoreboard players set @s word_id 2727 
...
execute if block ~5 ~ ~ minecraft:orange_wool run function wordlist:w/r/i/t/e/r/check 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:w/r/i/t/e/s/check 
