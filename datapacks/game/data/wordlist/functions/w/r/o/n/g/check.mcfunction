scoreboard players set @s word_id 2728 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:w/r/o/n/g/s/check 
...
execute if block ~5 ~ ~ minecraft:blue_concrete_powder run function wordlist:w/r/o/n/g/l/check 
