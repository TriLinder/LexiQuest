...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 48
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 48
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 48
...
execute if block ~3 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:w/i/n/d/c
...
execute if block ~3 ~ ~ minecraft:pink_concrete_powder run function wordlist:w/i/n/g/c
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:w/i/n/s/c
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:w/i/n/e/c
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:w/i/n/t/c
...
execute if block ~3 ~ ~ minecraft:green_concrete_powder run function wordlist:w/i/n/n/c
