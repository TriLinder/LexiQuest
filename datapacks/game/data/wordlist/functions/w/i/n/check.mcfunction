scoreboard players set @s word_id 311 
...
execute if block ~3 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:w/i/n/d/check 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:w/i/n/e/check 
...
execute if block ~3 ~ ~ minecraft:pink_concrete_powder run function wordlist:w/i/n/g/check 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:w/i/n/s/check 
...
execute if block ~3 ~ ~ minecraft:green_concrete_powder run function wordlist:w/i/n/n/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:w/i/n/t/check 
