scoreboard players set @s word_id 312 
...
execute if block ~3 ~ ~ minecraft:gray_concrete_powder run function wordlist:w/i/t/h/check 
...
execute if block ~3 ~ ~ minecraft:magenta_concrete_powder run function wordlist:w/i/t/c/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:w/i/t/t/check 
...
execute if block ~3 ~ ~ minecraft:green_concrete_powder run function wordlist:w/i/t/n/check 
