...
execute if block ~7 ~ ~ minecraft:lime_concrete_powder run function wordlist:y/o/u/r/s/e/l/f/check 
...
execute if block ~7 ~ ~ minecraft:lime_wool run function wordlist:y/o/u/r/s/e/l/v/check 
