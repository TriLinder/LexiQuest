scoreboard players set @s word_id 3040 
...
execute if block ~6 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:c/h/a/r/g/e/d/check 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:c/h/a/r/g/e/s/check 
