scoreboard players set @s word_id 3035 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:c/h/a/n/c/e/s/check 
...
execute if block ~6 ~ ~ minecraft:blue_concrete_powder run function wordlist:c/h/a/n/c/e/l/check 
