scoreboard players set @s word_id 1466 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:c/h/a/i/r/s/check 
...
execute if block ~5 ~ ~ minecraft:brown_concrete_powder run function wordlist:c/h/a/i/r/m/check 
