scoreboard players set @s word_id 1472 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:c/h/a/r/t/s/check 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:c/h/a/r/t/e/check 
