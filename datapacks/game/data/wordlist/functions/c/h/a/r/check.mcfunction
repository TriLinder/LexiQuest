scoreboard players set @s word_id 442 
...
execute if block ~4 ~ ~ minecraft:brown_concrete_powder run function wordlist:c/h/a/r/m/check 
execute if block ~ ~ ~4 minecraft:brown_concrete_powder run scoreboard players set @s word_direction 1 
execute if block ~ ~ ~4 minecraft:brown_concrete_powder run function wordlist:c/h/a/r/m/check 
execute if block ~4 ~ ~ minecraft:magenta_wool run scoreboard players set @s word_direction 0 
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:c/h/a/r/s/check 
execute if block ~ ~ ~4 minecraft:magenta_wool run scoreboard players set @s word_direction 1 
execute if block ~ ~ ~4 minecraft:magenta_wool run function wordlist:c/h/a/r/s/check 
execute if block ~4 ~ ~ minecraft:light_blue_wool run scoreboard players set @s word_direction 0 
execute if block ~4 ~ ~ minecraft:light_blue_wool run function wordlist:c/h/a/r/t/check 
...
execute if block ~4 ~ ~ minecraft:pink_concrete_powder run function wordlist:c/h/a/r/g/check 
...
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:c/h/a/r/i/check 
...
execute if block ~4 ~ ~ minecraft:white_concrete_powder run function wordlist:c/h/a/r/a/check 
