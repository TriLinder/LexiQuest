scoreboard players set @s word_id 8907 
...
execute if block ~9 ~ ~ minecraft:magenta_wool run function wordlist:c/h/a/r/a/c/t/e/r/s/check 
...
execute if block ~9 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:c/h/a/r/a/c/t/e/r/i/check 
