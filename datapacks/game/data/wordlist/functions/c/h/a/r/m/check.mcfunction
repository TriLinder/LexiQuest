scoreboard players set @s word_id 1470 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:c/h/a/r/m/s/check 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:c/h/a/r/m/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:c/h/a/r/m/i/check 
