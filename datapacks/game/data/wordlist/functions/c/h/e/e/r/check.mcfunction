scoreboard players set @s word_id 1479 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:c/h/e/e/r/s/check 
...
execute if block ~5 ~ ~ minecraft:lime_concrete_powder run function wordlist:c/h/e/e/r/f/check 
