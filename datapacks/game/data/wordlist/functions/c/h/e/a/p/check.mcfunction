scoreboard players set @s word_id 1475 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:c/h/e/a/p/e/check 
...
execute if block ~5 ~ ~ minecraft:blue_concrete_powder run function wordlist:c/h/e/a/p/l/check 
