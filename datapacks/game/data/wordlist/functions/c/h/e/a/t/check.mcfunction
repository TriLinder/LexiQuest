scoreboard players set @s word_id 1476 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:c/h/e/a/t/s/check 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:c/h/e/a/t/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:c/h/e/a/t/i/check 
