...
execute if block ~4 ~ ~ minecraft:purple_concrete_powder run function wordlist:c/h/e/e/k/c
...
execute if block ~4 ~ ~ minecraft:orange_wool run function wordlist:c/h/e/e/r/c
execute if block ~ ~ ~4 minecraft:orange_wool run scoreboard players set @s word_direction 1
execute if block ~ ~ ~4 minecraft:orange_wool run function wordlist:c/h/e/e/r/c
execute if block ~4 ~ ~ minecraft:magenta_wool run scoreboard players set @s word_direction 0
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:c/h/e/e/s/c
