scoreboard players set @s word_id 94 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:c/u/p/s/check 
...
execute if block ~3 ~ ~ minecraft:orange_concrete_powder run function wordlist:c/u/p/b/check 
