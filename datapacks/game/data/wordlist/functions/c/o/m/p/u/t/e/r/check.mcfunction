scoreboard players set @s word_id 7161 
...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:c/o/m/p/u/t/e/r/s/check 
...
execute if block ~8 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:c/o/m/p/u/t/e/r/i/check 
