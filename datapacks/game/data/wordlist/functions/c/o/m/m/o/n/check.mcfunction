scoreboard players set @s word_id 3105 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:c/o/m/m/o/n/s/check 
...
execute if block ~6 ~ ~ minecraft:blue_concrete_powder run function wordlist:c/o/m/m/o/n/l/check 
