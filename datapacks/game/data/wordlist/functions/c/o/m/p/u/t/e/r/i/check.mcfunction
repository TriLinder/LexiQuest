...
execute if block ~9 ~ ~ minecraft:magenta_wool run function wordlist:c/o/m/p/u/t/e/r/i/s/check 
...
execute if block ~9 ~ ~ minecraft:cyan_wool run function wordlist:c/o/m/p/u/t/e/r/i/z/check 
