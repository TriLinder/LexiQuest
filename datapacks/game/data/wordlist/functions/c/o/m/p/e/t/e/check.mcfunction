scoreboard players set @s word_id 5106 
...
execute if block ~7 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:c/o/m/p/e/t/e/d/check 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:c/o/m/p/e/t/e/s/check 
...
execute if block ~7 ~ ~ minecraft:green_concrete_powder run function wordlist:c/o/m/p/e/t/e/n/check 
