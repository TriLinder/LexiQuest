scoreboard players set @s word_id 5098 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:c/o/m/m/a/n/d/s/check 
...
execute if block ~7 ~ ~ minecraft:brown_concrete_powder run function wordlist:c/o/m/m/a/n/d/m/check 
