...
execute if block ~8 ~ ~ minecraft:orange_wool run function wordlist:c/o/m/m/e/n/t/a/r/check 
...
execute if block ~8 ~ ~ minecraft:light_blue_wool run function wordlist:c/o/m/m/e/n/t/a/t/check 
