scoreboard players set @s word_id 3106 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:c/o/m/p/e/l/s/check 
...
execute if block ~6 ~ ~ minecraft:blue_concrete_powder run function wordlist:c/o/m/p/e/l/l/check 
