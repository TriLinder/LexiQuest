...
execute if block ~9 ~ ~ minecraft:red_concrete_powder run function wordlist:c/o/m/p/e/t/i/t/i/o/check 
...
execute if block ~9 ~ ~ minecraft:lime_wool run function wordlist:c/o/m/p/e/t/i/t/i/v/check 
