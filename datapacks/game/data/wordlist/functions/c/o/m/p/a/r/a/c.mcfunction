...
execute if block ~7 ~ ~ minecraft:orange_concrete_powder run function wordlist:c/o/m/p/a/r/a/b/c
...
execute if block ~7 ~ ~ minecraft:light_blue_wool run function wordlist:c/o/m/p/a/r/a/t/c
