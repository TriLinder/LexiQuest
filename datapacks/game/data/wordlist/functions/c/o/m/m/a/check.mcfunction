scoreboard players set @s word_id 1523 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:c/o/m/m/a/s/check 
...
execute if block ~5 ~ ~ minecraft:green_concrete_powder run function wordlist:c/o/m/m/a/n/check 
