...
execute if block ~11 ~ ~ minecraft:green_concrete_powder run function wordlist:c/o/m/m/u/n/i/c/a/t/i/n/c
...
execute if block ~11 ~ ~ minecraft:red_concrete_powder run function wordlist:c/o/m/m/u/n/i/c/a/t/i/o/c
