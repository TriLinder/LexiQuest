...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 6055
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 6055
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 6055
...
execute if block ~7 ~ ~ minecraft:black_concrete_powder run function wordlist:c/o/u/n/t/e/r/p/c
...
execute if block ~7 ~ ~ minecraft:yellow_concrete_powder run function wordlist:c/o/u/n/t/e/r/e/c
