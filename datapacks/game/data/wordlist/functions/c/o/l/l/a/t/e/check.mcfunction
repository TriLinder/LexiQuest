scoreboard players set @s word_id 5087 
...
execute if block ~7 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:c/o/l/l/a/t/e/d/check 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:c/o/l/l/a/t/e/s/check 
