...
execute if block ~8 ~ ~ minecraft:green_concrete_powder run function wordlist:c/o/l/l/e/c/t/i/n/check 
...
execute if block ~8 ~ ~ minecraft:red_concrete_powder run function wordlist:c/o/l/l/e/c/t/i/o/check 
...
execute if block ~8 ~ ~ minecraft:lime_wool run function wordlist:c/o/l/l/e/c/t/i/v/check 
