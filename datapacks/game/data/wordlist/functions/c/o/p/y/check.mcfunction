scoreboard players set @s word_id 463 
...
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:c/o/p/y/i/check 
...
execute if block ~4 ~ ~ minecraft:orange_wool run function wordlist:c/o/p/y/r/check 
