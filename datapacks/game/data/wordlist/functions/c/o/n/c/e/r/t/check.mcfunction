scoreboard players set @s word_id 5115 
...
execute if block ~7 ~ ~ minecraft:red_concrete_powder run function wordlist:c/o/n/c/e/r/t/o/check 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:c/o/n/c/e/r/t/s/check 
