scoreboard players set @s word_id 7172 
...
execute if block ~8 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:c/o/n/d/e/n/s/e/d/check 
...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:c/o/n/d/e/n/s/e/s/check 
