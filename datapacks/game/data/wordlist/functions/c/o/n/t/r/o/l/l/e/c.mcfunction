...
execute if block ~9 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:c/o/n/t/r/o/l/l/e/d/c
...
execute if block ~9 ~ ~ minecraft:orange_wool run function wordlist:c/o/n/t/r/o/l/l/e/r/c
