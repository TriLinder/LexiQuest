...
execute if block ~9 ~ ~ minecraft:light_blue_wool run function wordlist:c/o/n/s/i/s/t/e/n/t/c
...
execute if block ~9 ~ ~ minecraft:magenta_concrete_powder run function wordlist:c/o/n/s/i/s/t/e/n/c/c
