scoreboard players set @s word_id 5122 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:c/o/n/f/i/r/m/s/check 
...
execute if block ~7 ~ ~ minecraft:yellow_concrete_powder run function wordlist:c/o/n/f/i/r/m/e/check 
...
execute if block ~7 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:c/o/n/f/i/r/m/i/check 
...
execute if block ~7 ~ ~ minecraft:white_concrete_powder run function wordlist:c/o/n/f/i/r/m/a/check 
