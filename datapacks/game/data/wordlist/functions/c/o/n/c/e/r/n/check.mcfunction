scoreboard players set @s word_id 5114 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:c/o/n/c/e/r/n/s/check 
...
execute if block ~7 ~ ~ minecraft:yellow_concrete_powder run function wordlist:c/o/n/c/e/r/n/e/check 
...
execute if block ~7 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:c/o/n/c/e/r/n/i/check 
