scoreboard players set @s word_id 7197 
...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:c/o/n/t/r/a/c/t/s/check 
...
execute if block ~8 ~ ~ minecraft:yellow_concrete_powder run function wordlist:c/o/n/t/r/a/c/t/e/check 
...
execute if block ~8 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:c/o/n/t/r/a/c/t/i/check 
