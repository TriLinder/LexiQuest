...
execute if block ~10 ~ ~ minecraft:light_gray_wool run function wordlist:c/o/n/t/r/o/v/e/r/s/y/c
...
execute if block ~10 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:c/o/n/t/r/o/v/e/r/s/i/c
