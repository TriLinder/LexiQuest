...
execute if block ~11 ~ ~ minecraft:yellow_concrete_powder run function wordlist:c/o/n/s/i/d/e/r/a/b/l/e/check 
...
execute if block ~11 ~ ~ minecraft:light_gray_wool run function wordlist:c/o/n/s/i/d/e/r/a/b/l/y/check 
