...
execute if block ~6 ~ ~ minecraft:blue_concrete_powder run function wordlist:c/o/n/t/r/o/l/c
...
execute if block ~6 ~ ~ minecraft:lime_wool run function wordlist:c/o/n/t/r/o/v/c
