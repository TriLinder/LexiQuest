scoreboard players set @s word_id 5139 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:c/o/n/t/r/o/l/s/check 
...
execute if block ~7 ~ ~ minecraft:blue_concrete_powder run function wordlist:c/o/n/t/r/o/l/l/check 
