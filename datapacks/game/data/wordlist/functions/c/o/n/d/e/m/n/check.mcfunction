scoreboard players set @s word_id 5117 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:c/o/n/d/e/m/n/s/check 
...
execute if block ~7 ~ ~ minecraft:yellow_concrete_powder run function wordlist:c/o/n/d/e/m/n/e/check 
...
execute if block ~7 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:c/o/n/d/e/m/n/i/check 
...
execute if block ~7 ~ ~ minecraft:white_concrete_powder run function wordlist:c/o/n/d/e/m/n/a/check 
