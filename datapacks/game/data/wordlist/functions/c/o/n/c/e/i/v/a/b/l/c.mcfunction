...
execute if block ~10 ~ ~ minecraft:light_gray_wool run function wordlist:c/o/n/c/e/i/v/a/b/l/y/c
...
execute if block ~10 ~ ~ minecraft:yellow_concrete_powder run function wordlist:c/o/n/c/e/i/v/a/b/l/e/c
