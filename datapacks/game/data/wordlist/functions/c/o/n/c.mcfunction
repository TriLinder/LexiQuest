...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 137
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 137
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 137
...
execute if block ~3 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:c/o/n/d/c
...
execute if block ~3 ~ ~ minecraft:magenta_concrete_powder run function wordlist:c/o/n/c/c
...
execute if block ~3 ~ ~ minecraft:lime_wool run function wordlist:c/o/n/v/c
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:c/o/n/t/c
...
execute if block ~3 ~ ~ minecraft:lime_concrete_powder run function wordlist:c/o/n/f/c
...
execute if block ~3 ~ ~ minecraft:pink_concrete_powder run function wordlist:c/o/n/g/c
...
execute if block ~3 ~ ~ minecraft:green_concrete_powder run function wordlist:c/o/n/n/c
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:c/o/n/s/c
...
execute if block ~3 ~ ~ minecraft:cyan_concrete_powder run function wordlist:c/o/n/j/c
