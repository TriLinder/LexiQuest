...
execute if block ~6 ~ ~ minecraft:lime_wool run function wordlist:c/o/n/t/r/i/v/check 
...
execute if block ~6 ~ ~ minecraft:orange_concrete_powder run function wordlist:c/o/n/t/r/i/b/check 
