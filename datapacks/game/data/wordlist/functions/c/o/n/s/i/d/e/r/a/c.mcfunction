...
execute if block ~9 ~ ~ minecraft:light_blue_wool run function wordlist:c/o/n/s/i/d/e/r/a/t/c
...
execute if block ~9 ~ ~ minecraft:orange_concrete_powder run function wordlist:c/o/n/s/i/d/e/r/a/b/c
