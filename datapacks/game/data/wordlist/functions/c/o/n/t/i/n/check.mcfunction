...
execute if block ~6 ~ ~ minecraft:yellow_wool run function wordlist:c/o/n/t/i/n/u/check 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:c/o/n/t/i/n/e/check 
