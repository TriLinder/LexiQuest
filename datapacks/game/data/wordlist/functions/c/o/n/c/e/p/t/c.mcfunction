...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 6507
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 6507
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 6507
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:c/o/n/c/e/p/t/s/c
...
execute if block ~7 ~ ~ minecraft:yellow_wool run function wordlist:c/o/n/c/e/p/t/u/c
...
execute if block ~7 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:c/o/n/c/e/p/t/i/c
