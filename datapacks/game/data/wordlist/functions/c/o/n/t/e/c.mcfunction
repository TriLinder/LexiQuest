...
execute if block ~5 ~ ~ minecraft:green_concrete_powder run function wordlist:c/o/n/t/e/n/c
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:c/o/n/t/e/s/c
...
execute if block ~5 ~ ~ minecraft:gray_wool run function wordlist:c/o/n/t/e/x/c
...
execute if block ~5 ~ ~ minecraft:brown_concrete_powder run function wordlist:c/o/n/t/e/m/c
