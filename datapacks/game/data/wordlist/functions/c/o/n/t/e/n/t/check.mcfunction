scoreboard players set @s word_id 5135 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:c/o/n/t/e/n/t/s/check 
...
execute if block ~7 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:c/o/n/t/e/n/t/i/check 
