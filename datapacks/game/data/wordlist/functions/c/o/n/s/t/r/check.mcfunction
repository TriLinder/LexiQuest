...
execute if block ~6 ~ ~ minecraft:white_concrete_powder run function wordlist:c/o/n/s/t/r/a/check 
...
execute if block ~6 ~ ~ minecraft:yellow_wool run function wordlist:c/o/n/s/t/r/u/check 
