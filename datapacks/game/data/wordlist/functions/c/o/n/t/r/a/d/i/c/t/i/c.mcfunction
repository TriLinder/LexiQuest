...
execute if block ~11 ~ ~ minecraft:green_concrete_powder run function wordlist:c/o/n/t/r/a/d/i/c/t/i/n/c
...
execute if block ~11 ~ ~ minecraft:red_concrete_powder run function wordlist:c/o/n/t/r/a/d/i/c/t/i/o/c
