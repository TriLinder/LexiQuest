scoreboard players set @s word_id 7205 
...
execute if block ~8 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:c/o/n/v/i/n/c/e/d/check 
...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:c/o/n/v/i/n/c/e/s/check 
