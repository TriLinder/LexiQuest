scoreboard players set @s word_id 5125 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:c/o/n/g/e/s/t/s/check 
...
execute if block ~7 ~ ~ minecraft:yellow_concrete_powder run function wordlist:c/o/n/g/e/s/t/e/check 
...
execute if block ~7 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:c/o/n/g/e/s/t/i/check 
