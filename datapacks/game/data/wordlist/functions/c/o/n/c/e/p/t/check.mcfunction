scoreboard players set @s word_id 5113 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:c/o/n/c/e/p/t/s/check 
...
execute if block ~7 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:c/o/n/c/e/p/t/i/check 
...
execute if block ~7 ~ ~ minecraft:yellow_wool run function wordlist:c/o/n/c/e/p/t/u/check 
