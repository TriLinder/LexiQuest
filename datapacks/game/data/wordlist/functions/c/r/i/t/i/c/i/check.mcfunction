...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:c/r/i/t/i/c/i/s/check 
...
execute if block ~7 ~ ~ minecraft:cyan_wool run function wordlist:c/r/i/t/i/c/i/z/check 
