...
execute if block ~5 ~ ~ minecraft:light_blue_wool run function wordlist:c/r/e/d/i/t/c
...
execute if block ~5 ~ ~ minecraft:orange_concrete_powder run function wordlist:c/r/e/d/i/b/c
