scoreboard players set @s word_id 3145 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:c/r/u/n/c/h/e/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:c/r/u/n/c/h/i/check 
