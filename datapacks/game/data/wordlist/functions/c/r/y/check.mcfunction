scoreboard players set @s word_id 91 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:c/r/y/i/check 
...
execute if block ~3 ~ ~ minecraft:black_concrete_powder run function wordlist:c/r/y/p/check 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:c/r/y/s/check 
