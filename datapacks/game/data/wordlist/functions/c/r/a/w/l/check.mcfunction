scoreboard players set @s word_id 1540 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:c/r/a/w/l/s/check 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:c/r/a/w/l/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:c/r/a/w/l/i/check 
