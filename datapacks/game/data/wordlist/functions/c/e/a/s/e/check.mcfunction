scoreboard players set @s word_id 1463 
...
execute if block ~5 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:c/e/a/s/e/d/check 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:c/e/a/s/e/s/check 
