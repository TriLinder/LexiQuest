scoreboard players set @s word_id 440 
...
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run function wordlist:c/e/n/t/e/check 
...
execute if block ~4 ~ ~ minecraft:orange_wool run function wordlist:c/e/n/t/r/check 
...
execute if block ~4 ~ ~ minecraft:yellow_wool run function wordlist:c/e/n/t/u/check 
