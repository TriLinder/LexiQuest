scoreboard players set @s word_id 5050 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:c/i/r/c/u/i/t/s/check 
...
execute if block ~7 ~ ~ minecraft:orange_wool run function wordlist:c/i/r/c/u/i/t/r/check 
