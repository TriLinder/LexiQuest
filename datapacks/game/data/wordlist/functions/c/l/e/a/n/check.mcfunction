scoreboard players set @s word_id 1500 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:c/l/e/a/n/s/check 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:c/l/e/a/n/e/check 
...
execute if block ~5 ~ ~ minecraft:blue_concrete_powder run function wordlist:c/l/e/a/n/l/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:c/l/e/a/n/i/check 
