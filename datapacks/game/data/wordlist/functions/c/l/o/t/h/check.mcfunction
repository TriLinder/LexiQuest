scoreboard players set @s word_id 1509 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:c/l/o/t/h/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:c/l/o/t/h/i/check 
