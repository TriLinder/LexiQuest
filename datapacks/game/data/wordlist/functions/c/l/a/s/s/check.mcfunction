scoreboard players set @s word_id 1499 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:c/l/a/s/s/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:c/l/a/s/s/i/check 
