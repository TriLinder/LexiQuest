scoreboard players set @s word_id 1497 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:c/l/a/i/m/s/check 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:c/l/a/i/m/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:c/l/a/i/m/i/check 
