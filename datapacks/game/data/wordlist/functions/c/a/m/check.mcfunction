scoreboard players set @s word_id 84 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:c/a/m/e/check 
...
execute if block ~3 ~ ~ minecraft:black_concrete_powder run function wordlist:c/a/m/p/check 
