scoreboard players set @s word_id 427 
...
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:c/a/m/p/s/check 
execute if block ~ ~ ~4 minecraft:magenta_wool run scoreboard players set @s word_direction 1 
execute if block ~ ~ ~4 minecraft:magenta_wool run function wordlist:c/a/m/p/s/check 
execute if block ~4 ~ ~ minecraft:yellow_wool run scoreboard players set @s word_direction 0 
execute if block ~4 ~ ~ minecraft:yellow_wool run function wordlist:c/a/m/p/u/check 
...
execute if block ~4 ~ ~ minecraft:white_concrete_powder run function wordlist:c/a/m/p/a/check 
