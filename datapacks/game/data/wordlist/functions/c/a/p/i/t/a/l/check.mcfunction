scoreboard players set @s word_id 4985 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:c/a/p/i/t/a/l/s/check 
...
execute if block ~7 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:c/a/p/i/t/a/l/i/check 
