scoreboard players set @s word_id 86 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:c/a/p/s/check 
...
execute if block ~3 ~ ~ minecraft:white_concrete_powder run function wordlist:c/a/p/a/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:c/a/p/i/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:c/a/p/t/check 
