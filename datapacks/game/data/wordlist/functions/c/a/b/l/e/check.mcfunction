scoreboard players set @s word_id 1444 
...
execute if block ~5 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:c/a/b/l/e/d/check 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:c/a/b/l/e/s/check 
