scoreboard players set @s word_id 3006 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:c/a/n/c/e/l/s/check 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:c/a/n/c/e/l/e/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:c/a/n/c/e/l/i/check 
...
execute if block ~6 ~ ~ minecraft:blue_concrete_powder run function wordlist:c/a/n/c/e/l/l/check 
