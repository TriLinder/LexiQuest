scoreboard players set @s word_id 85 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:c/a/n/s/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:c/a/n/t/check 
...
execute if block ~3 ~ ~ minecraft:magenta_concrete_powder run function wordlist:c/a/n/c/check 
...
execute if block ~3 ~ ~ minecraft:green_concrete_powder run function wordlist:c/a/n/n/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:c/a/n/d/check 
...
execute if block ~3 ~ ~ minecraft:red_concrete_powder run function wordlist:c/a/n/o/check 
