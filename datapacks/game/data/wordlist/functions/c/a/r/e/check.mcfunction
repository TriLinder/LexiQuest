scoreboard players set @s word_id 432 
...
execute if block ~4 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:c/a/r/e/d/check 
execute if block ~ ~ ~4 minecraft:light_blue_concrete_powder run scoreboard players set @s word_direction 1 
execute if block ~ ~ ~4 minecraft:light_blue_concrete_powder run function wordlist:c/a/r/e/d/check 
execute if block ~4 ~ ~ minecraft:magenta_wool run scoreboard players set @s word_direction 0 
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:c/a/r/e/s/check 
execute if block ~ ~ ~4 minecraft:magenta_wool run scoreboard players set @s word_direction 1 
execute if block ~ ~ ~4 minecraft:magenta_wool run function wordlist:c/a/r/e/s/check 
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run scoreboard players set @s word_direction 0 
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run function wordlist:c/a/r/e/e/check 
...
execute if block ~4 ~ ~ minecraft:lime_concrete_powder run function wordlist:c/a/r/e/f/check 
...
execute if block ~4 ~ ~ minecraft:blue_concrete_powder run function wordlist:c/a/r/e/l/check 
