scoreboard players set @s word_id 4997 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:c/a/t/a/l/o/g/s/check 
...
execute if block ~7 ~ ~ minecraft:yellow_wool run function wordlist:c/a/t/a/l/o/g/u/check 
