scoreboard players set @s word_id 88 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:c/a/t/s/check 
...
execute if block ~3 ~ ~ minecraft:magenta_concrete_powder run function wordlist:c/a/t/c/check 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:c/a/t/e/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:c/a/t/t/check 
...
execute if block ~3 ~ ~ minecraft:white_concrete_powder run function wordlist:c/a/t/a/check 
...
execute if block ~3 ~ ~ minecraft:gray_concrete_powder run function wordlist:c/a/t/h/check 
