scoreboard players set @s word_id 1460 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:c/a/t/c/h/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:c/a/t/c/h/i/check 
