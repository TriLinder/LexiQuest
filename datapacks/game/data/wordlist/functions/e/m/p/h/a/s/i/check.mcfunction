...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:e/m/p/h/a/s/i/s/check 
...
execute if block ~7 ~ ~ minecraft:cyan_wool run function wordlist:e/m/p/h/a/s/i/z/check 
