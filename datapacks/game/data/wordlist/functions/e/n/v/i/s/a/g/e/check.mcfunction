scoreboard players set @s word_id 7453 
...
execute if block ~8 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:e/n/v/i/s/a/g/e/d/check 
...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:e/n/v/i/s/a/g/e/s/check 
