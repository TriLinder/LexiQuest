scoreboard players set @s word_id 5394 
...
execute if block ~7 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:e/n/q/u/i/r/e/d/check 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:e/n/q/u/i/r/e/s/check 
