scoreboard players set @s word_id 3282 
...
execute if block ~6 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:e/n/a/b/l/e/d/check 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:e/n/a/b/l/e/s/check 
