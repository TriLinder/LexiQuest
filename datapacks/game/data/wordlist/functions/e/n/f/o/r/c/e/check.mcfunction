scoreboard players set @s word_id 5387 
...
execute if block ~7 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:e/n/f/o/r/c/e/d/check 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:e/n/f/o/r/c/e/s/check 
