scoreboard players set @s word_id 3287 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:e/n/g/i/n/e/s/check 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:e/n/g/i/n/e/e/check 
