scoreboard players set @s word_id 3286 
...
execute if block ~6 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:e/n/g/a/g/e/d/check 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:e/n/g/a/g/e/s/check 
