scoreboard players set @s word_id 1667 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:e/n/t/e/r/s/check 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:e/n/t/e/r/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:e/n/t/e/r/i/check 
...
execute if block ~5 ~ ~ minecraft:light_blue_wool run function wordlist:e/n/t/e/r/t/check 
...
execute if block ~5 ~ ~ minecraft:black_concrete_powder run function wordlist:e/n/t/e/r/p/check 
