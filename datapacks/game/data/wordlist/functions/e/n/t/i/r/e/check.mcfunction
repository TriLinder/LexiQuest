scoreboard players set @s word_id 3293 
...
execute if block ~6 ~ ~ minecraft:blue_concrete_powder run function wordlist:e/n/t/i/r/e/l/check 
...
execute if block ~6 ~ ~ minecraft:light_blue_wool run function wordlist:e/n/t/i/r/e/t/check 
