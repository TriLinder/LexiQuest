...
execute if block ~7 ~ ~ minecraft:orange_wool run function wordlist:e/n/d/e/a/v/o/r/check 
...
execute if block ~7 ~ ~ minecraft:yellow_wool run function wordlist:e/n/d/e/a/v/o/u/check 
