scoreboard players set @s word_id 113 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:e/n/d/s/check 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:e/n/d/e/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:e/n/d/i/check 
...
execute if block ~3 ~ ~ minecraft:blue_concrete_powder run function wordlist:e/n/d/l/check 
