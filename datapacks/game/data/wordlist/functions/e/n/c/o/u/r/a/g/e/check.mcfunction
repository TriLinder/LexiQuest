scoreboard players set @s word_id 9208 
...
execute if block ~9 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:e/n/c/o/u/r/a/g/e/d/check 
...
execute if block ~9 ~ ~ minecraft:magenta_wool run function wordlist:e/n/c/o/u/r/a/g/e/s/check 
...
execute if block ~9 ~ ~ minecraft:brown_concrete_powder run function wordlist:e/n/c/o/u/r/a/g/e/m/check 
