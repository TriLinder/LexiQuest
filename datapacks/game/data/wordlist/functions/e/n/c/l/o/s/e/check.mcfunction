scoreboard players set @s word_id 5380 
...
execute if block ~7 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:e/n/c/l/o/s/e/d/check 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:e/n/c/l/o/s/e/s/check 
