scoreboard players set @s word_id 1674 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:e/t/h/i/c/s/check 
...
execute if block ~5 ~ ~ minecraft:white_concrete_powder run function wordlist:e/t/h/i/c/a/check 
