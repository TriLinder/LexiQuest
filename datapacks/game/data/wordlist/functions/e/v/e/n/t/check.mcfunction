scoreboard players set @s word_id 1676 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:e/v/e/n/t/s/check 
...
execute if block ~5 ~ ~ minecraft:yellow_wool run function wordlist:e/v/e/n/t/u/check 
