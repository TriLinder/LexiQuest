scoreboard players set @s word_id 3272 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:e/f/f/e/c/t/s/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:e/f/f/e/c/t/i/check 
