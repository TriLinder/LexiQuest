scoreboard players set @s word_id 109 
...
execute if block ~3 ~ ~ minecraft:green_concrete_powder run function wordlist:e/a/r/n/check 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:e/a/r/s/check 
...
execute if block ~3 ~ ~ minecraft:blue_concrete_powder run function wordlist:e/a/r/l/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:e/a/r/t/check 
