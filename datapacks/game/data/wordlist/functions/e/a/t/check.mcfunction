scoreboard players set @s word_id 110 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:e/a/t/s/check 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:e/a/t/e/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:e/a/t/i/check 
