scoreboard players set @s word_id 3325 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:e/x/p/e/r/t/s/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:e/x/p/e/r/t/i/check 
