scoreboard players set @s word_id 3326 
...
execute if block ~6 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:e/x/p/i/r/e/d/check 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:e/x/p/i/r/e/s/check 
