scoreboard players set @s word_id 10651 
...
execute if block ~10 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:e/x/p/e/r/i/e/n/c/e/d/check 
...
execute if block ~10 ~ ~ minecraft:magenta_wool run function wordlist:e/x/p/e/r/i/e/n/c/e/s/check 
