...
execute if block ~11 ~ ~ minecraft:blue_concrete_powder run function wordlist:e/x/p/e/r/i/m/e/n/t/a/l/check 
...
execute if block ~11 ~ ~ minecraft:light_blue_wool run function wordlist:e/x/p/e/r/i/m/e/n/t/a/t/check 
