...
execute if block ~7 ~ ~ minecraft:red_concrete_powder run function wordlist:e/x/c/l/u/s/i/o/check 
...
execute if block ~7 ~ ~ minecraft:lime_wool run function wordlist:e/x/c/l/u/s/i/v/check 
