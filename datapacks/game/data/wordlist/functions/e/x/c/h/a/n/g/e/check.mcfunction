scoreboard players set @s word_id 7476 
...
execute if block ~8 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:e/x/c/h/a/n/g/e/d/check 
...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:e/x/c/h/a/n/g/e/s/check 
