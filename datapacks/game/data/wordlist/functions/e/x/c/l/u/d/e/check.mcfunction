scoreboard players set @s word_id 5427 
...
execute if block ~7 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:e/x/c/l/u/d/e/d/check 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:e/x/c/l/u/d/e/s/check 
