scoreboard players set @s word_id 3314 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:e/x/c/e/p/t/s/check 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:e/x/c/e/p/t/e/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:e/x/c/e/p/t/i/check 
