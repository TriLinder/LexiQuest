scoreboard players set @s word_id 1681 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:e/x/i/s/t/s/check 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:e/x/i/s/t/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:e/x/i/s/t/i/check 
