...
execute if block ~7 ~ ~ minecraft:lime_wool run function wordlist:e/x/t/e/n/s/i/v/c
...
execute if block ~7 ~ ~ minecraft:red_concrete_powder run function wordlist:e/x/t/e/n/s/i/o/c
