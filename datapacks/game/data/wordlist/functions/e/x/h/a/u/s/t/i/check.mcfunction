...
execute if block ~8 ~ ~ minecraft:green_concrete_powder run function wordlist:e/x/h/a/u/s/t/i/n/check 
...
execute if block ~8 ~ ~ minecraft:lime_wool run function wordlist:e/x/h/a/u/s/t/i/v/check 
