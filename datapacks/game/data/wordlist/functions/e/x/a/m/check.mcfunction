scoreboard players set @s word_id 562 
...
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:e/x/a/m/s/check 
execute if block ~ ~ ~4 minecraft:magenta_wool run scoreboard players set @s word_direction 1 
execute if block ~ ~ ~4 minecraft:magenta_wool run function wordlist:e/x/a/m/s/check 
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run scoreboard players set @s word_direction 0 
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:e/x/a/m/i/check 
...
execute if block ~4 ~ ~ minecraft:black_concrete_powder run function wordlist:e/x/a/m/p/check 
