scoreboard players set @s word_id 7483 
...
execute if block ~8 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:e/x/e/r/c/i/s/e/d/check 
...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:e/x/e/r/c/i/s/e/s/check 
