...
execute if block ~10 ~ ~ minecraft:light_blue_wool run function wordlist:i/n/e/f/f/i/c/i/e/n/t/c
...
execute if block ~10 ~ ~ minecraft:magenta_concrete_powder run function wordlist:i/n/e/f/f/i/c/i/e/n/c/c
