...
execute if block ~7 ~ ~ minecraft:lime_wool run function wordlist:i/n/t/e/n/s/i/v/c
...
execute if block ~7 ~ ~ minecraft:light_blue_wool run function wordlist:i/n/t/e/n/s/i/t/c
