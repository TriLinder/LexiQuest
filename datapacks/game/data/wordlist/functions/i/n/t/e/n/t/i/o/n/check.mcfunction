scoreboard players set @s word_id 9459 
...
execute if block ~9 ~ ~ minecraft:magenta_wool run function wordlist:i/n/t/e/n/t/i/o/n/s/check 
...
execute if block ~9 ~ ~ minecraft:white_concrete_powder run function wordlist:i/n/t/e/n/t/i/o/n/a/check 
