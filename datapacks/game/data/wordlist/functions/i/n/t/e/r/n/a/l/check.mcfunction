scoreboard players set @s word_id 7742 
...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:i/n/t/e/r/n/a/l/s/check 
...
execute if block ~8 ~ ~ minecraft:blue_concrete_powder run function wordlist:i/n/t/e/r/n/a/l/l/check 
