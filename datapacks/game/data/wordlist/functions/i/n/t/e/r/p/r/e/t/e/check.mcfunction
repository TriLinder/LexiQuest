...
execute if block ~10 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:i/n/t/e/r/p/r/e/t/e/d/check 
...
execute if block ~10 ~ ~ minecraft:orange_wool run function wordlist:i/n/t/e/r/p/r/e/t/e/r/check 
