...
execute if block ~6 ~ ~ minecraft:yellow_wool run function wordlist:i/n/t/e/r/r/u/c
...
execute if block ~6 ~ ~ minecraft:red_concrete_powder run function wordlist:i/n/t/e/r/r/o/c
