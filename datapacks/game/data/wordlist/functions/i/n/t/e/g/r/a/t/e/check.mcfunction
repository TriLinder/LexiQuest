scoreboard players set @s word_id 9452 
...
execute if block ~9 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:i/n/t/e/g/r/a/t/e/d/check 
...
execute if block ~9 ~ ~ minecraft:magenta_wool run function wordlist:i/n/t/e/g/r/a/t/e/s/check 
