scoreboard players set @s word_id 9422 
...
execute if block ~9 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:i/n/f/l/u/e/n/c/e/d/check 
...
execute if block ~9 ~ ~ minecraft:magenta_wool run function wordlist:i/n/f/l/u/e/n/c/e/s/check 
