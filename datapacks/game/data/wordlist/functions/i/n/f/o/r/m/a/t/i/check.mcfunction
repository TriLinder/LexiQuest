...
execute if block ~9 ~ ~ minecraft:red_concrete_powder run function wordlist:i/n/f/o/r/m/a/t/i/o/check 
...
execute if block ~9 ~ ~ minecraft:lime_wool run function wordlist:i/n/f/o/r/m/a/t/i/v/check 
