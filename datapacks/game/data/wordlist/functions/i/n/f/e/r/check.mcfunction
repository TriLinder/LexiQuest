scoreboard players set @s word_id 1905 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:i/n/f/e/r/i/check 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:i/n/f/e/r/e/check 
