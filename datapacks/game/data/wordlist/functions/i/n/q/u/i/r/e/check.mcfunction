scoreboard players set @s word_id 5713 
...
execute if block ~7 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:i/n/q/u/i/r/e/d/check 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:i/n/q/u/i/r/e/s/check 
