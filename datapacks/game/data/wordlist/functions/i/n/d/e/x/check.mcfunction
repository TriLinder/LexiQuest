scoreboard players set @s word_id 1904 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:i/n/d/e/x/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:i/n/d/e/x/i/check 
