...
execute if block ~10 ~ ~ minecraft:light_blue_wool run function wordlist:i/n/d/e/p/e/n/d/e/n/t/check 
...
execute if block ~10 ~ ~ minecraft:magenta_concrete_powder run function wordlist:i/n/d/e/p/e/n/d/e/n/c/check 
