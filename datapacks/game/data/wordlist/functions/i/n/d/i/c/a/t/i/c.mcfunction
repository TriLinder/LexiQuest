...
execute if block ~8 ~ ~ minecraft:lime_wool run function wordlist:i/n/d/i/c/a/t/i/v/c
...
execute if block ~8 ~ ~ minecraft:red_concrete_powder run function wordlist:i/n/d/i/c/a/t/i/o/c
...
execute if block ~8 ~ ~ minecraft:green_concrete_powder run function wordlist:i/n/d/i/c/a/t/i/n/c
