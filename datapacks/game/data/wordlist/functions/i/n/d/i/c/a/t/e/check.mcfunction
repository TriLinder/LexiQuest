scoreboard players set @s word_id 7696 
...
execute if block ~8 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:i/n/d/i/c/a/t/e/d/check 
...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:i/n/d/i/c/a/t/e/s/check 
