...
execute if block ~8 ~ ~ minecraft:green_concrete_powder run function wordlist:i/n/i/t/i/a/t/i/n/check 
...
execute if block ~8 ~ ~ minecraft:lime_wool run function wordlist:i/n/i/t/i/a/t/i/v/check 
