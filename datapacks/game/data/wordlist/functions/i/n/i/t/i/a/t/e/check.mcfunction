scoreboard players set @s word_id 7714 
...
execute if block ~8 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:i/n/i/t/i/a/t/e/d/check 
...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:i/n/i/t/i/a/t/e/s/check 
