...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:i/n/i/t/i/a/l/i/s/c
...
execute if block ~8 ~ ~ minecraft:cyan_wool run function wordlist:i/n/i/t/i/a/l/i/z/c
