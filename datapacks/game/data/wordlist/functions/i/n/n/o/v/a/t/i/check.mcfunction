...
execute if block ~8 ~ ~ minecraft:red_concrete_powder run function wordlist:i/n/n/o/v/a/t/i/o/check 
...
execute if block ~8 ~ ~ minecraft:lime_wool run function wordlist:i/n/n/o/v/a/t/i/v/check 
