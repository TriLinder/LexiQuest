scoreboard players set @s word_id 1903 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:i/n/c/u/r/s/check 
...
execute if block ~5 ~ ~ minecraft:orange_wool run function wordlist:i/n/c/u/r/r/check 
