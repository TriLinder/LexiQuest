...
execute if block ~12 ~ ~ minecraft:light_gray_wool run function wordlist:i/n/c/o/n/s/i/s/t/e/n/c/y/c
...
execute if block ~12 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:i/n/c/o/n/s/i/s/t/e/n/c/i/c
