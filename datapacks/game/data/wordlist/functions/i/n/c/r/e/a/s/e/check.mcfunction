scoreboard players set @s word_id 7693 
...
execute if block ~8 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:i/n/c/r/e/a/s/e/d/check 
...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:i/n/c/r/e/a/s/e/s/check 
