...
execute if block ~7 ~ ~ minecraft:lime_wool run function wordlist:i/n/c/l/u/s/i/v/c
...
execute if block ~7 ~ ~ minecraft:red_concrete_powder run function wordlist:i/n/c/l/u/s/i/o/c
