...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 12660
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 12660
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 12660
...
execute if block ~13 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:i/n/c/o/n/v/e/n/i/e/n/c/e/d/c
...
execute if block ~13 ~ ~ minecraft:magenta_wool run function wordlist:i/n/c/o/n/v/e/n/i/e/n/c/e/s/c
