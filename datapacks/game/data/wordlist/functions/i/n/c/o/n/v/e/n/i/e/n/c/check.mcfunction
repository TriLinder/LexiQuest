...
execute if block ~12 ~ ~ minecraft:yellow_concrete_powder run function wordlist:i/n/c/o/n/v/e/n/i/e/n/c/e/check 
...
execute if block ~12 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:i/n/c/o/n/v/e/n/i/e/n/c/i/check 
