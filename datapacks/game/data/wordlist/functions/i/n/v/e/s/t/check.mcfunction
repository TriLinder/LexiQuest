scoreboard players set @s word_id 3630 
...
execute if block ~6 ~ ~ minecraft:brown_concrete_powder run function wordlist:i/n/v/e/s/t/m/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:i/n/v/e/s/t/i/check 
