scoreboard players set @s word_id 3629 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:i/n/v/e/r/t/s/check 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:i/n/v/e/r/t/e/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:i/n/v/e/r/t/i/check 
