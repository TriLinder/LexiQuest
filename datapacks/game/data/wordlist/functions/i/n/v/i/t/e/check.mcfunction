scoreboard players set @s word_id 3631 
...
execute if block ~6 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:i/n/v/i/t/e/d/check 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:i/n/v/i/t/e/s/check 
