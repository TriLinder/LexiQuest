scoreboard players set @s word_id 3627 
...
execute if block ~6 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:i/n/v/a/d/e/d/check 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:i/n/v/a/d/e/s/check 
