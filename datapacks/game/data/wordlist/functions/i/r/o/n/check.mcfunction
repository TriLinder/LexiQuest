scoreboard players set @s word_id 712 
...
execute if block ~4 ~ ~ minecraft:light_gray_wool run function wordlist:i/r/o/n/y/check 
...
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:i/r/o/n/i/check 
