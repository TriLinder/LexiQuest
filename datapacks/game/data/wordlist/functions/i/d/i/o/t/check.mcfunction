scoreboard players set @s word_id 1899 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:i/d/i/o/t/s/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:i/d/i/o/t/i/check 
