scoreboard players set @s word_id 18 
...
execute if block ~2 ~ ~ minecraft:yellow_concrete_powder run function wordlist:i/d/e/check 
...
execute if block ~2 ~ ~ minecraft:blue_concrete_powder run function wordlist:i/d/l/check 
...
execute if block ~2 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:i/d/i/check 
