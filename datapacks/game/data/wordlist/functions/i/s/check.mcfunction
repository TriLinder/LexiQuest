scoreboard players set @s word_id 21 
...
execute if block ~2 ~ ~ minecraft:magenta_wool run function wordlist:i/s/s/check 
...
execute if block ~2 ~ ~ minecraft:blue_concrete_powder run function wordlist:i/s/l/check 
...
execute if block ~2 ~ ~ minecraft:red_concrete_powder run function wordlist:i/s/o/check 
