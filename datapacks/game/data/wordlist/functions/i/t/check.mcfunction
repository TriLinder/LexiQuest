scoreboard players set @s word_id 22 
...
execute if block ~2 ~ ~ minecraft:magenta_wool run function wordlist:i/t/s/check 
...
execute if block ~2 ~ ~ minecraft:yellow_concrete_powder run function wordlist:i/t/e/check 
