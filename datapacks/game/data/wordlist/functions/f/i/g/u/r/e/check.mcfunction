scoreboard players set @s word_id 3370 
...
execute if block ~6 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:f/i/g/u/r/e/d/check 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:f/i/g/u/r/e/s/check 
