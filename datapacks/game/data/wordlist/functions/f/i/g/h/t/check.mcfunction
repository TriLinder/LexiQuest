scoreboard players set @s word_id 1713 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:f/i/g/h/t/s/check 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:f/i/g/h/t/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:f/i/g/h/t/i/check 
