scoreboard players set @s word_id 3366 
...
execute if block ~6 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:f/i/d/d/l/e/d/check 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:f/i/d/d/l/e/s/check 
