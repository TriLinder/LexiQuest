scoreboard players set @s word_id 124 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:f/i/x/e/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:f/i/x/i/check 
