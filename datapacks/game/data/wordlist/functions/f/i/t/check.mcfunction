scoreboard players set @s word_id 123 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:f/i/t/s/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:f/i/t/t/check 
