scoreboard players set @s word_id 1763 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:f/o/u/n/d/s/check 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:f/o/u/n/d/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:f/o/u/n/d/i/check 
...
execute if block ~5 ~ ~ minecraft:white_concrete_powder run function wordlist:f/o/u/n/d/a/check 
