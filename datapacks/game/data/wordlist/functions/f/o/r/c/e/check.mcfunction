scoreboard players set @s word_id 1758 
...
execute if block ~5 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:f/o/r/c/e/d/check 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:f/o/r/c/e/s/check 
