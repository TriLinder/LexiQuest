...
execute if block ~5 ~ ~ minecraft:green_concrete_powder run function wordlist:f/o/r/c/i/n/c
...
execute if block ~5 ~ ~ minecraft:orange_concrete_powder run function wordlist:f/o/r/c/i/b/c
