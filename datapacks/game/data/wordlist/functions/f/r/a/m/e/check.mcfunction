scoreboard players set @s word_id 1764 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:f/r/a/m/e/s/check 
...
execute if block ~5 ~ ~ minecraft:pink_wool run function wordlist:f/r/a/m/e/w/check 
