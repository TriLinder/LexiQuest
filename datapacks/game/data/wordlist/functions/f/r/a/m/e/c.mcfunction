...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 1485
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 1485
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 1485
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:f/r/a/m/e/s/c
...
execute if block ~5 ~ ~ minecraft:pink_wool run function wordlist:f/r/a/m/e/w/c
