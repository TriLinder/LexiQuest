...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:f/r/e/e/c
...
execute if block ~3 ~ ~ minecraft:white_concrete_powder run function wordlist:f/r/e/a/c
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:f/r/e/s/c
...
execute if block ~3 ~ ~ minecraft:green_concrete_powder run function wordlist:f/r/e/n/c
execute if block ~ ~ ~3 minecraft:green_concrete_powder run scoreboard players set @s word_direction 1
execute if block ~ ~ ~3 minecraft:green_concrete_powder run function wordlist:f/r/e/n/c
execute if block ~3 ~ ~ minecraft:white_wool run scoreboard players set @s word_direction 0
execute if block ~3 ~ ~ minecraft:white_wool run function wordlist:f/r/e/q/c
execute if block ~ ~ ~3 minecraft:white_wool run scoreboard players set @s word_direction 1
execute if block ~ ~ ~3 minecraft:white_wool run function wordlist:f/r/e/q/c
