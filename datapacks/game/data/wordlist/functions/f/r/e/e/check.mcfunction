scoreboard players set @s word_id 613 
...
execute if block ~4 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:f/r/e/e/d/check 
execute if block ~ ~ ~4 minecraft:light_blue_concrete_powder run scoreboard players set @s word_direction 1 
execute if block ~ ~ ~4 minecraft:light_blue_concrete_powder run function wordlist:f/r/e/e/d/check 
execute if block ~4 ~ ~ minecraft:magenta_wool run scoreboard players set @s word_direction 0 
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:f/r/e/e/s/check 
execute if block ~ ~ ~4 minecraft:magenta_wool run scoreboard players set @s word_direction 1 
execute if block ~ ~ ~4 minecraft:magenta_wool run function wordlist:f/r/e/e/s/check 
execute if block ~4 ~ ~ minecraft:blue_concrete_powder run scoreboard players set @s word_direction 0 
execute if block ~4 ~ ~ minecraft:blue_concrete_powder run function wordlist:f/r/e/e/l/check 
...
execute if block ~4 ~ ~ minecraft:cyan_wool run function wordlist:f/r/e/e/z/check 
...
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:f/r/e/e/i/check 
...
execute if block ~4 ~ ~ minecraft:pink_wool run function wordlist:f/r/e/e/w/check 
