scoreboard players set @s word_id 3441 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:f/r/i/e/n/d/s/check 
...
execute if block ~6 ~ ~ minecraft:blue_concrete_powder run function wordlist:f/r/i/e/n/d/l/check 
