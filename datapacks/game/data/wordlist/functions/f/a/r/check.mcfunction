scoreboard players set @s word_id 118 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:f/a/r/e/check 
...
execute if block ~3 ~ ~ minecraft:brown_concrete_powder run function wordlist:f/a/r/m/check 
...
execute if block ~3 ~ ~ minecraft:magenta_concrete_powder run function wordlist:f/a/r/c/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:f/a/r/t/check 
