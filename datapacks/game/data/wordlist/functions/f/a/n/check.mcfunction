scoreboard players set @s word_id 117 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:f/a/n/s/check 
...
execute if block ~3 ~ ~ minecraft:magenta_concrete_powder run function wordlist:f/a/n/c/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:f/a/n/t/check 
