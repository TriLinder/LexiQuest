scoreboard players set @s word_id 565 
...
execute if block ~4 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:f/a/c/e/d/check 
execute if block ~ ~ ~4 minecraft:light_blue_concrete_powder run scoreboard players set @s word_direction 1 
execute if block ~ ~ ~4 minecraft:light_blue_concrete_powder run function wordlist:f/a/c/e/d/check 
execute if block ~4 ~ ~ minecraft:magenta_wool run scoreboard players set @s word_direction 0 
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:f/a/c/e/s/check 
