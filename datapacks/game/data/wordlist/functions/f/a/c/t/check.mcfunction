scoreboard players set @s word_id 566 
...
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:f/a/c/t/s/check 
execute if block ~ ~ ~4 minecraft:magenta_wool run scoreboard players set @s word_direction 1 
execute if block ~ ~ ~4 minecraft:magenta_wool run function wordlist:f/a/c/t/s/check 
execute if block ~4 ~ ~ minecraft:red_concrete_powder run scoreboard players set @s word_direction 0 
execute if block ~4 ~ ~ minecraft:red_concrete_powder run function wordlist:f/a/c/t/o/check 
...
execute if block ~4 ~ ~ minecraft:yellow_wool run function wordlist:f/a/c/t/u/check 
