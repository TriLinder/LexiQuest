scoreboard players set @s word_id 119 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:f/a/t/e/check 
...
execute if block ~3 ~ ~ minecraft:white_concrete_powder run function wordlist:f/a/t/a/check 
...
execute if block ~3 ~ ~ minecraft:gray_concrete_powder run function wordlist:f/a/t/h/check 
...
execute if block ~3 ~ ~ minecraft:yellow_wool run function wordlist:f/a/t/u/check 
