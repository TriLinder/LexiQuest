scoreboard players set @s word_id 130 
...
execute if block ~3 ~ ~ minecraft:orange_wool run function wordlist:f/u/r/r/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:f/u/r/t/check 
...
execute if block ~3 ~ ~ minecraft:green_concrete_powder run function wordlist:f/u/r/n/check 
