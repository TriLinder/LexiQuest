scoreboard players set @s word_id 11687 
...
execute if block ~11 ~ ~ minecraft:blue_concrete_powder run function wordlist:f/u/n/d/a/m/e/n/t/a/l/l/check 
...
execute if block ~11 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:f/u/n/d/a/m/e/n/t/a/l/i/check 
