scoreboard players set @s word_id 129 
...
execute if block ~3 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:f/u/n/d/check 
...
execute if block ~3 ~ ~ minecraft:green_concrete_powder run function wordlist:f/u/n/n/check 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:f/u/n/e/check 
...
execute if block ~3 ~ ~ minecraft:magenta_concrete_powder run function wordlist:f/u/n/c/check 
