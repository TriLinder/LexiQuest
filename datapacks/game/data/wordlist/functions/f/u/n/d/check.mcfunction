scoreboard players set @s word_id 619 
...
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:f/u/n/d/s/check 
execute if block ~ ~ ~4 minecraft:magenta_wool run scoreboard players set @s word_direction 1 
execute if block ~ ~ ~4 minecraft:magenta_wool run function wordlist:f/u/n/d/s/check 
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run scoreboard players set @s word_direction 0 
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run function wordlist:f/u/n/d/e/check 
...
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:f/u/n/d/i/check 
...
execute if block ~4 ~ ~ minecraft:white_concrete_powder run function wordlist:f/u/n/d/a/check 
