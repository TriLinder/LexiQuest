...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 57
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 57
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 57
...
execute if block ~3 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:f/u/n/d/c
...
execute if block ~3 ~ ~ minecraft:green_concrete_powder run function wordlist:f/u/n/n/c
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:f/u/n/e/c
...
execute if block ~3 ~ ~ minecraft:magenta_concrete_powder run function wordlist:f/u/n/c/c
