...
execute if block ~2 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:f/e/d/check 
...
execute if block ~2 ~ ~ minecraft:yellow_concrete_powder run function wordlist:f/e/e/check 
...
execute if block ~2 ~ ~ minecraft:pink_wool run function wordlist:f/e/w/check 
...
execute if block ~2 ~ ~ minecraft:white_concrete_powder run function wordlist:f/e/a/check 
...
execute if block ~2 ~ ~ minecraft:blue_concrete_powder run function wordlist:f/e/l/check 
...
execute if block ~2 ~ ~ minecraft:green_concrete_powder run function wordlist:f/e/n/check 
...
execute if block ~2 ~ ~ minecraft:light_blue_wool run function wordlist:f/e/t/check 
...
execute if block ~2 ~ ~ minecraft:lime_wool run function wordlist:f/e/v/check 
...
execute if block ~2 ~ ~ minecraft:brown_concrete_powder run function wordlist:f/e/m/check 
...
execute if block ~2 ~ ~ minecraft:magenta_wool run function wordlist:f/e/s/check 
