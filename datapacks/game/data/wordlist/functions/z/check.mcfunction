...
execute if block ~1 ~ ~ minecraft:yellow_concrete_powder run function wordlist:z/e/check 
...
execute if block ~1 ~ ~ minecraft:red_concrete_powder run function wordlist:z/o/check 
