scoreboard players set @s word_id 3160 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:d/a/n/g/e/r/s/check 
...
execute if block ~6 ~ ~ minecraft:red_concrete_powder run function wordlist:d/a/n/g/e/r/o/check 
