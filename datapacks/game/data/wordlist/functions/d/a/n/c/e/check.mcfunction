scoreboard players set @s word_id 1570 
...
execute if block ~5 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:d/a/n/c/e/d/check 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:d/a/n/c/e/s/check 
