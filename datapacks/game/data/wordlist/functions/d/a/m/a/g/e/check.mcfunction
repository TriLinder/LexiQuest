scoreboard players set @s word_id 3156 
...
execute if block ~6 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:d/a/m/a/g/e/d/check 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:d/a/m/a/g/e/s/check 
