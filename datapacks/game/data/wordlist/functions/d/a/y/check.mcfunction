scoreboard players set @s word_id 96 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:d/a/y/s/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:d/a/y/t/check 
...
execute if block ~3 ~ ~ minecraft:blue_concrete_powder run function wordlist:d/a/y/l/check 
