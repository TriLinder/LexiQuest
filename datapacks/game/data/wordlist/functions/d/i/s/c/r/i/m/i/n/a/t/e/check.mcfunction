scoreboard players set @s word_id 12219 
...
execute if block ~12 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:d/i/s/c/r/i/m/i/n/a/t/e/d/check 
...
execute if block ~12 ~ ~ minecraft:magenta_wool run function wordlist:d/i/s/c/r/i/m/i/n/a/t/e/s/check 
