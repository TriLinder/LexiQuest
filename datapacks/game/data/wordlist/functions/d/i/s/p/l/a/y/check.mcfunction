scoreboard players set @s word_id 5304 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:d/i/s/p/l/a/y/s/check 
...
execute if block ~7 ~ ~ minecraft:yellow_concrete_powder run function wordlist:d/i/s/p/l/a/y/e/check 
...
execute if block ~7 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:d/i/s/p/l/a/y/i/check 
