...
execute if block ~6 ~ ~ minecraft:magenta_concrete_powder run function wordlist:d/i/s/t/i/n/c/check 
...
execute if block ~6 ~ ~ minecraft:pink_concrete_powder run function wordlist:d/i/s/t/i/n/g/check 
