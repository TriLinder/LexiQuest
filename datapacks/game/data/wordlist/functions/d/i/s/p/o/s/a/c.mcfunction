...
execute if block ~7 ~ ~ minecraft:blue_concrete_powder run function wordlist:d/i/s/p/o/s/a/l/c
...
execute if block ~7 ~ ~ minecraft:orange_concrete_powder run function wordlist:d/i/s/p/o/s/a/b/c
