scoreboard players set @s word_id 7340 
...
execute if block ~8 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:d/i/s/a/g/r/e/e/d/check 
...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:d/i/s/a/g/r/e/e/s/check 
...
execute if block ~8 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:d/i/s/a/g/r/e/e/i/check 
...
execute if block ~8 ~ ~ minecraft:brown_concrete_powder run function wordlist:d/i/s/a/g/r/e/e/m/check 
