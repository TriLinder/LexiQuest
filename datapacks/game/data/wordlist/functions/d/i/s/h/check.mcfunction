scoreboard players set @s word_id 512 
...
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run function wordlist:d/i/s/h/e/check 
...
execute if block ~4 ~ ~ minecraft:red_concrete_powder run function wordlist:d/i/s/h/o/check 
