scoreboard players set @s word_id 5305 
...
execute if block ~7 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:d/i/s/p/o/s/e/d/check 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:d/i/s/p/o/s/e/s/check 
