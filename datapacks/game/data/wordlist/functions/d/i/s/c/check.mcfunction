scoreboard players set @s word_id 511 
...
execute if block ~4 ~ ~ minecraft:red_concrete_powder run function wordlist:d/i/s/c/o/check 
execute if block ~ ~ ~4 minecraft:red_concrete_powder run scoreboard players set @s word_direction 1 
execute if block ~ ~ ~4 minecraft:red_concrete_powder run function wordlist:d/i/s/c/o/check 
execute if block ~4 ~ ~ minecraft:magenta_wool run scoreboard players set @s word_direction 0 
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:d/i/s/c/s/check 
execute if block ~ ~ ~4 minecraft:magenta_wool run scoreboard players set @s word_direction 1 
execute if block ~ ~ ~4 minecraft:magenta_wool run function wordlist:d/i/s/c/s/check 
execute if block ~4 ~ ~ minecraft:white_concrete_powder run scoreboard players set @s word_direction 0 
execute if block ~4 ~ ~ minecraft:white_concrete_powder run function wordlist:d/i/s/c/a/check 
...
execute if block ~4 ~ ~ minecraft:yellow_wool run function wordlist:d/i/s/c/u/check 
...
execute if block ~4 ~ ~ minecraft:orange_wool run function wordlist:d/i/s/c/r/check 
...
execute if block ~4 ~ ~ minecraft:gray_concrete_powder run function wordlist:d/i/s/c/h/check 
...
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:d/i/s/c/i/check 
...
execute if block ~4 ~ ~ minecraft:blue_concrete_powder run function wordlist:d/i/s/c/l/check 
