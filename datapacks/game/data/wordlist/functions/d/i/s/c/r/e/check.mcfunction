...
execute if block ~6 ~ ~ minecraft:light_blue_wool run function wordlist:d/i/s/c/r/e/t/check 
...
execute if block ~6 ~ ~ minecraft:black_concrete_powder run function wordlist:d/i/s/c/r/e/p/check 
