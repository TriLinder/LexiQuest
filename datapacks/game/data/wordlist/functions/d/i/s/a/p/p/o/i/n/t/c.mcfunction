...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 10539
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 10539
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 10539
...
execute if block ~10 ~ ~ minecraft:magenta_wool run function wordlist:d/i/s/a/p/p/o/i/n/t/s/c
...
execute if block ~10 ~ ~ minecraft:yellow_concrete_powder run function wordlist:d/i/s/a/p/p/o/i/n/t/e/c
...
execute if block ~10 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:d/i/s/a/p/p/o/i/n/t/i/c
execute if block ~ ~ ~10 minecraft:light_gray_concrete_powder run scoreboard players set @s word_direction 1
execute if block ~ ~ ~10 minecraft:light_gray_concrete_powder run function wordlist:d/i/s/a/p/p/o/i/n/t/i/c
execute if block ~10 ~ ~ minecraft:brown_concrete_powder run scoreboard players set @s word_direction 0
execute if block ~10 ~ ~ minecraft:brown_concrete_powder run function wordlist:d/i/s/a/p/p/o/i/n/t/m/c
execute if block ~ ~ ~10 minecraft:brown_concrete_powder run scoreboard players set @s word_direction 1
execute if block ~ ~ ~10 minecraft:brown_concrete_powder run function wordlist:d/i/s/a/p/p/o/i/n/t/m/c
