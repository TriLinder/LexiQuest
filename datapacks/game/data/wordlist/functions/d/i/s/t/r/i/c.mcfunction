...
execute if block ~6 ~ ~ minecraft:magenta_concrete_powder run function wordlist:d/i/s/t/r/i/c/c
...
execute if block ~6 ~ ~ minecraft:orange_concrete_powder run function wordlist:d/i/s/t/r/i/b/c
