...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 12156
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 12156
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 12156
...
execute if block ~11 ~ ~ minecraft:yellow_concrete_powder run function wordlist:d/i/s/t/i/n/g/u/i/s/h/e/c
...
execute if block ~11 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:d/i/s/t/i/n/g/u/i/s/h/i/c
