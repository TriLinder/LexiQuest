...
execute if block ~12 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:d/i/s/t/i/n/g/u/i/s/h/e/d/c
...
execute if block ~12 ~ ~ minecraft:magenta_wool run function wordlist:d/i/s/t/i/n/g/u/i/s/h/e/s/c
