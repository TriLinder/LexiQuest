scoreboard players set @s word_id 98 
...
execute if block ~3 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:d/i/e/d/check 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:d/i/e/s/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:d/i/e/t/check 
