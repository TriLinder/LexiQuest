scoreboard players set @s word_id 1594 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:d/i/g/i/t/s/check 
...
execute if block ~5 ~ ~ minecraft:white_concrete_powder run function wordlist:d/i/g/i/t/a/check 
