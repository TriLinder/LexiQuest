scoreboard players set @s word_id 99 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:d/i/g/s/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:d/i/g/i/check 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:d/i/g/e/check 
...
execute if block ~3 ~ ~ minecraft:pink_concrete_powder run function wordlist:d/i/g/g/check 
...
execute if block ~3 ~ ~ minecraft:green_concrete_powder run function wordlist:d/i/g/n/check 
