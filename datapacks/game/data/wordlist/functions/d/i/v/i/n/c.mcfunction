...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:d/i/v/i/n/e/c
...
execute if block ~5 ~ ~ minecraft:pink_concrete_powder run function wordlist:d/i/v/i/n/g/c
