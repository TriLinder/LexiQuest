scoreboard players set @s word_id 1618 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:d/r/a/f/t/s/check 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:d/r/a/f/t/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:d/r/a/f/t/i/check 
