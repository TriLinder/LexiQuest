scoreboard players set @s word_id 3207 
...
execute if block ~6 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:d/e/v/o/t/e/d/check 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:d/e/v/o/t/e/s/check 
