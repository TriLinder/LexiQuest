...
execute if block ~8 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:d/e/v/e/l/o/p/e/d/c
...
execute if block ~8 ~ ~ minecraft:orange_wool run function wordlist:d/e/v/e/l/o/p/e/r/c
