...
execute if block ~8 ~ ~ minecraft:red_concrete_powder run function wordlist:d/e/f/i/n/i/t/i/o/check 
...
execute if block ~8 ~ ~ minecraft:lime_wool run function wordlist:d/e/f/i/n/i/t/i/v/check 
