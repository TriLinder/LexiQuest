scoreboard players set @s word_id 3182 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:d/e/f/e/a/t/s/check 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:d/e/f/e/a/t/e/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:d/e/f/e/a/t/i/check 
