scoreboard players set @s word_id 498 
...
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run function wordlist:d/e/e/p/e/check 
...
execute if block ~4 ~ ~ minecraft:blue_concrete_powder run function wordlist:d/e/e/p/l/check 
