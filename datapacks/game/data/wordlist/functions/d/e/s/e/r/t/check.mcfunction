scoreboard players set @s word_id 3198 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:d/e/s/e/r/t/s/check 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:d/e/s/e/r/t/e/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:d/e/s/e/r/t/i/check 
