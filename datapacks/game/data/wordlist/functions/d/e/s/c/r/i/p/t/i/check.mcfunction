...
execute if block ~9 ~ ~ minecraft:red_concrete_powder run function wordlist:d/e/s/c/r/i/p/t/i/o/check 
...
execute if block ~9 ~ ~ minecraft:lime_wool run function wordlist:d/e/s/c/r/i/p/t/i/v/check 
