scoreboard players set @s word_id 9100 
...
execute if block ~9 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:d/e/s/i/g/n/a/t/e/d/check 
...
execute if block ~9 ~ ~ minecraft:magenta_wool run function wordlist:d/e/s/i/g/n/a/t/e/s/check 
