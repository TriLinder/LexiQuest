...
execute if block ~6 ~ ~ minecraft:orange_concrete_powder run function wordlist:d/e/s/c/r/i/b/c
...
execute if block ~6 ~ ~ minecraft:black_concrete_powder run function wordlist:d/e/s/c/r/i/p/c
