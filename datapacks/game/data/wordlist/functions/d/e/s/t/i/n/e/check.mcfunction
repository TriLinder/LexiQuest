scoreboard players set @s word_id 5273 
...
execute if block ~7 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:d/e/s/t/i/n/e/d/check 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:d/e/s/t/i/n/e/s/check 
