...
execute if block ~11 ~ ~ minecraft:green_concrete_powder run function wordlist:d/e/m/o/n/s/t/r/a/t/i/n/c
...
execute if block ~11 ~ ~ minecraft:red_concrete_powder run function wordlist:d/e/m/o/n/s/t/r/a/t/i/o/c
