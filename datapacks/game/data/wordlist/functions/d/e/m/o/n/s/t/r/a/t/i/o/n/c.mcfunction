...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 12757
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 12757
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 12757
...
execute if block ~13 ~ ~ minecraft:magenta_wool run function wordlist:d/e/m/o/n/s/t/r/a/t/i/o/n/s/c
