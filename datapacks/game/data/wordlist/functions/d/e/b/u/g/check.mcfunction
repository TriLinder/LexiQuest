scoreboard players set @s word_id 1580 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:d/e/b/u/g/s/check 
...
execute if block ~5 ~ ~ minecraft:pink_concrete_powder run function wordlist:d/e/b/u/g/g/check 
