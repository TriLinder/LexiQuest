scoreboard players set @s word_id 5258 
...
execute if block ~7 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:d/e/p/r/i/v/e/d/check 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:d/e/p/r/i/v/e/s/check 
