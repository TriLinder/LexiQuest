...
execute if block ~6 ~ ~ minecraft:yellow_wool run function wordlist:d/e/p/a/r/t/u/c
...
execute if block ~6 ~ ~ minecraft:brown_concrete_powder run function wordlist:d/e/p/a/r/t/m/c
