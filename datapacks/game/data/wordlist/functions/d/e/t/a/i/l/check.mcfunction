scoreboard players set @s word_id 3202 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:d/e/t/a/i/l/s/check 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:d/e/t/a/i/l/e/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:d/e/t/a/i/l/i/check 
