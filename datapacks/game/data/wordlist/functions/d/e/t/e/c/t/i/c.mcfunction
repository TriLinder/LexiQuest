...
execute if block ~7 ~ ~ minecraft:red_concrete_powder run function wordlist:d/e/t/e/c/t/i/o/c
...
execute if block ~7 ~ ~ minecraft:lime_wool run function wordlist:d/e/t/e/c/t/i/v/c
...
execute if block ~7 ~ ~ minecraft:green_concrete_powder run function wordlist:d/e/t/e/c/t/i/n/c
