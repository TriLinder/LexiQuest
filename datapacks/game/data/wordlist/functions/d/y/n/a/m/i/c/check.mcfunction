scoreboard players set @s word_id 5349 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:d/y/n/a/m/i/c/s/check 
...
execute if block ~7 ~ ~ minecraft:white_concrete_powder run function wordlist:d/y/n/a/m/i/c/a/check 
