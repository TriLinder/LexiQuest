scoreboard players set @s word_id 103 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:d/o/g/s/check 
...
execute if block ~3 ~ ~ minecraft:brown_concrete_powder run function wordlist:d/o/g/m/check 
