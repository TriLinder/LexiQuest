scoreboard players set @s word_id 104 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:d/o/n/e/check 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:d/o/n/s/check 
...
execute if block ~3 ~ ~ minecraft:white_concrete_powder run function wordlist:d/o/n/a/check 
