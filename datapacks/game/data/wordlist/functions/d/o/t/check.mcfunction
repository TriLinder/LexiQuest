scoreboard players set @s word_id 105 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:d/o/t/s/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:d/o/t/t/check 
