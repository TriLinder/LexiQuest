...
execute if block ~1 ~ ~ minecraft:red_concrete_powder run function wordlist:d/o/c
...
execute if block ~1 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:d/i/c
...
execute if block ~1 ~ ~ minecraft:yellow_wool run function wordlist:d/u/c
...
execute if block ~1 ~ ~ minecraft:orange_wool run function wordlist:d/r/c
...
execute if block ~1 ~ ~ minecraft:white_concrete_powder run function wordlist:d/a/c
...
execute if block ~1 ~ ~ minecraft:yellow_concrete_powder run function wordlist:d/e/c
...
execute if block ~1 ~ ~ minecraft:light_gray_wool run function wordlist:d/y/c
