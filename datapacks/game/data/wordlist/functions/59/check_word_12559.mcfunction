#Auto-generated check for: HOMOSEXUALITY

#East (+x) direction
execute if block ~-1 ~ ~ minecraft:purple_wool if block ~0 ~ ~ minecraft:gray_concrete_powder if block ~1 ~ ~ minecraft:red_concrete_powder if block ~2 ~ ~ minecraft:brown_concrete_powder if block ~3 ~ ~ minecraft:red_concrete_powder if block ~4 ~ ~ minecraft:magenta_wool if block ~5 ~ ~ minecraft:yellow_concrete_powder if block ~6 ~ ~ minecraft:gray_wool if block ~7 ~ ~ minecraft:yellow_wool if block ~8 ~ ~ minecraft:white_concrete_powder if block ~9 ~ ~ minecraft:blue_concrete_powder if block ~10 ~ ~ minecraft:light_gray_concrete_powder if block ~11 ~ ~ minecraft:light_blue_wool if block ~12 ~ ~ minecraft:light_gray_wool if block ~13 ~ ~ minecraft:purple_wool run scoreboard players set @s word_direction 0

#South (+z) direction
execute if block ~ ~ ~-1 minecraft:purple_wool if block ~ ~ ~0 minecraft:gray_concrete_powder if block ~ ~ ~1 minecraft:red_concrete_powder if block ~ ~ ~2 minecraft:brown_concrete_powder if block ~ ~ ~3 minecraft:red_concrete_powder if block ~ ~ ~4 minecraft:magenta_wool if block ~ ~ ~5 minecraft:yellow_concrete_powder if block ~ ~ ~6 minecraft:gray_wool if block ~ ~ ~7 minecraft:yellow_wool if block ~ ~ ~8 minecraft:white_concrete_powder if block ~ ~ ~9 minecraft:blue_concrete_powder if block ~ ~ ~10 minecraft:light_gray_concrete_powder if block ~ ~ ~11 minecraft:light_blue_wool if block ~ ~ ~12 minecraft:light_gray_wool if block ~ ~ ~13 minecraft:purple_wool run scoreboard players set @s word_direction 1
execute unless score @s word_direction matches -1 run scoreboard players set @s word_id 12559
