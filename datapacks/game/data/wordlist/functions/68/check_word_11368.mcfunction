#Auto-generated check for: VIGOROUSLY

#East (+x) direction
execute if block ~-1 ~ ~ minecraft:purple_wool if block ~0 ~ ~ minecraft:lime_wool if block ~1 ~ ~ minecraft:light_gray_concrete_powder if block ~2 ~ ~ minecraft:pink_concrete_powder if block ~3 ~ ~ minecraft:red_concrete_powder if block ~4 ~ ~ minecraft:orange_wool if block ~5 ~ ~ minecraft:red_concrete_powder if block ~6 ~ ~ minecraft:yellow_wool if block ~7 ~ ~ minecraft:magenta_wool if block ~8 ~ ~ minecraft:blue_concrete_powder if block ~9 ~ ~ minecraft:light_gray_wool if block ~10 ~ ~ minecraft:purple_wool run scoreboard players set @s word_direction 0

#South (+z) direction
execute if block ~ ~ ~-1 minecraft:purple_wool if block ~ ~ ~0 minecraft:lime_wool if block ~ ~ ~1 minecraft:light_gray_concrete_powder if block ~ ~ ~2 minecraft:pink_concrete_powder if block ~ ~ ~3 minecraft:red_concrete_powder if block ~ ~ ~4 minecraft:orange_wool if block ~ ~ ~5 minecraft:red_concrete_powder if block ~ ~ ~6 minecraft:yellow_wool if block ~ ~ ~7 minecraft:magenta_wool if block ~ ~ ~8 minecraft:blue_concrete_powder if block ~ ~ ~9 minecraft:light_gray_wool if block ~ ~ ~10 minecraft:purple_wool run scoreboard players set @s word_direction 1
execute unless score @s word_direction matches -1 run scoreboard players set @s word_id 11368
