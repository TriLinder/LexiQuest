scoreboard players set @s word_id 174 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:k/i/t/s/check 
...
execute if block ~3 ~ ~ minecraft:magenta_concrete_powder run function wordlist:k/i/t/c/check 
