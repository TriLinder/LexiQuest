scoreboard players set @s word_id 1382 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:b/l/a/c/k/s/check 
...
execute if block ~5 ~ ~ minecraft:brown_concrete_powder run function wordlist:b/l/a/c/k/m/check 
...
execute if block ~5 ~ ~ minecraft:orange_concrete_powder run function wordlist:b/l/a/c/k/b/check 
