scoreboard players set @s word_id 1411 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:b/o/u/n/d/s/check 
...
execute if block ~5 ~ ~ minecraft:white_concrete_powder run function wordlist:b/o/u/n/d/a/check 
