...
execute if block ~2 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:b/i/d/check 
...
execute if block ~2 ~ ~ minecraft:pink_concrete_powder run function wordlist:b/i/g/check 
...
execute if block ~2 ~ ~ minecraft:green_concrete_powder run function wordlist:b/i/n/check 
...
execute if block ~2 ~ ~ minecraft:light_blue_wool run function wordlist:b/i/t/check 
...
execute if block ~2 ~ ~ minecraft:white_concrete_powder run function wordlist:b/i/a/check 
...
execute if block ~2 ~ ~ minecraft:blue_concrete_powder run function wordlist:b/i/l/check 
...
execute if block ~2 ~ ~ minecraft:orange_wool run function wordlist:b/i/r/check 
...
execute if block ~2 ~ ~ minecraft:orange_concrete_powder run function wordlist:b/i/b/check 
...
execute if block ~2 ~ ~ minecraft:magenta_wool run function wordlist:b/i/s/check 
...
execute if block ~2 ~ ~ minecraft:magenta_concrete_powder run function wordlist:b/i/c/check 
...
execute if block ~2 ~ ~ minecraft:red_concrete_powder run function wordlist:b/i/o/check 
...
execute if block ~2 ~ ~ minecraft:cyan_wool run function wordlist:b/i/z/check 
