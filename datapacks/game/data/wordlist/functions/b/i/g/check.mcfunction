scoreboard players set @s word_id 71 
...
execute if block ~3 ~ ~ minecraft:red_concrete_powder run function wordlist:b/i/g/o/check 
...
execute if block ~3 ~ ~ minecraft:pink_concrete_powder run function wordlist:b/i/g/g/check 
