scoreboard players set @s word_id 73 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:b/i/t/e/check 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:b/i/t/s/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:b/i/t/i/check 
...
execute if block ~3 ~ ~ minecraft:brown_concrete_powder run function wordlist:b/i/t/m/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:b/i/t/t/check 
