...
execute if block ~3 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:b/i/r/d/c
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:b/i/r/t/c
