scoreboard players set @s word_id 70 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:b/i/d/s/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:b/i/d/d/check 
