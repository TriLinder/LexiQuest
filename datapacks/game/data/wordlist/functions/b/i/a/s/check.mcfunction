scoreboard players set @s word_id 376 
...
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run function wordlist:b/i/a/s/e/check 
...
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:b/i/a/s/i/check 
