scoreboard players set @s word_id 72 
...
execute if block ~3 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:b/i/n/d/check 
...
execute if block ~3 ~ ~ minecraft:white_concrete_powder run function wordlist:b/i/n/a/check 
