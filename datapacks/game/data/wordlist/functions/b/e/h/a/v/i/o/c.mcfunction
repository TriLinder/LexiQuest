...
execute if block ~7 ~ ~ minecraft:orange_wool run function wordlist:b/e/h/a/v/i/o/r/c
...
execute if block ~7 ~ ~ minecraft:yellow_wool run function wordlist:b/e/h/a/v/i/o/u/c
