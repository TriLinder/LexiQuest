...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 20
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 20
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 20
...
execute if block ~2 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:b/e/d/c
...
execute if block ~2 ~ ~ minecraft:yellow_concrete_powder run function wordlist:b/e/e/c
...
execute if block ~2 ~ ~ minecraft:pink_concrete_powder run function wordlist:b/e/g/c
...
execute if block ~2 ~ ~ minecraft:light_blue_wool run function wordlist:b/e/t/c
...
execute if block ~2 ~ ~ minecraft:white_concrete_powder run function wordlist:b/e/a/c
...
execute if block ~2 ~ ~ minecraft:blue_concrete_powder run function wordlist:b/e/l/c
...
execute if block ~2 ~ ~ minecraft:green_concrete_powder run function wordlist:b/e/n/c
...
execute if block ~2 ~ ~ minecraft:magenta_wool run function wordlist:b/e/s/c
...
execute if block ~2 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:b/e/i/c
...
execute if block ~2 ~ ~ minecraft:light_gray_wool run function wordlist:b/e/y/c
...
execute if block ~2 ~ ~ minecraft:magenta_concrete_powder run function wordlist:b/e/c/c
...
execute if block ~2 ~ ~ minecraft:pink_wool run function wordlist:b/e/w/c
...
execute if block ~2 ~ ~ minecraft:gray_concrete_powder run function wordlist:b/e/h/c
...
execute if block ~2 ~ ~ minecraft:lime_concrete_powder run function wordlist:b/e/f/c
