scoreboard players set @s word_id 1366 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:b/e/g/i/n/s/check 
...
execute if block ~5 ~ ~ minecraft:green_concrete_powder run function wordlist:b/e/g/i/n/n/check 
