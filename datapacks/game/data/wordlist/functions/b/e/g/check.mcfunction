scoreboard players set @s word_id 68 
...
execute if block ~3 ~ ~ minecraft:white_concrete_powder run function wordlist:b/e/g/a/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:b/e/g/i/check 
...
execute if block ~3 ~ ~ minecraft:yellow_wool run function wordlist:b/e/g/u/check 
