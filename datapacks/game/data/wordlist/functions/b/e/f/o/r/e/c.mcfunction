...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 3997
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 3997
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 3997
...
execute if block ~6 ~ ~ minecraft:gray_concrete_powder run function wordlist:b/e/f/o/r/e/h/c
