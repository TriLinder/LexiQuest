scoreboard players set @s word_id 1359 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:b/e/a/r/d/s/check 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:b/e/a/r/d/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:b/e/a/r/d/i/check 
