scoreboard players set @s word_id 62 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:b/a/g/s/check 
...
execute if block ~3 ~ ~ minecraft:pink_concrete_powder run function wordlist:b/a/g/g/check 
