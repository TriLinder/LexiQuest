scoreboard players set @s word_id 2866 
...
execute if block ~6 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:b/a/f/f/l/e/d/check 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:b/a/f/f/l/e/s/check 
