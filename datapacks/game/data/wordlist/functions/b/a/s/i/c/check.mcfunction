scoreboard players set @s word_id 1353 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:b/a/s/i/c/s/check 
...
execute if block ~5 ~ ~ minecraft:white_concrete_powder run function wordlist:b/a/s/i/c/a/check 
