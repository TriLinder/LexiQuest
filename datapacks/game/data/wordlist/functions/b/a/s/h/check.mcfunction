scoreboard players set @s word_id 357 
...
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run function wordlist:b/a/s/h/e/check 
...
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:b/a/s/h/i/check 
