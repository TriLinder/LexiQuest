scoreboard players set @s word_id 61 
...
execute if block ~3 ~ ~ minecraft:pink_concrete_powder run function wordlist:b/a/d/g/check 
...
execute if block ~3 ~ ~ minecraft:blue_concrete_powder run function wordlist:b/a/d/l/check 
