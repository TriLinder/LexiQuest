scoreboard players set @s word_id 65 
...
execute if block ~3 ~ ~ minecraft:gray_concrete_powder run function wordlist:b/a/t/h/check 
...
execute if block ~3 ~ ~ minecraft:magenta_concrete_powder run function wordlist:b/a/t/c/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:b/a/t/t/check 
