scoreboard players set @s word_id 82 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:b/u/y/s/check 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:b/u/y/e/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:b/u/y/i/check 
