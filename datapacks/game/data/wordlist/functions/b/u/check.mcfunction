...
execute if block ~2 ~ ~ minecraft:pink_concrete_powder run function wordlist:b/u/g/check 
...
execute if block ~2 ~ ~ minecraft:magenta_wool run function wordlist:b/u/s/check 
...
execute if block ~2 ~ ~ minecraft:light_blue_wool run function wordlist:b/u/t/check 
...
execute if block ~2 ~ ~ minecraft:light_gray_wool run function wordlist:b/u/y/check 
...
execute if block ~2 ~ ~ minecraft:magenta_concrete_powder run function wordlist:b/u/c/check 
...
execute if block ~2 ~ ~ minecraft:blue_concrete_powder run function wordlist:b/u/l/check 
...
execute if block ~2 ~ ~ minecraft:brown_concrete_powder run function wordlist:b/u/m/check 
...
execute if block ~2 ~ ~ minecraft:orange_wool run function wordlist:b/u/r/check 
...
execute if block ~2 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:b/u/i/check 
...
execute if block ~2 ~ ~ minecraft:green_concrete_powder run function wordlist:b/u/n/check 
...
execute if block ~2 ~ ~ minecraft:orange_concrete_powder run function wordlist:b/u/b/check 
...
execute if block ~2 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:b/u/d/check 
...
execute if block ~2 ~ ~ minecraft:lime_concrete_powder run function wordlist:b/u/f/check 
