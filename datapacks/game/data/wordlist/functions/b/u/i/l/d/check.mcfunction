scoreboard players set @s word_id 1432 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:b/u/i/l/d/s/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:b/u/i/l/d/i/check 
