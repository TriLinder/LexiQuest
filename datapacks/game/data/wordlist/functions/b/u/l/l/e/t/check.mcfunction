scoreboard players set @s word_id 2983 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:b/u/l/l/e/t/s/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:b/u/l/l/e/t/i/check 
