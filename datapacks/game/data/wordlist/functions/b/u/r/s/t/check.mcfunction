scoreboard players set @s word_id 1438 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:b/u/r/s/t/s/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:b/u/r/s/t/i/check 
