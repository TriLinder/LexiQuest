scoreboard players set @s word_id 414 
...
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:b/u/r/n/s/check 
execute if block ~ ~ ~4 minecraft:magenta_wool run scoreboard players set @s word_direction 1 
execute if block ~ ~ ~4 minecraft:magenta_wool run function wordlist:b/u/r/n/s/check 
execute if block ~4 ~ ~ minecraft:light_blue_wool run scoreboard players set @s word_direction 0 
execute if block ~4 ~ ~ minecraft:light_blue_wool run function wordlist:b/u/r/n/t/check 
...
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run function wordlist:b/u/r/n/e/check 
...
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:b/u/r/n/i/check 
