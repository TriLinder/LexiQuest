...
execute if block ~4 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:b/r/e/e/d/c
...
execute if block ~4 ~ ~ minecraft:cyan_wool run function wordlist:b/r/e/e/z/c
