scoreboard players set @s word_id 4958 
...
execute if block ~7 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:b/r/e/a/t/h/e/d/check 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:b/r/e/a/t/h/e/s/check 
