scoreboard players set @s word_id 2965 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:b/r/e/a/t/h/e/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:b/r/e/a/t/h/i/check 
