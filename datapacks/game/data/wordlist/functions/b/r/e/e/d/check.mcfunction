scoreboard players set @s word_id 1422 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:b/r/e/e/d/s/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:b/r/e/e/d/i/check 
