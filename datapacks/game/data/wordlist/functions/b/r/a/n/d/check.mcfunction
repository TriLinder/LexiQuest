scoreboard players set @s word_id 1417 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:b/r/a/n/d/s/check 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:b/r/a/n/d/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:b/r/a/n/d/i/check 
