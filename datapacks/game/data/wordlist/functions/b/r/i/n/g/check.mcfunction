scoreboard players set @s word_id 1425 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:b/r/i/n/g/s/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:b/r/i/n/g/i/check 
