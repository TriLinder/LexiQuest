...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 1553
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 1553
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 1553
...
execute if block ~5 ~ ~ minecraft:green_concrete_powder run function wordlist:a/f/t/e/r/n/c
...
execute if block ~5 ~ ~ minecraft:pink_wool run function wordlist:a/f/t/e/r/w/c
