scoreboard players set @s word_id 1272 
...
execute if block ~5 ~ ~ minecraft:green_concrete_powder run function wordlist:a/f/t/e/r/n/check 
...
execute if block ~5 ~ ~ minecraft:pink_wool run function wordlist:a/f/t/e/r/w/check 
