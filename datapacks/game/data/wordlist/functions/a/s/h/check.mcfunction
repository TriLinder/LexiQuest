scoreboard players set @s word_id 56 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:a/s/h/e/check 
...
execute if block ~3 ~ ~ minecraft:magenta_concrete_powder run function wordlist:a/s/h/c/check 
...
execute if block ~3 ~ ~ minecraft:white_concrete_powder run function wordlist:a/s/h/a/check 
