scoreboard players set @s word_id 2848 
...
execute if block ~6 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:a/s/s/u/r/e/d/check 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:a/s/s/u/r/e/s/check 
