scoreboard players set @s word_id 8810 
...
execute if block ~9 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:a/s/s/o/c/i/a/t/e/d/check 
...
execute if block ~9 ~ ~ minecraft:magenta_wool run function wordlist:a/s/s/o/c/i/a/t/e/s/check 
