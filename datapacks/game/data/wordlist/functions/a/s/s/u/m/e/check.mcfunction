scoreboard players set @s word_id 2847 
...
execute if block ~6 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:a/s/s/u/m/e/d/check 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:a/s/s/u/m/e/s/check 
