scoreboard players set @s word_id 6952 
...
execute if block ~8 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:a/s/s/e/m/b/l/e/d/check 
...
execute if block ~8 ~ ~ minecraft:orange_wool run function wordlist:a/s/s/e/m/b/l/e/r/check 
...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:a/s/s/e/m/b/l/e/s/check 
