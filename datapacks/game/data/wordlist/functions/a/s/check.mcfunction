scoreboard players set @s word_id 5 
...
execute if block ~2 ~ ~ minecraft:gray_concrete_powder run function wordlist:a/s/h/check 
...
execute if block ~2 ~ ~ minecraft:purple_concrete_powder run function wordlist:a/s/k/check 
...
execute if block ~2 ~ ~ minecraft:magenta_wool run function wordlist:a/s/s/check 
...
execute if block ~2 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:a/s/i/check 
...
execute if block ~2 ~ ~ minecraft:magenta_concrete_powder run function wordlist:a/s/c/check 
...
execute if block ~2 ~ ~ minecraft:blue_concrete_powder run function wordlist:a/s/l/check 
...
execute if block ~2 ~ ~ minecraft:black_concrete_powder run function wordlist:a/s/p/check 
...
execute if block ~2 ~ ~ minecraft:light_blue_wool run function wordlist:a/s/t/check 
...
execute if block ~2 ~ ~ minecraft:light_gray_wool run function wordlist:a/s/y/check 
