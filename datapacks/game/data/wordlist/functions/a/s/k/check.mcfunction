scoreboard players set @s word_id 57 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:a/s/k/s/check 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:a/s/k/e/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:a/s/k/i/check 
