...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 11
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 11
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 11
...
execute if block ~2 ~ ~ minecraft:magenta_wool run function wordlist:a/s/s/c
...
execute if block ~2 ~ ~ minecraft:purple_concrete_powder run function wordlist:a/s/k/c
...
execute if block ~2 ~ ~ minecraft:gray_concrete_powder run function wordlist:a/s/h/c
...
execute if block ~2 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:a/s/i/c
...
execute if block ~2 ~ ~ minecraft:blue_concrete_powder run function wordlist:a/s/l/c
...
execute if block ~2 ~ ~ minecraft:magenta_concrete_powder run function wordlist:a/s/c/c
...
execute if block ~2 ~ ~ minecraft:black_concrete_powder run function wordlist:a/s/p/c
...
execute if block ~2 ~ ~ minecraft:light_blue_wool run function wordlist:a/s/t/c
...
execute if block ~2 ~ ~ minecraft:light_gray_wool run function wordlist:a/s/y/c
