scoreboard players set @s word_id 6851 
...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:a/c/c/i/d/e/n/t/s/check 
...
execute if block ~8 ~ ~ minecraft:white_concrete_powder run function wordlist:a/c/c/i/d/e/n/t/a/check 
