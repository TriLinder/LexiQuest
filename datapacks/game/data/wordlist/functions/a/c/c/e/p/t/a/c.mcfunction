...
execute if block ~7 ~ ~ minecraft:green_concrete_powder run function wordlist:a/c/c/e/p/t/a/n/c
...
execute if block ~7 ~ ~ minecraft:orange_concrete_powder run function wordlist:a/c/c/e/p/t/a/b/c
