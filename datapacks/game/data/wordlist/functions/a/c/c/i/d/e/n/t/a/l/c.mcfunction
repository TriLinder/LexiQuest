...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 10703
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 10703
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 10703
...
execute if block ~10 ~ ~ minecraft:blue_concrete_powder run function wordlist:a/c/c/i/d/e/n/t/a/l/l/c
