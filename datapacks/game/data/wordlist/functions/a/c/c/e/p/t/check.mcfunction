scoreboard players set @s word_id 2750 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:a/c/c/e/p/t/s/check 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:a/c/c/e/p/t/e/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:a/c/c/e/p/t/i/check 
...
execute if block ~6 ~ ~ minecraft:white_concrete_powder run function wordlist:a/c/c/e/p/t/a/check 
