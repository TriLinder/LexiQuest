scoreboard players set @s word_id 40 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:a/c/t/s/check 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:a/c/t/e/check 
...
execute if block ~3 ~ ~ minecraft:red_concrete_powder run function wordlist:a/c/t/o/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:a/c/t/i/check 
...
execute if block ~3 ~ ~ minecraft:yellow_wool run function wordlist:a/c/t/u/check 
