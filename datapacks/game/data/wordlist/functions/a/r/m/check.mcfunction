scoreboard players set @s word_id 54 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:a/r/m/s/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_wool run function wordlist:a/r/m/y/check 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:a/r/m/e/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:a/r/m/i/check 
