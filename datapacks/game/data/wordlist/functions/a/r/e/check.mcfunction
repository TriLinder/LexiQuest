scoreboard players set @s word_id 53 
...
execute if block ~3 ~ ~ minecraft:white_concrete_powder run function wordlist:a/r/e/a/check 
...
execute if block ~3 ~ ~ minecraft:green_concrete_powder run function wordlist:a/r/e/n/check 
