scoreboard players set @s word_id 331 
...
execute if block ~4 ~ ~ minecraft:white_concrete_powder run function wordlist:a/r/c/h/a/check 
...
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:a/r/c/h/i/check 
