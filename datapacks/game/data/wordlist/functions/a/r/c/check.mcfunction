scoreboard players set @s word_id 52 
...
execute if block ~3 ~ ~ minecraft:gray_concrete_powder run function wordlist:a/r/c/h/check 
...
execute if block ~3 ~ ~ minecraft:white_concrete_powder run function wordlist:a/r/c/a/check 
