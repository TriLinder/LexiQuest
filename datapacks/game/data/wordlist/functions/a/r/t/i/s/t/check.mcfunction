scoreboard players set @s word_id 2835 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:a/r/t/i/s/t/s/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:a/r/t/i/s/t/i/check 
