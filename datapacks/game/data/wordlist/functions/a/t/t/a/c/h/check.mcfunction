scoreboard players set @s word_id 2851 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:a/t/t/a/c/h/e/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:a/t/t/a/c/h/i/check 
...
execute if block ~6 ~ ~ minecraft:brown_concrete_powder run function wordlist:a/t/t/a/c/h/m/check 
