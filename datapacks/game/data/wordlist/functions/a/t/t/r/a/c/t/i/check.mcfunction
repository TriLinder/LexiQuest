...
execute if block ~8 ~ ~ minecraft:green_concrete_powder run function wordlist:a/t/t/r/a/c/t/i/n/check 
...
execute if block ~8 ~ ~ minecraft:red_concrete_powder run function wordlist:a/t/t/r/a/c/t/i/o/check 
...
execute if block ~8 ~ ~ minecraft:lime_wool run function wordlist:a/t/t/r/a/c/t/i/v/check 
