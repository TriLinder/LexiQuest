scoreboard players set @s word_id 42 
...
execute if block ~3 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:a/g/e/d/check 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:a/g/e/s/check 
...
execute if block ~3 ~ ~ minecraft:green_concrete_powder run function wordlist:a/g/e/n/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:a/g/e/i/check 
