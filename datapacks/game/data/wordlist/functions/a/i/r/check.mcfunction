scoreboard players set @s word_id 46 
...
execute if block ~3 ~ ~ minecraft:black_concrete_powder run function wordlist:a/i/r/p/check 
...
execute if block ~3 ~ ~ minecraft:magenta_concrete_powder run function wordlist:a/i/r/c/check 
