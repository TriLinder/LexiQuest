scoreboard players set @s word_id 44 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:a/i/d/s/check 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:a/i/d/e/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:a/i/d/i/check 
