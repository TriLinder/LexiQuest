scoreboard players set @s word_id 45 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:a/i/m/s/check 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:a/i/m/e/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:a/i/m/i/check 
