...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 11999
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 11999
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 11999
...
execute if block ~11 ~ ~ minecraft:blue_concrete_powder run function wordlist:a/p/p/r/o/x/i/m/a/t/e/l/c
