scoreboard players set @s word_id 10298 
...
execute if block ~10 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:a/p/p/r/e/c/i/a/t/e/d/check 
...
execute if block ~10 ~ ~ minecraft:magenta_wool run function wordlist:a/p/p/r/e/c/i/a/t/e/s/check 
