scoreboard players set @s word_id 4836 
...
execute if block ~7 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:a/p/p/r/o/v/e/d/check 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:a/p/p/r/o/v/e/s/check 
