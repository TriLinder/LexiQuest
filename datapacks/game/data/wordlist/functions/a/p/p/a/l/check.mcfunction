scoreboard players set @s word_id 1310 
...
execute if block ~5 ~ ~ minecraft:blue_concrete_powder run function wordlist:a/p/p/a/l/l/check 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:a/p/p/a/l/s/check 
