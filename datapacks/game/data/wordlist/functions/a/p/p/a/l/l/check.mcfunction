scoreboard players set @s word_id 2816 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:a/p/p/a/l/l/s/check 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:a/p/p/a/l/l/e/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:a/p/p/a/l/l/i/check 
