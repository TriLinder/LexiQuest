scoreboard players set @s word_id 2819 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:a/p/p/e/a/r/s/check 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:a/p/p/e/a/r/e/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:a/p/p/e/a/r/i/check 
...
execute if block ~6 ~ ~ minecraft:white_concrete_powder run function wordlist:a/p/p/e/a/r/a/check 
