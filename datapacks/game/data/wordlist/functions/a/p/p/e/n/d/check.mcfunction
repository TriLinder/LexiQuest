scoreboard players set @s word_id 2820 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:a/p/p/e/n/d/s/check 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:a/p/p/e/n/d/e/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:a/p/p/e/n/d/i/check 
