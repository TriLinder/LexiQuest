...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 31
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 31
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 31
...
execute if block ~2 ~ ~ minecraft:light_gray_wool run function wordlist:a/n/y/c
...
execute if block ~2 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:a/n/d/c
...
execute if block ~2 ~ ~ minecraft:pink_concrete_powder run function wordlist:a/n/g/c
...
execute if block ~2 ~ ~ minecraft:lime_wool run function wordlist:a/n/v/c
...
execute if block ~2 ~ ~ minecraft:green_concrete_powder run function wordlist:a/n/n/c
...
execute if block ~2 ~ ~ minecraft:white_concrete_powder run function wordlist:a/n/a/c
...
execute if block ~2 ~ ~ minecraft:magenta_wool run function wordlist:a/n/s/c
...
execute if block ~2 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:a/n/i/c
...
execute if block ~2 ~ ~ minecraft:red_concrete_powder run function wordlist:a/n/o/c
...
execute if block ~2 ~ ~ minecraft:gray_wool run function wordlist:a/n/x/c
...
execute if block ~2 ~ ~ minecraft:light_blue_wool run function wordlist:a/n/t/c
...
execute if block ~2 ~ ~ minecraft:magenta_concrete_powder run function wordlist:a/n/c/c
...
execute if block ~2 ~ ~ minecraft:yellow_concrete_powder run function wordlist:a/n/e/c
