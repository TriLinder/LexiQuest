scoreboard players set @s word_id 10286 
...
execute if block ~10 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:a/n/t/i/c/i/p/a/t/e/d/check 
...
execute if block ~10 ~ ~ minecraft:magenta_wool run function wordlist:a/n/t/i/c/i/p/a/t/e/s/check 
