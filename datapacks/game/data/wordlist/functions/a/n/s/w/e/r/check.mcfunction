scoreboard players set @s word_id 2811 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:a/n/s/w/e/r/s/check 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:a/n/s/w/e/r/e/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:a/n/s/w/e/r/i/check 
