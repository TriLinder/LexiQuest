scoreboard players set @s word_id 6913 
...
execute if block ~8 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:a/n/n/o/u/n/c/e/d/check 
...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:a/n/n/o/u/n/c/e/s/check 
...
execute if block ~8 ~ ~ minecraft:brown_concrete_powder run function wordlist:a/n/n/o/u/n/c/e/m/check 
