scoreboard players set @s word_id 4 
...
execute if block ~2 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:a/n/d/check 
...
execute if block ~2 ~ ~ minecraft:light_gray_wool run function wordlist:a/n/y/check 
...
execute if block ~2 ~ ~ minecraft:pink_concrete_powder run function wordlist:a/n/g/check 
...
execute if block ~2 ~ ~ minecraft:green_concrete_powder run function wordlist:a/n/n/check 
...
execute if block ~2 ~ ~ minecraft:white_concrete_powder run function wordlist:a/n/a/check 
...
execute if block ~2 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:a/n/i/check 
...
execute if block ~2 ~ ~ minecraft:red_concrete_powder run function wordlist:a/n/o/check 
...
execute if block ~2 ~ ~ minecraft:magenta_wool run function wordlist:a/n/s/check 
...
execute if block ~2 ~ ~ minecraft:magenta_concrete_powder run function wordlist:a/n/c/check 
...
execute if block ~2 ~ ~ minecraft:light_blue_wool run function wordlist:a/n/t/check 
...
execute if block ~2 ~ ~ minecraft:gray_wool run function wordlist:a/n/x/check 
...
execute if block ~2 ~ ~ minecraft:yellow_concrete_powder run function wordlist:a/n/e/check 
