scoreboard players set @s word_id 1298 
...
execute if block ~5 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:a/m/a/z/e/d/check 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:a/m/a/z/e/s/check 
