...
execute if block ~2 ~ ~ minecraft:white_concrete_powder run function wordlist:a/w/a/c
...
execute if block ~2 ~ ~ minecraft:lime_concrete_powder run function wordlist:a/w/f/c
...
execute if block ~2 ~ ~ minecraft:purple_concrete_powder run function wordlist:a/w/k/c
