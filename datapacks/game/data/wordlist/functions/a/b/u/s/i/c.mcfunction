...
execute if block ~5 ~ ~ minecraft:green_concrete_powder run function wordlist:a/b/u/s/i/n/c
...
execute if block ~5 ~ ~ minecraft:lime_wool run function wordlist:a/b/u/s/i/v/c
