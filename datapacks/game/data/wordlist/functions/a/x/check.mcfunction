scoreboard players set @s word_id 7 
...
execute if block ~2 ~ ~ minecraft:yellow_concrete_powder run function wordlist:a/x/e/check 
...
execute if block ~2 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:a/x/i/check 
