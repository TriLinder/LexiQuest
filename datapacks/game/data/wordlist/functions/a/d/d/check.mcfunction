scoreboard players set @s word_id 41 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:a/d/d/s/check 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:a/d/d/e/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:a/d/d/i/check 
...
execute if block ~3 ~ ~ minecraft:orange_wool run function wordlist:a/d/d/r/check 
