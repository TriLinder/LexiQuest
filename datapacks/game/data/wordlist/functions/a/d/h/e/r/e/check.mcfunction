scoreboard players set @s word_id 2763 
...
execute if block ~6 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:a/d/h/e/r/e/d/check 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:a/d/h/e/r/e/s/check 
