scoreboard players set @s word_id 4776 
...
execute if block ~7 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:a/d/v/a/n/c/e/d/check 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:a/d/v/a/n/c/e/s/check 
