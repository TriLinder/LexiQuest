...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 2974
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 2974
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 2974
...
execute if block ~6 ~ ~ minecraft:yellow_wool run function wordlist:a/d/v/e/n/t/u/c
