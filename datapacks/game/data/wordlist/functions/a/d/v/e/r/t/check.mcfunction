scoreboard players set @s word_id 2770 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:a/d/v/e/r/t/s/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:a/d/v/e/r/t/i/check 
