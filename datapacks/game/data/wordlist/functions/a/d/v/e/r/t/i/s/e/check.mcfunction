scoreboard players set @s word_id 8734 
...
execute if block ~9 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:a/d/v/e/r/t/i/s/e/d/check 
...
execute if block ~9 ~ ~ minecraft:magenta_wool run function wordlist:a/d/v/e/r/t/i/s/e/s/check 
...
execute if block ~9 ~ ~ minecraft:brown_concrete_powder run function wordlist:a/d/v/e/r/t/i/s/e/m/check 
