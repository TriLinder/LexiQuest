scoreboard players set @s word_id 6886 
...
execute if block ~8 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:a/d/v/o/c/a/t/e/d/check 
...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:a/d/v/o/c/a/t/e/s/check 
