scoreboard players set @s word_id 1270 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:a/d/o/p/t/s/check 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:a/d/o/p/t/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:a/d/o/p/t/i/check 
