scoreboard players set @s word_id 1269 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:a/d/m/i/t/s/check 
...
execute if block ~5 ~ ~ minecraft:light_blue_wool run function wordlist:a/d/m/i/t/t/check 
