...
execute if block ~6 ~ ~ minecraft:orange_concrete_powder run function wordlist:a/d/m/i/r/a/b/check 
...
execute if block ~6 ~ ~ minecraft:light_blue_wool run function wordlist:a/d/m/i/r/a/t/check 
