...
execute if block ~12 ~ ~ minecraft:red_concrete_powder run function wordlist:a/d/m/i/n/i/s/t/r/a/t/i/o/c
...
execute if block ~12 ~ ~ minecraft:lime_wool run function wordlist:a/d/m/i/n/i/s/t/r/a/t/i/v/c
