...
execute if block ~6 ~ ~ minecraft:orange_concrete_powder run function wordlist:a/l/l/o/w/a/b/check 
...
execute if block ~6 ~ ~ minecraft:green_concrete_powder run function wordlist:a/l/l/o/w/a/n/check 
