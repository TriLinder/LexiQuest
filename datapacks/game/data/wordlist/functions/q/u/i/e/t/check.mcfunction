scoreboard players set @s word_id 2225 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:q/u/i/e/t/e/check 
...
execute if block ~5 ~ ~ minecraft:blue_concrete_powder run function wordlist:q/u/i/e/t/l/check 
