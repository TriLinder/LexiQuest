...
execute if block ~3 ~ ~ minecraft:light_gray_wool run function wordlist:t/i/d/y/c
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:t/i/d/i/c
