...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:t/i/g/e/check 
...
execute if block ~3 ~ ~ minecraft:gray_concrete_powder run function wordlist:t/i/g/h/check 
