scoreboard players set @s word_id 286 
...
execute if block ~3 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:t/i/e/d/check 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:t/i/e/s/check 
