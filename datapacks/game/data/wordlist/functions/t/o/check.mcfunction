scoreboard players set @s word_id 33 
...
execute if block ~2 ~ ~ minecraft:yellow_concrete_powder run function wordlist:t/o/e/check 
...
execute if block ~2 ~ ~ minecraft:green_concrete_powder run function wordlist:t/o/n/check 
...
execute if block ~2 ~ ~ minecraft:red_concrete_powder run function wordlist:t/o/o/check 
...
execute if block ~2 ~ ~ minecraft:black_concrete_powder run function wordlist:t/o/p/check 
...
execute if block ~2 ~ ~ minecraft:light_gray_wool run function wordlist:t/o/y/check 
...
execute if block ~2 ~ ~ minecraft:white_concrete_powder run function wordlist:t/o/a/check 
...
execute if block ~2 ~ ~ minecraft:blue_concrete_powder run function wordlist:t/o/l/check 
...
execute if block ~2 ~ ~ minecraft:brown_concrete_powder run function wordlist:t/o/m/check 
...
execute if block ~2 ~ ~ minecraft:orange_wool run function wordlist:t/o/r/check 
...
execute if block ~2 ~ ~ minecraft:magenta_wool run function wordlist:t/o/s/check 
...
execute if block ~2 ~ ~ minecraft:yellow_wool run function wordlist:t/o/u/check 
...
execute if block ~2 ~ ~ minecraft:pink_wool run function wordlist:t/o/w/check 
...
execute if block ~2 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:t/o/d/check 
...
execute if block ~2 ~ ~ minecraft:purple_concrete_powder run function wordlist:t/o/k/check 
...
execute if block ~2 ~ ~ minecraft:light_blue_wool run function wordlist:t/o/t/check 
...
execute if block ~2 ~ ~ minecraft:pink_concrete_powder run function wordlist:t/o/g/check 
...
execute if block ~2 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:t/o/i/check 
...
execute if block ~2 ~ ~ minecraft:orange_concrete_powder run function wordlist:t/o/b/check 
