scoreboard players set @s word_id 2571 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:t/o/p/i/c/s/check 
...
execute if block ~5 ~ ~ minecraft:white_concrete_powder run function wordlist:t/o/p/i/c/a/check 
