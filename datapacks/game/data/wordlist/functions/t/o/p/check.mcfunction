scoreboard players set @s word_id 292 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:t/o/p/s/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:t/o/p/i/check 
