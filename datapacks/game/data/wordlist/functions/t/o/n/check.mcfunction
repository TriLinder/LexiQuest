scoreboard players set @s word_id 290 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:t/o/n/e/check 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:t/o/n/s/check 
...
execute if block ~3 ~ ~ minecraft:pink_concrete_powder run function wordlist:t/o/n/g/check 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:t/o/n/i/check 
