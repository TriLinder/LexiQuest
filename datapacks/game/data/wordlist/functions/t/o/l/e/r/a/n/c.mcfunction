...
execute if block ~7 ~ ~ minecraft:light_blue_wool run function wordlist:t/o/l/e/r/a/n/t/c
...
execute if block ~7 ~ ~ minecraft:magenta_concrete_powder run function wordlist:t/o/l/e/r/a/n/c/c
