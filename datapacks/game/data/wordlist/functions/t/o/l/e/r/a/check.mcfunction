...
execute if block ~6 ~ ~ minecraft:green_concrete_powder run function wordlist:t/o/l/e/r/a/n/check 
...
execute if block ~6 ~ ~ minecraft:light_blue_wool run function wordlist:t/o/l/e/r/a/t/check 
