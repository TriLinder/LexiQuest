scoreboard players set @s word_id 1164 
...
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:t/r/i/p/s/check 
execute if block ~ ~ ~4 minecraft:magenta_wool run scoreboard players set @s word_direction 1 
execute if block ~ ~ ~4 minecraft:magenta_wool run function wordlist:t/r/i/p/s/check 
execute if block ~4 ~ ~ minecraft:blue_concrete_powder run scoreboard players set @s word_direction 0 
execute if block ~4 ~ ~ minecraft:blue_concrete_powder run function wordlist:t/r/i/p/l/check 
...
execute if block ~4 ~ ~ minecraft:red_concrete_powder run function wordlist:t/r/i/p/o/check 
