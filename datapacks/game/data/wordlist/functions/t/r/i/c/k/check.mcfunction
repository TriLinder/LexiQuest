scoreboard players set @s word_id 2591 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:t/r/i/c/k/s/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_wool run function wordlist:t/r/i/c/k/y/check 
