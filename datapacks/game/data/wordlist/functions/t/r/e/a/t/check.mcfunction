scoreboard players set @s word_id 2586 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:t/r/e/a/t/s/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_wool run function wordlist:t/r/e/a/t/y/check 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:t/r/e/a/t/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:t/r/e/a/t/i/check 
...
execute if block ~5 ~ ~ minecraft:brown_concrete_powder run function wordlist:t/r/e/a/t/m/check 
