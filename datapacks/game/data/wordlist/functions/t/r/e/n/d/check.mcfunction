scoreboard players set @s word_id 2588 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:t/r/e/n/d/s/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_wool run function wordlist:t/r/e/n/d/y/check 
