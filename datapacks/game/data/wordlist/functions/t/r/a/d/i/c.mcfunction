...
execute if block ~5 ~ ~ minecraft:green_concrete_powder run function wordlist:t/r/a/d/i/n/c
...
execute if block ~5 ~ ~ minecraft:light_blue_wool run function wordlist:t/r/a/d/i/t/c
