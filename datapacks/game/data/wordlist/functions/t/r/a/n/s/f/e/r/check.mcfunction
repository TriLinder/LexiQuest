scoreboard players set @s word_id 8594 
...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:t/r/a/n/s/f/e/r/s/check 
...
execute if block ~8 ~ ~ minecraft:orange_wool run function wordlist:t/r/a/n/s/f/e/r/r/check 
