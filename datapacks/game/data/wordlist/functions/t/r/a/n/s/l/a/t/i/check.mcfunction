...
execute if block ~9 ~ ~ minecraft:green_concrete_powder run function wordlist:t/r/a/n/s/l/a/t/i/n/check 
...
execute if block ~9 ~ ~ minecraft:red_concrete_powder run function wordlist:t/r/a/n/s/l/a/t/i/o/check 
