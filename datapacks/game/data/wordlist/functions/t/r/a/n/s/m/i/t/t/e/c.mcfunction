...
execute if block ~10 ~ ~ minecraft:orange_wool run function wordlist:t/r/a/n/s/m/i/t/t/e/r/c
...
execute if block ~10 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:t/r/a/n/s/m/i/t/t/e/d/c
