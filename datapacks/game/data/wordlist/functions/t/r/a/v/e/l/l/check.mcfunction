...
execute if block ~7 ~ ~ minecraft:yellow_concrete_powder run function wordlist:t/r/a/v/e/l/l/e/check 
...
execute if block ~7 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:t/r/a/v/e/l/l/i/check 
