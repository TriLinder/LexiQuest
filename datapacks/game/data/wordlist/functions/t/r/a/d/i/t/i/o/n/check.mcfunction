scoreboard players set @s word_id 10135 
...
execute if block ~9 ~ ~ minecraft:magenta_wool run function wordlist:t/r/a/d/i/t/i/o/n/s/check 
...
execute if block ~9 ~ ~ minecraft:white_concrete_powder run function wordlist:t/r/a/d/i/t/i/o/n/a/check 
