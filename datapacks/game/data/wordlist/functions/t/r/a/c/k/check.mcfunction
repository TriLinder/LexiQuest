scoreboard players set @s word_id 2579 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:t/r/a/c/k/s/check 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:t/r/a/c/k/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:t/r/a/c/k/i/check 
