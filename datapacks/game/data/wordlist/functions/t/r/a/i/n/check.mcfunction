scoreboard players set @s word_id 2582 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:t/r/a/i/n/s/check 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:t/r/a/i/n/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:t/r/a/i/n/i/check 
