...
execute if block ~8 ~ ~ minecraft:yellow_concrete_powder run function wordlist:t/r/a/n/s/l/a/t/e/c
...
execute if block ~8 ~ ~ minecraft:red_concrete_powder run function wordlist:t/r/a/n/s/l/a/t/o/c
...
execute if block ~8 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:t/r/a/n/s/l/a/t/i/c
