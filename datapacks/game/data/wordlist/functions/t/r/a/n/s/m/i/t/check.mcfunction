scoreboard players set @s word_id 8595 
...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:t/r/a/n/s/m/i/t/s/check 
...
execute if block ~8 ~ ~ minecraft:light_blue_wool run function wordlist:t/r/a/n/s/m/i/t/t/check 
