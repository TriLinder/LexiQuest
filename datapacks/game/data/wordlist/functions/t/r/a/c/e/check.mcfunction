scoreboard players set @s word_id 2578 
...
execute if block ~5 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:t/r/a/c/e/d/check 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:t/r/a/c/e/s/check 
