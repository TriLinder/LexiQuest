...
execute if block ~6 ~ ~ minecraft:light_blue_wool run function wordlist:t/r/a/n/s/i/t/c
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:t/r/a/n/s/i/e/c
