scoreboard players set @s word_id 4554 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:t/r/a/v/e/l/s/check 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:t/r/a/v/e/l/e/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:t/r/a/v/e/l/i/check 
...
execute if block ~6 ~ ~ minecraft:blue_concrete_powder run function wordlist:t/r/a/v/e/l/l/check 
