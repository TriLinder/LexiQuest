...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:t/r/a/n/s/f/e/c
...
execute if block ~6 ~ ~ minecraft:red_concrete_powder run function wordlist:t/r/a/n/s/f/o/c
