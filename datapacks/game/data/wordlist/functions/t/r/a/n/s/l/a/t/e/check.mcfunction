scoreboard players set @s word_id 10139 
...
execute if block ~9 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:t/r/a/n/s/l/a/t/e/d/check 
...
execute if block ~9 ~ ~ minecraft:magenta_wool run function wordlist:t/r/a/n/s/l/a/t/e/s/check 
