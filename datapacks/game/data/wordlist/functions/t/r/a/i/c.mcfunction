...
execute if block ~4 ~ ~ minecraft:green_concrete_powder run function wordlist:t/r/a/i/n/c
...
execute if block ~4 ~ ~ minecraft:blue_concrete_powder run function wordlist:t/r/a/i/l/c
