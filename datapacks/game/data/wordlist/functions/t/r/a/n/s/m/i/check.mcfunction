...
execute if block ~7 ~ ~ minecraft:light_blue_wool run function wordlist:t/r/a/n/s/m/i/t/check 
...
execute if block ~7 ~ ~ minecraft:magenta_wool run function wordlist:t/r/a/n/s/m/i/s/check 
