...
execute if block ~3 ~ ~ minecraft:red_concrete_powder run function wordlist:t/r/o/o/check 
...
execute if block ~3 ~ ~ minecraft:blue_concrete_powder run function wordlist:t/r/o/l/check 
...
execute if block ~3 ~ ~ minecraft:yellow_wool run function wordlist:t/r/o/u/check 
