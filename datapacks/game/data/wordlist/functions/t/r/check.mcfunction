...
execute if block ~2 ~ ~ minecraft:light_gray_wool run function wordlist:t/r/y/check 
...
execute if block ~2 ~ ~ minecraft:white_concrete_powder run function wordlist:t/r/a/check 
...
execute if block ~2 ~ ~ minecraft:yellow_concrete_powder run function wordlist:t/r/e/check 
...
execute if block ~2 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:t/r/i/check 
...
execute if block ~2 ~ ~ minecraft:yellow_wool run function wordlist:t/r/u/check 
...
execute if block ~2 ~ ~ minecraft:red_concrete_powder run function wordlist:t/r/o/check 
