scoreboard players set @s word_id 8606 
...
execute if block ~8 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:t/r/u/n/c/a/t/e/d/check 
...
execute if block ~8 ~ ~ minecraft:magenta_wool run function wordlist:t/r/u/n/c/a/t/e/s/check 
