...
execute if block ~4 ~ ~ minecraft:purple_concrete_powder run function wordlist:t/r/u/n/k/c
...
execute if block ~4 ~ ~ minecraft:magenta_concrete_powder run function wordlist:t/r/u/n/c/c
