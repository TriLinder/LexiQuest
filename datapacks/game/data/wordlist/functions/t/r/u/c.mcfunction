...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:t/r/u/e/c
...
execute if block ~3 ~ ~ minecraft:blue_concrete_powder run function wordlist:t/r/u/l/c
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:t/r/u/s/c
...
execute if block ~3 ~ ~ minecraft:magenta_concrete_powder run function wordlist:t/r/u/c/c
...
execute if block ~3 ~ ~ minecraft:green_concrete_powder run function wordlist:t/r/u/n/c
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:t/r/u/t/c
...
execute if block ~3 ~ ~ minecraft:brown_concrete_powder run function wordlist:t/r/u/m/c
