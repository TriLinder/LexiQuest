scoreboard players set @s word_id 4475 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:t/a/i/l/o/r/s/check 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:t/a/i/l/o/r/e/check 
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:t/a/i/l/o/r/i/check 
