...
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:t/a/c/t/i/check 
...
execute if block ~4 ~ ~ minecraft:blue_concrete_powder run function wordlist:t/a/c/t/l/check 
