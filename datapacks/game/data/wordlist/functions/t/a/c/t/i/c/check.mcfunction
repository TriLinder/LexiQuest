scoreboard players set @s word_id 4473 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:t/a/c/t/i/c/s/check 
...
execute if block ~6 ~ ~ minecraft:white_concrete_powder run function wordlist:t/a/c/t/i/c/a/check 
