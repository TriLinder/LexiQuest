scoreboard players set @s word_id 4472 
...
execute if block ~6 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:t/a/c/k/l/e/d/check 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:t/a/c/k/l/e/s/check 
