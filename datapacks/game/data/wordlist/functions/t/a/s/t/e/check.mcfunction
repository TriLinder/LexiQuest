scoreboard players set @s word_id 2516 
...
execute if block ~5 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:t/a/s/t/e/d/check 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:t/a/s/t/e/s/check 
...
execute if block ~5 ~ ~ minecraft:blue_concrete_powder run function wordlist:t/a/s/t/e/l/check 
