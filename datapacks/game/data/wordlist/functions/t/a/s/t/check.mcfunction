...
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run function wordlist:t/a/s/t/e/check 
...
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:t/a/s/t/i/check 
