...
execute if block ~3 ~ ~ minecraft:purple_concrete_powder run function wordlist:t/a/n/k/c
...
execute if block ~3 ~ ~ minecraft:pink_concrete_powder run function wordlist:t/a/n/g/c
