...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 271
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 271
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 271
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:t/a/x/i/c
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:t/a/x/e/c
...
execute if block ~3 ~ ~ minecraft:white_concrete_powder run function wordlist:t/a/x/a/c
...
execute if block ~3 ~ ~ minecraft:black_concrete_powder run function wordlist:t/a/x/p/c
