scoreboard players set @s word_id 281 
...
execute if block ~3 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:t/a/x/i/check 
...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:t/a/x/e/check 
...
execute if block ~3 ~ ~ minecraft:white_concrete_powder run function wordlist:t/a/x/a/check 
...
execute if block ~3 ~ ~ minecraft:black_concrete_powder run function wordlist:t/a/x/p/check 
