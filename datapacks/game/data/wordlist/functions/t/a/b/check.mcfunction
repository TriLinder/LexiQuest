scoreboard players set @s word_id 278 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:t/a/b/s/check 
...
execute if block ~3 ~ ~ minecraft:blue_concrete_powder run function wordlist:t/a/b/l/check 
