...
execute if block ~3 ~ ~ minecraft:yellow_concrete_powder run function wordlist:t/a/l/e/check 
...
execute if block ~3 ~ ~ minecraft:purple_concrete_powder run function wordlist:t/a/l/k/check 
...
execute if block ~3 ~ ~ minecraft:blue_concrete_powder run function wordlist:t/a/l/l/check 
