scoreboard players set @s word_id 1167 
...
execute if block ~4 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:t/u/n/e/d/check 
execute if block ~ ~ ~4 minecraft:light_blue_concrete_powder run scoreboard players set @s word_direction 1 
execute if block ~ ~ ~4 minecraft:light_blue_concrete_powder run function wordlist:t/u/n/e/d/check 
execute if block ~4 ~ ~ minecraft:magenta_wool run scoreboard players set @s word_direction 0 
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:t/u/n/e/s/check 
