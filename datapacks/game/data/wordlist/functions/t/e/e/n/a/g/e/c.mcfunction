...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 6262
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 6262
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 6262
...
execute if block ~7 ~ ~ minecraft:orange_wool run function wordlist:t/e/e/n/a/g/e/r/c
