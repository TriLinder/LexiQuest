...
execute if block ~2 ~ ~ minecraft:white_concrete_powder run function wordlist:t/e/a/check 
...
execute if block ~2 ~ ~ minecraft:green_concrete_powder run function wordlist:t/e/n/check 
...
execute if block ~2 ~ ~ minecraft:blue_concrete_powder run function wordlist:t/e/l/check 
...
execute if block ~2 ~ ~ minecraft:orange_wool run function wordlist:t/e/r/check 
...
execute if block ~2 ~ ~ minecraft:gray_wool run function wordlist:t/e/x/check 
...
execute if block ~2 ~ ~ minecraft:yellow_concrete_powder run function wordlist:t/e/e/check 
...
execute if block ~2 ~ ~ minecraft:brown_concrete_powder run function wordlist:t/e/m/check 
...
execute if block ~2 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:t/e/d/check 
...
execute if block ~2 ~ ~ minecraft:magenta_concrete_powder run function wordlist:t/e/c/check 
