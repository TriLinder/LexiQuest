...
execute if block ~6 ~ ~ minecraft:light_gray_wool run function wordlist:t/e/r/r/i/f/y/c
...
execute if block ~6 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:t/e/r/r/i/f/i/c
