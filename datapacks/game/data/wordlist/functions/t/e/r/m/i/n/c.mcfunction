...
execute if block ~6 ~ ~ minecraft:pink_concrete_powder run function wordlist:t/e/r/m/i/n/g/c
...
execute if block ~6 ~ ~ minecraft:white_concrete_powder run function wordlist:t/e/r/m/i/n/a/c
...
execute if block ~6 ~ ~ minecraft:red_concrete_powder run function wordlist:t/e/r/m/i/n/o/c
