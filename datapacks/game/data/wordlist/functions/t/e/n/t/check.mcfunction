...
execute if block ~4 ~ ~ minecraft:gray_concrete_powder run function wordlist:t/e/n/t/h/check 
...
execute if block ~4 ~ ~ minecraft:white_concrete_powder run function wordlist:t/e/n/t/a/check 
