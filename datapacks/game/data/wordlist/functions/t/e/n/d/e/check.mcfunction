...
execute if block ~5 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:t/e/n/d/e/d/check 
...
execute if block ~5 ~ ~ minecraft:orange_wool run function wordlist:t/e/n/d/e/r/check 
...
execute if block ~5 ~ ~ minecraft:green_concrete_powder run function wordlist:t/e/n/d/e/n/check 
