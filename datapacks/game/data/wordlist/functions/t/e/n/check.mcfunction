scoreboard players set @s word_id 283 
...
execute if block ~3 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:t/e/n/d/check 
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:t/e/n/s/check 
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:t/e/n/t/check 
...
execute if block ~3 ~ ~ minecraft:green_concrete_powder run function wordlist:t/e/n/n/check 
