...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 207
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 207
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 207
...
execute if block ~3 ~ ~ minecraft:magenta_wool run function wordlist:t/e/n/s/c
...
execute if block ~3 ~ ~ minecraft:light_blue_concrete_powder run function wordlist:t/e/n/d/c
...
execute if block ~3 ~ ~ minecraft:light_blue_wool run function wordlist:t/e/n/t/c
...
execute if block ~3 ~ ~ minecraft:green_concrete_powder run function wordlist:t/e/n/n/c
