...
execute if block ~7 ~ ~ minecraft:light_gray_wool run function wordlist:t/e/n/d/e/n/c/y/c
...
execute if block ~7 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:t/e/n/d/e/n/c/i/c
