scoreboard players set @s word_id 1119 
...
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run function wordlist:t/e/n/s/e/check 
...
execute if block ~4 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:t/e/n/s/i/check 
