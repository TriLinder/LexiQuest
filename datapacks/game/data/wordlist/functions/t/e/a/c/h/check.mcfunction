scoreboard players set @s word_id 2519 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:t/e/a/c/h/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:t/e/a/c/h/i/check 
