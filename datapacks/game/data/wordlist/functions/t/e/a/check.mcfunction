scoreboard players set @s word_id 282 
...
execute if block ~3 ~ ~ minecraft:brown_concrete_powder run function wordlist:t/e/a/m/check 
...
execute if block ~3 ~ ~ minecraft:orange_wool run function wordlist:t/e/a/r/check 
...
execute if block ~3 ~ ~ minecraft:magenta_concrete_powder run function wordlist:t/e/a/c/check 
...
execute if block ~3 ~ ~ minecraft:black_concrete_powder run function wordlist:t/e/a/p/check 
