...
execute if block ~8 ~ ~ minecraft:light_gray_wool run function wordlist:t/e/m/p/o/r/a/r/y/c
...
execute if block ~8 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:t/e/m/p/o/r/a/r/i/c
