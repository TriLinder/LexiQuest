scoreboard players set @s word_id 2524 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:t/e/m/p/t/s/check 
...
execute if block ~5 ~ ~ minecraft:yellow_concrete_powder run function wordlist:t/e/m/p/t/e/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:t/e/m/p/t/i/check 
...
execute if block ~5 ~ ~ minecraft:white_concrete_powder run function wordlist:t/e/m/p/t/a/check 
