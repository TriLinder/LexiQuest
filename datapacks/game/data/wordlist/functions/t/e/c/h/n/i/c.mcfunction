...
execute if block ~6 ~ ~ minecraft:magenta_concrete_powder run function wordlist:t/e/c/h/n/i/c/c
...
execute if block ~6 ~ ~ minecraft:white_wool run function wordlist:t/e/c/h/n/i/q/c
