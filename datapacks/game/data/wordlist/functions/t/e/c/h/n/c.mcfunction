...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:t/e/c/h/n/i/c
...
execute if block ~5 ~ ~ minecraft:red_concrete_powder run function wordlist:t/e/c/h/n/o/c
