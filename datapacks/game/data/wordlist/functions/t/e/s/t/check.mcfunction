execute if score @s word_direction matches 0 unless block ~-1 ~-4 ~ minecraft:pink_concrete unless block ~4 ~-4 ~ minecraft:pink_concrete run scoreboard players set @s enclosed_with_space 1 
execute if score @s word_direction matches 1 unless block ~ ~-4 ~-1 minecraft:pink_concrete unless block ~ ~-4 ~4 minecraft:pink_concrete run scoreboard players set @s enclosed_with_space 1 
