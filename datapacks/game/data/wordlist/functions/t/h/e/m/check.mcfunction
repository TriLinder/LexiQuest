scoreboard players set @s word_id 1126 
...
execute if block ~4 ~ ~ minecraft:yellow_concrete_powder run function wordlist:t/h/e/m/e/check 
execute if block ~ ~ ~4 minecraft:yellow_concrete_powder run scoreboard players set @s word_direction 1 
execute if block ~ ~ ~4 minecraft:yellow_concrete_powder run function wordlist:t/h/e/m/e/check 
execute if block ~4 ~ ~ minecraft:magenta_wool run scoreboard players set @s word_direction 0 
execute if block ~4 ~ ~ minecraft:magenta_wool run function wordlist:t/h/e/m/s/check 
