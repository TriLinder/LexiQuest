...
execute if block ~6 ~ ~ minecraft:brown_concrete_powder run function wordlist:t/h/e/o/r/e/m/c
...
execute if block ~6 ~ ~ minecraft:light_blue_wool run function wordlist:t/h/e/o/r/e/t/c
