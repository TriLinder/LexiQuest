...
execute if block ~4 ~ ~ minecraft:orange_wool run function wordlist:t/h/e/o/r/c
...
execute if block ~4 ~ ~ minecraft:blue_concrete_powder run function wordlist:t/h/e/o/l/c
