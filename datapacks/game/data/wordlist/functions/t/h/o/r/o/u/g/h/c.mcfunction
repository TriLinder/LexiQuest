...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 7814
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 7814
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 7814
...
execute if block ~8 ~ ~ minecraft:blue_concrete_powder run function wordlist:t/h/o/r/o/u/g/h/l/c
execute if block ~ ~ ~8 minecraft:blue_concrete_powder run scoreboard players set @s word_direction 1
execute if block ~ ~ ~8 minecraft:blue_concrete_powder run function wordlist:t/h/o/r/o/u/g/h/l/c
execute if block ~8 ~ ~ minecraft:lime_concrete_powder run scoreboard players set @s word_direction 0
execute if block ~8 ~ ~ minecraft:lime_concrete_powder run function wordlist:t/h/o/r/o/u/g/h/f/c
execute if block ~ ~ ~8 minecraft:lime_concrete_powder run scoreboard players set @s word_direction 1
execute if block ~ ~ ~8 minecraft:lime_concrete_powder run function wordlist:t/h/o/r/o/u/g/h/f/c
