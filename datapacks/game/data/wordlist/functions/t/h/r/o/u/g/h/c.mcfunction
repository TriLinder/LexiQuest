...
execute if score @s enclosed_with_space matches 1 run scoreboard players set @s word_id 5957
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 0 run scoreboard players set @s word_id_right 5957
execute if score @s enclosed_with_space matches 1 if score @s word_direction matches 1 run scoreboard players set @s word_id_down 5957
...
execute if block ~7 ~ ~ minecraft:red_concrete_powder run function wordlist:t/h/r/o/u/g/h/o/c
...
execute if block ~7 ~ ~ minecraft:black_concrete_powder run function wordlist:t/h/r/o/u/g/h/p/c
