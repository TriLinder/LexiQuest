scoreboard players set @s word_id 4521 
...
execute if block ~6 ~ ~ minecraft:magenta_wool run function wordlist:t/h/r/e/a/t/s/check 
...
execute if block ~6 ~ ~ minecraft:yellow_concrete_powder run function wordlist:t/h/r/e/a/t/e/check 
