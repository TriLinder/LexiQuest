scoreboard players set @s word_id 2542 
...
execute if block ~5 ~ ~ minecraft:magenta_wool run function wordlist:t/h/i/n/k/s/check 
...
execute if block ~5 ~ ~ minecraft:light_gray_concrete_powder run function wordlist:t/h/i/n/k/i/check 
