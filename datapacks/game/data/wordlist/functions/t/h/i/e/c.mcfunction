...
execute if block ~4 ~ ~ minecraft:lime_concrete_powder run function wordlist:t/h/i/e/f/c
...
execute if block ~4 ~ ~ minecraft:lime_wool run function wordlist:t/h/i/e/v/c
