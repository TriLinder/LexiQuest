scoreboard players set @s word_id 1129 
...
execute if block ~4 ~ ~ minecraft:pink_concrete_powder run function wordlist:t/h/i/n/g/check 
...
execute if block ~4 ~ ~ minecraft:purple_concrete_powder run function wordlist:t/h/i/n/k/check 
