#Auto-generated check for: RESPONDING

#East (+x) direction
execute if block ~-1 ~ ~ minecraft:purple_wool if block ~0 ~ ~ minecraft:orange_wool if block ~1 ~ ~ minecraft:yellow_concrete_powder if block ~2 ~ ~ minecraft:magenta_wool if block ~3 ~ ~ minecraft:black_concrete_powder if block ~4 ~ ~ minecraft:red_concrete_powder if block ~5 ~ ~ minecraft:green_concrete_powder if block ~6 ~ ~ minecraft:light_blue_concrete_powder if block ~7 ~ ~ minecraft:light_gray_concrete_powder if block ~8 ~ ~ minecraft:green_concrete_powder if block ~9 ~ ~ minecraft:pink_concrete_powder if block ~10 ~ ~ minecraft:purple_wool run scoreboard players set @s word_direction 0
...
execute unless score @s word_direction matches -1 run scoreboard players set @s word_id 11162
