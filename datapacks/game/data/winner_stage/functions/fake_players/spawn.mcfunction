...
summon minecraft:armor_stand -14.656 128.813 13.356 {Invulnerable:1b,NoBasePlate:1b,NoGravity:1b,ShowArms:1b,Rotation:[175f],ArmorItems:[{id:"minecraft:leather_boots",Count:1b},{id:"minecraft:leather_leggings",Count:1b},{id:"minecraft:leather_chestplate",Count:1b},{id:"player_head",Count:1b,tag:{SkullOwner:"TriLinder"}}],HandItems:[{},{}],Tags:["winner_stage_fake_players"],DisabledSlots:4144959,Pose:{LeftLeg:[271f,0f,0f],RightLeg:[271f,0f,0f],LeftArm:[82f,31f,0f]}}
